...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->e:Landroid/content/res/AssetManager;
...
.method public b(Ls50/g;)J
    ...
    iput-object v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->f:Landroid/net/Uri;
    ...
    iget-object v1, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->e:Landroid/content/res/AssetManager;

    invoke-virtual {v1, v0, v2}, Landroid/content/res/AssetManager;->open(Ljava/lang/String;I)Ljava/io/InputStream;

    move-result-object v0

    iput-object v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->g:Ljava/io/InputStream;

    iget-wide v3, p1, Ls50/g;->g:J
    ...
    iput-wide v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->h:J

    goto :goto_1

    :cond_2
    iget-object v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->g:Ljava/io/InputStream;
    ...
    iput-wide v3, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->h:J
    :try_end_0
    ...
    :cond_3
    :goto_1
    iput-boolean v2, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->i:Z

    invoke-virtual {p0, p1}, Ls50/a;->g(Ls50/g;)V

    iget-wide v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->h:J
...
.method public close()V
    ...
    :try_start_0
    iget-object v2, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->g:Ljava/io/InputStream;
    ...
    iget-boolean v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->i:Z

    if-eqz v0, :cond_1

    iput-boolean v1, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->i:Z
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->f:Landroid/net/Uri;
...
.method public read([BII)I
    ...
    :cond_3
    iget-wide p2, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->h:J
    ...
    iput-wide p2, p0, Lio/bidmachine/media3/datasource/AssetDataSource;->h:J
