...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/media3/datasource/AssetDataSource;->r:Landroid/content/res/AssetManager;
...
.method public close()V
    ...
    iput-object v0, p0, Landroidx/media3/datasource/AssetDataSource;->s:Landroid/net/Uri;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Landroidx/media3/datasource/AssetDataSource;->t:Ljava/io/InputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Landroidx/media3/datasource/AssetDataSource;->t:Ljava/io/InputStream;

    iget-boolean v0, p0, Landroidx/media3/datasource/AssetDataSource;->v:Z

    if-eqz v0, :cond_1

    iput-boolean v1, p0, Landroidx/media3/datasource/AssetDataSource;->v:Z
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroidx/media3/datasource/AssetDataSource;->s:Landroid/net/Uri;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    iget-object v1, p0, Landroidx/media3/datasource/AssetDataSource;->r:Landroid/content/res/AssetManager;
    ...
    iput-wide v0, p0, Landroidx/media3/datasource/AssetDataSource;->u:J

    goto :goto_1

    :cond_2
    iget-object v0, p0, Landroidx/media3/datasource/AssetDataSource;->t:Ljava/io/InputStream;
    ...
    iput-wide v3, p0, Landroidx/media3/datasource/AssetDataSource;->u:J
    :try_end_0
    ...
    :cond_3
    :goto_1
    iput-boolean v2, p0, Landroidx/media3/datasource/AssetDataSource;->v:Z

    invoke-virtual {p0, p1}, Landroidx/media3/datasource/BaseDataSource;->transferStarted(Landroidx/media3/datasource/DataSpec;)V

    iget-wide v0, p0, Landroidx/media3/datasource/AssetDataSource;->u:J
...
.method public read([BII)I
    ...
    :cond_3
    iget-wide p2, p0, Landroidx/media3/datasource/AssetDataSource;->u:J
    ...
    iput-wide p2, p0, Landroidx/media3/datasource/AssetDataSource;->u:J
