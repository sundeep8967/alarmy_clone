...
# static fields
.field public static final e:Landroidx/graphics/shapes/MeasuredPolygon$Companion;


# instance fields
.field private final b:Landroidx/graphics/shapes/Measurer;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/graphics/shapes/MeasuredPolygon;->e:Landroidx/graphics/shapes/MeasuredPolygon$Companion;
...
.method private constructor <init>(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;)V
    ...
    .line 3
    invoke-virtual {p4}, Landroidx/collection/FloatList;->c()I
    ...
    .line 4
    invoke-virtual {p4}, Landroidx/collection/FloatList;->a()F
    ...
    .line 5
    invoke-virtual {p4}, Landroidx/collection/FloatList;->f()F
    ...
    .line 6
    iput-object p1, p0, Landroidx/graphics/shapes/MeasuredPolygon;->b:Landroidx/graphics/shapes/Measurer;

    .line 7
    iput-object p2, p0, Landroidx/graphics/shapes/MeasuredPolygon;->d:Ljava/util/List;
    ...
    .line 10
    invoke-virtual {p4, v5}, Landroidx/collection/FloatList;->b(I)F

    move-result v6

    invoke-virtual {p4, v0}, Landroidx/collection/FloatList;->b(I)F
    ...
    invoke-static {p2, v1, v3, v2, p3}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->f(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;FFILjava/lang/Object;)V

    .line 15
    iput-object p1, p0, Landroidx/graphics/shapes/MeasuredPolygon;->c:Ljava/util/List;
...
.method public static final synthetic d(Landroidx/graphics/shapes/MeasuredPolygon;)Landroidx/graphics/shapes/Measurer;
    .locals 0

    iget-object p0, p0, Landroidx/graphics/shapes/MeasuredPolygon;->b:Landroidx/graphics/shapes/Measurer;
...
.method public final bridge contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;->e(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)Z
...
.method public bridge e(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)Z
    .locals 0
...
.method public final f(F)Landroidx/graphics/shapes/MeasuredPolygon;
    .locals 12
    ...
    :cond_0
    iget-object v2, p0, Landroidx/graphics/shapes/MeasuredPolygon;->c:Ljava/util/List;
    ...
    invoke-virtual {v5}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->d()F

    move-result v6

    invoke-virtual {v5}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->c()F
    ...
    invoke-virtual {v2, p1}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->a(F)Lja0/q;
    ...
    invoke-virtual {v2}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->b()Landroidx/graphics/shapes/Cubic;
    ...
    iget-object v6, p0, Landroidx/graphics/shapes/MeasuredPolygon;->c:Ljava/util/List;
    ...
    iget-object v9, p0, Landroidx/graphics/shapes/MeasuredPolygon;->c:Ljava/util/List;
    ...
    invoke-virtual {v9}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->b()Landroidx/graphics/shapes/Cubic;
    ...
    :cond_3
    invoke-virtual {v5}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->b()Landroidx/graphics/shapes/Cubic;
    ...
    iget-object v10, p0, Landroidx/graphics/shapes/MeasuredPolygon;->c:Ljava/util/List;
    ...
    invoke-virtual {v9}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;->c()F

    move-result v9

    sub-float/2addr v9, p1

    invoke-static {v9, v1}, Landroidx/graphics/shapes/Utils;->j(FF)F

    move-result v9

    :goto_4
    invoke-virtual {v5, v9}, Landroidx/collection/MutableFloatList;->g(F)Z
    ...
    iget-object v4, p0, Landroidx/graphics/shapes/MeasuredPolygon;->d:Ljava/util/List;
    ...
    iget-object v7, p0, Landroidx/graphics/shapes/MeasuredPolygon;->d:Ljava/util/List;
    ...
    invoke-virtual {v7}, Landroidx/graphics/shapes/ProgressableFeature;->b()F

    move-result v7

    sub-float/2addr v7, p1

    invoke-static {v7, v1}, Landroidx/graphics/shapes/Utils;->j(FF)F

    move-result v7

    iget-object v8, p0, Landroidx/graphics/shapes/MeasuredPolygon;->d:Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/graphics/shapes/MeasuredPolygon;->b:Landroidx/graphics/shapes/Measurer;
...
.method public bridge synthetic get(I)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;->h(I)Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
...
.method public h(I)Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    .locals 1
...
.method public final bridge indexOf(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;->n(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)I
...
.method public final bridge lastIndexOf(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;->r(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)I
...
.method public final m()Ljava/util/List;
    ...
    iget-object v0, p0, Landroidx/graphics/shapes/MeasuredPolygon;->d:Ljava/util/List;

    return-object v0
.end method

.method public bridge n(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)I
    .locals 0
...
.method public bridge r(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)I
    .locals 0
