...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lxj/l;->r(Lxj/p;Lza0/l;Landroidx/compose/runtime/Composer;I)V
.end annotation
...
# direct methods
.method constructor <init>(Lxj/p;Lza0/l;Landroid/content/Context;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lxj/l$d;->b:Lxj/p;

    iput-object p2, p0, Lxj/l$d;->c:Lza0/l;

    iput-object p3, p0, Lxj/l$d;->d:Landroid/content/Context;
...
.method public static synthetic a(Lza0/l;Landroid/content/Context;)Lja0/h0;
    ...
    invoke-static {p0, p1}, Lxj/l$d;->f(Lza0/l;Landroid/content/Context;)Lja0/h0;
...
.method public static synthetic b(Lza0/l;I)Lja0/h0;
    ...
    invoke-static {p0, p1}, Lxj/l$d;->e(Lza0/l;I)Lja0/h0;
...
.method private static final e(Lza0/l;I)Lja0/h0;
    ...
    new-instance v0, Lxj/q$e;

    invoke-direct {v0, p1}, Lxj/q$e;-><init>(I)V
...
.method private static final f(Lza0/l;Landroid/content/Context;)Lja0/h0;
    ...
    new-instance v0, Lxj/q$f;

    invoke-direct {v0, p1}, Lxj/q$f;-><init>(Landroid/content/Context;)V
...
.method public final d(Landroidx/compose/foundation/layout/PaddingValues;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v4, "com.delightroom.alarmy.feature.alarm.editor.normal.ui.mission.typing.TypingSettingScreen.<anonymous> (TypingSettingScreen.kt:124)"
    ...
    invoke-static {v2, v13, v14, v15}, Landroidx/compose/foundation/layout/SizeKt;->d(Landroidx/compose/ui/Modifier;FILjava/lang/Object;)Landroidx/compose/ui/Modifier;
    ...
    invoke-static {v8, v9, v8, v14}, Landroidx/compose/foundation/ScrollKt;->c(ILandroidx/compose/runtime/Composer;II)Landroidx/compose/foundation/ScrollState;
    ...
    iget-object v7, v0, Lxj/l$d;->b:Lxj/p;

    iget-object v6, v0, Lxj/l$d;->c:Lza0/l;

    iget-object v5, v0, Lxj/l$d;->d:Landroid/content/Context;
    ...
    invoke-static {v2, v3, v9, v8}, Landroidx/compose/foundation/layout/ColumnKt;->a(Landroidx/compose/foundation/layout/Arrangement$Vertical;Landroidx/compose/ui/Alignment$Horizontal;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-static {v8, v2, v11}, Landroidx/compose/runtime/Updater;->e(Landroidx/compose/runtime/Composer;Ljava/lang/Object;Lza0/p;)V
    ...
    new-instance v1, Lxj/l$d$a;

    invoke-direct {v1, v7}, Lxj/l$d$a;-><init>(Lxj/p;)V

    const/16 v2, 0x36

    const v3, -0x503e2088

    invoke-static {v3, v14, v1, v9, v2}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->e(IZLjava/lang/Object;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    invoke-virtual {v7}, Lxj/p;->c()Lcom/delightroom/alarmy/domain/model/mission/Mission$Typing;
    ...
    sget v8, Lcom/delightroom/alarmy/feature/alarm/editor/normal/R$string;->mission_count:I
    ...
    invoke-direct {v2, v6}, Lxj/m;-><init>(Lza0/l;)V
    ...
    invoke-static {v12, v1, v13, v2, v15}, Landroidx/compose/foundation/layout/PaddingKt;->k(Landroidx/compose/ui/Modifier;FFILjava/lang/Object;)Landroidx/compose/ui/Modifier;

    move-result-object v4

    invoke-virtual/range {v16 .. v16}, Lxj/p;->c()Lcom/delightroom/alarmy/domain/model/mission/Mission$Typing;

    move-result-object v1

    invoke-virtual {v1}, Lcom/delightroom/alarmy/domain/model/mission/Mission;->isPremium()Z

    move-result v1

    if-eqz v1, :cond_b

    invoke-virtual/range {v16 .. v16}, Lxj/p;->d()Ljj/e;

    move-result-object v1

    sget-object v2, Ljj/e$d;->INSTANCE:Ljj/e$d;
    ...
    :cond_c
    new-instance v6, Lxj/n;

    invoke-direct {v6, v3, v14}, Lxj/n;-><init>(Lza0/l;Landroid/content/Context;)V
    ...
    invoke-static/range {v1 .. v7}, Lxj/l;->y(ZILza0/a;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lxj/l$d;->d(Landroidx/compose/foundation/layout/PaddingValues;Landroidx/compose/runtime/Composer;I)V
