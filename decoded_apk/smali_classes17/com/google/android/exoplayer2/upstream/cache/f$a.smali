...
.method public constructor <init>(Lko/a;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/cache/f$a;->a:Lko/a;
...
.method private h(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/exoplayer2/upstream/cache/e;)V
    .locals 4
    ...
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/upstream/cache/e;->d()Lfp/g;
    ...
    invoke-static {v1, v2}, Lcom/google/android/exoplayer2/upstream/cache/f;->c(Lfp/g;Ljava/io/DataOutputStream;)V
...
.method private static i(Lko/a;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    :try_start_0
    invoke-static {p1}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->m(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-interface {p0}, Lko/a;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_1
    invoke-static {p0, v1, p1}, Lko/c;->c(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)V

    invoke-static {p0, v0}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->k(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
...
.method private l()Landroid/database/Cursor;
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/cache/f$a;->a:Lko/a;
...
.method private n(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1, v1, v0, v1}, Lko/c;->d(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;I)V
    ...
    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->k(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
...
.method public b(Ljava/util/HashMap;)V
    ...
    :try_start_1
    invoke-direct {p0, v0}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->n(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->h(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/exoplayer2/upstream/cache/e;)V
...
.method public c()Z
    ...
    invoke-static {v0, v2, v1}, Lko/c;->b(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)I
...
.method public d(Ljava/util/HashMap;)V
    ...
    :cond_0
    :try_start_0
    iget-object p1, p0, Lcom/google/android/exoplayer2/upstream/cache/f$a;->a:Lko/a;
    ...
    invoke-direct {p0, p1, v1}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->j(Landroid/database/sqlite/SQLiteDatabase;I)V
    ...
    :cond_1
    invoke-direct {p0, p1, v1}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->h(Landroid/database/sqlite/SQLiteDatabase;Lcom/google/android/exoplayer2/upstream/cache/e;)V
...
.method public delete()V
    ...
    invoke-static {v0, v1}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->i(Lko/a;Ljava/lang/String;)V
...
.method public e(Ljava/util/HashMap;Landroid/util/SparseArray;)V
    ...
    invoke-static {v0, v2, v3}, Lko/c;->b(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)I
    ...
    :cond_1
    :goto_1
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/cache/f$a;->l()Landroid/database/Cursor;
    ...
    invoke-static {v5}, Lcom/google/android/exoplayer2/upstream/cache/f;->b(Ljava/io/DataInputStream;)Lfp/g;

    move-result-object v5

    new-instance v6, Lcom/google/android/exoplayer2/upstream/cache/e;

    invoke-direct {v6, v3, v4, v5}, Lcom/google/android/exoplayer2/upstream/cache/e;-><init>(ILjava/lang/String;Lfp/g;)V
