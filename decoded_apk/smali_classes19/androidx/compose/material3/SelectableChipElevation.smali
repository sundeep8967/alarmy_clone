...
.method public static final synthetic a(Landroidx/compose/runtime/MutableState;)Landroidx/compose/foundation/interaction/Interaction;
    .locals 0

    invoke-static {p0}, Landroidx/compose/material3/SelectableChipElevation;->d(Landroidx/compose/runtime/MutableState;)Landroidx/compose/foundation/interaction/Interaction;
...
.method public static final synthetic b(Landroidx/compose/runtime/MutableState;Landroidx/compose/foundation/interaction/Interaction;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/compose/material3/SelectableChipElevation;->e(Landroidx/compose/runtime/MutableState;Landroidx/compose/foundation/interaction/Interaction;)V

    return-void
.end method

.method private final c(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    .locals 20
    ...
    invoke-static {v9, v9, v6, v9}, Landroidx/compose/runtime/SnapshotStateKt;->j(Ljava/lang/Object;Landroidx/compose/runtime/SnapshotMutationPolicy;ILjava/lang/Object;)Landroidx/compose/runtime/MutableState;
    ...
    invoke-direct {v11, v1, v3, v9}, Landroidx/compose/material3/SelectableChipElevation$animateElevation$1$1;-><init>(Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/snapshots/SnapshotStateList;Lpa0/e;)V
    ...
    invoke-static {v1, v11, v8, v7}, Landroidx/compose/runtime/EffectsKt;->g(Ljava/lang/Object;Lza0/p;Landroidx/compose/runtime/Composer;I)V
    ...
    iget v1, v0, Landroidx/compose/material3/SelectableChipElevation;->f:F
    ...
    iget v1, v0, Landroidx/compose/material3/SelectableChipElevation;->b:F
    ...
    iget v1, v0, Landroidx/compose/material3/SelectableChipElevation;->d:F
    ...
    iget v1, v0, Landroidx/compose/material3/SelectableChipElevation;->c:F
    ...
    iget v1, v0, Landroidx/compose/material3/SelectableChipElevation;->e:F

    goto :goto_1

    :cond_c
    iget v1, v0, Landroidx/compose/material3/SelectableChipElevation;->a:F
    ...
    invoke-static {v9}, Landroidx/compose/animation/core/VectorConvertersKt;->e(Landroidx/compose/ui/unit/Dp$Companion;)Landroidx/compose/animation/core/TwoWayConverter;
    ...
    invoke-interface {v8, v3}, Landroidx/compose/runtime/Composer;->w(F)Z
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/compose/material3/SelectableChipElevation$animateElevation$2$1;-><init>(Landroidx/compose/animation/core/Animatable;FZLandroidx/compose/foundation/interaction/Interaction;Landroidx/compose/runtime/MutableState;Lpa0/e;)V
    ...
    invoke-static {v11, v2, v8, v12}, Landroidx/compose/runtime/EffectsKt;->g(Ljava/lang/Object;Lza0/p;Landroidx/compose/runtime/Composer;I)V

    invoke-virtual {v9}, Landroidx/compose/animation/core/Animatable;->g()Landroidx/compose/runtime/State;
...
.method private static final d(Landroidx/compose/runtime/MutableState;)Landroidx/compose/foundation/interaction/Interaction;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final e(Landroidx/compose/runtime/MutableState;Landroidx/compose/foundation/interaction/Interaction;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final f(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/compose/material3/SelectableChipElevation;->c(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
