...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;)V
    ...
    invoke-virtual {p2}, Landroidx/work/impl/WorkManagerImpl;->q()Landroidx/work/impl/utils/PreferenceUtils;
...
.method private static e(Landroid/content/Context;I)Landroid/app/PendingIntent;
    .locals 2
...
.method static h(Landroid/content/Context;)V
    ...
    :goto_0
    invoke-static {p0, v1}, Landroidx/work/impl/utils/ForceStopRunnable;->e(Landroid/content/Context;I)Landroid/app/PendingIntent;
...
.method public a()Z
    ...
    :try_start_0
    invoke-interface {v2}, Landroidx/work/impl/model/WorkSpecDao;->x()Ljava/util/List;
    ...
    invoke-interface {v2, v9, v10}, Landroidx/work/impl/model/WorkSpecDao;->j(Landroidx/work/WorkInfo$State;Ljava/lang/String;)I

    iget-object v8, v8, Landroidx/work/impl/model/WorkSpec;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, Landroidx/work/impl/model/WorkSpecDao;->t(Ljava/lang/String;J)I
...
.method public b()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/WorkManagerImpl;->y()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Landroidx/work/impl/WorkManagerImpl;

    invoke-virtual {v0}, Landroidx/work/impl/WorkManagerImpl;->q()Landroidx/work/impl/utils/PreferenceUtils;
    ...
    invoke-virtual {v2}, Landroidx/work/impl/WorkManagerImpl;->s()Ljava/util/List;
...
.method public f()Z
    ...
    invoke-static {v3, v2}, Landroidx/work/impl/utils/ForceStopRunnable;->e(Landroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v2}, Landroidx/work/impl/utils/PreferenceUtils;->b()J
    ...
    invoke-static {v1}, Landroidx/work/impl/utils/ForceStopRunnable;->h(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-virtual {v2, v3, v4, v1}, Landroidx/work/Logger;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-virtual {v0}, Landroidx/work/impl/WorkManagerImpl;->x()V
    ...
    invoke-static {v0}, Landroidx/work/impl/WorkDatabasePathHelper;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-virtual {v2, v3, v1, v0}, Landroidx/work/Logger;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/Configuration;->e()Landroidx/core/util/Consumer;
    ...
    invoke-virtual {v1, v3, v4, v2}, Landroidx/work/Logger;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, Landroidx/work/Logger;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/utils/ForceStopRunnable;->j(J)V
    ...
    invoke-virtual {v2, v3, v1}, Landroidx/work/Logger;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkManagerImpl;->x()V
