...
.field private h:Landroidx/appcompat/widget/DropDownListView$GateKeeperDrawable;
...
.field n:Landroidx/appcompat/widget/DropDownListView$ResolveHoverRunnable;
...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/DropDownListView;->b:Landroid/graphics/Rect;
...
.method private c(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/DropDownListView;->b:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/DropDownListView;->b:Landroid/graphics/Rect;
...
.method private f(ILandroid/view/View;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/DropDownListView;->j()Z
    ...
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/DropDownListView;->k(Z)V
...
.method private g(ILandroid/view/View;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/DropDownListView;->f(ILandroid/view/View;)V

    if-eqz v3, :cond_3

    iget-object p1, p0, Landroidx/appcompat/widget/DropDownListView;->b:Landroid/graphics/Rect;
    ...
    invoke-static {v0, p2, p1}, Landroidx/core/graphics/drawable/DrawableCompat;->k(Landroid/graphics/drawable/Drawable;FF)V
...
.method private h(ILandroid/view/View;FF)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/DropDownListView;->g(ILandroid/view/View;)V
    ...
    invoke-static {p2, p3, p4}, Landroidx/core/graphics/drawable/DrawableCompat;->k(Landroid/graphics/drawable/Drawable;FF)V
...
.method private i(Landroid/view/View;IFF)V
    ...
    invoke-static {p0, p3, p4}, Landroidx/appcompat/widget/DropDownListView$Api21Impl;->a(Landroid/view/View;FF)V
    ...
    invoke-static {p1, v1, v2}, Landroidx/appcompat/widget/DropDownListView$Api21Impl;->a(Landroid/view/View;FF)V
    ...
    :cond_2
    invoke-direct {p0, p2, p1, p3, p4}, Landroidx/appcompat/widget/DropDownListView;->h(ILandroid/view/View;FF)V
...
.method private j()Z
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/DropDownListView$Api33Impl;->a(Landroid/widget/AbsListView;)Z
    ...
    :cond_0
    invoke-static {p0}, Landroidx/appcompat/widget/DropDownListView$PreApi33Impl;->a(Landroid/widget/AbsListView;)Z
...
.method private k(Z)V
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/widget/DropDownListView$Api33Impl;->b(Landroid/widget/AbsListView;Z)V

    goto :goto_0

    :cond_0
    invoke-static {p0, p1}, Landroidx/appcompat/widget/DropDownListView$PreApi33Impl;->b(Landroid/widget/AbsListView;Z)V
...
.method private m()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/DropDownListView;->l()Z
...
.method private setSelectorEnabled(Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/DropDownListView;->h:Landroidx/appcompat/widget/DropDownListView$GateKeeperDrawable;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/DropDownListView$GateKeeperDrawable;->b(Z)V
...
.method protected drawableStateChanged()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/DropDownListView;->m()V
...
.method public e(Landroid/view/MotionEvent;I)Z
    ...
    invoke-direct {p0, v3, v5, v4, p2}, Landroidx/appcompat/widget/DropDownListView;->i(Landroid/view/View;IFF)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/DropDownListView;->m:Landroidx/core/widget/ListViewAutoScrollHelper;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/DropDownListView;->m:Landroidx/core/widget/ListViewAutoScrollHelper;
    ...
    :cond_9
    iget-object p1, p0, Landroidx/appcompat/widget/DropDownListView;->m:Landroidx/core/widget/ListViewAutoScrollHelper;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Landroidx/appcompat/widget/DropDownListView$ResolveHoverRunnable;->b()V
    ...
    invoke-static {}, Landroidx/appcompat/widget/DropDownListView$Api30Impl;->a()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p0, p1, v1}, Landroidx/appcompat/widget/DropDownListView$Api30Impl;->b(Landroidx/appcompat/widget/DropDownListView;ILandroid/view/View;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/DropDownListView$ResolveHoverRunnable;->a()V
...
.method public setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/DropDownListView;->h:Landroidx/appcompat/widget/DropDownListView$GateKeeperDrawable;
