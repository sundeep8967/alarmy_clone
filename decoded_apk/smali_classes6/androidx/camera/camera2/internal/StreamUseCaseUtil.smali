...
.method static constructor <clinit>()V
    ...
    sget-object v3, Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;->c:Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;

    invoke-interface {v2, v3}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v4, Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;->g:Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;
    ...
    sget-object v7, Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;->e:Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;
...
.method public static a(Ljava/util/Map;Ljava/util/Map;Ljava/util/List;)Z
    ...
    :cond_0
    sget-object v3, Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;->f:Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;
    ...
    invoke-virtual {v2}, Landroidx/camera/core/streamsharing/StreamSharingConfig;->Y()Ljava/util/List;
...
.method public static c(Landroidx/camera/camera2/internal/compat/CameraCharacteristicsCompat;Ljava/util/List;)Z
    ...
    :cond_0
    invoke-static {}, Landroidx/camera/camera2/internal/t2;->a()Landroid/hardware/camera2/CameraCharacteristics$Key;
...
.method public static d(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-interface {p1}, Landroidx/camera/core/impl/UseCaseConfig;->U()Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;
...
.method private static f(Landroidx/camera/core/impl/Config;J)Landroidx/camera/core/impl/Config;
    .locals 3
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/camera/core/impl/MutableOptionsBundle;->J(Landroidx/camera/core/impl/Config$Option;Ljava/lang/Object;)V
...
.method private static g(Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;JLjava/util/List;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static i(Ljava/util/List;Ljava/util/List;Ljava/util/Set;)Z
    ...
    sget-object v6, Landroidx/camera/camera2/impl/Camera2ImplConfig;->K:Landroidx/camera/core/impl/Config$Option;
    ...
    sget-object v7, Landroidx/camera/camera2/impl/Camera2ImplConfig;->K:Landroidx/camera/core/impl/Config$Option;
...
.method private static j(Landroidx/camera/core/impl/Config;Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;)Z
    .locals 3
...
.method public static k(Landroidx/camera/camera2/internal/compat/CameraCharacteristicsCompat;Ljava/util/List;Ljava/util/Map;Ljava/util/Map;)Z
    ...
    sget-object v2, Landroidx/camera/camera2/impl/Camera2ImplConfig;->K:Landroidx/camera/core/impl/Config$Option;
    ...
    invoke-virtual {p3}, Landroidx/camera/core/impl/StreamSpec;->g()Landroidx/camera/core/impl/StreamSpec$Builder;
...
.method public static l(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-virtual {v4}, Landroidx/camera/core/impl/StreamSpec;->g()Landroidx/camera/core/impl/StreamSpec$Builder;
...
.method public static m(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Map;)V
    ...
    invoke-interface {v3}, Landroidx/camera/core/impl/UseCaseConfig;->U()Landroidx/camera/core/impl/UseCaseConfigFactory$CaptureType;
    ...
    invoke-virtual {v2}, Landroidx/camera/core/impl/SessionConfig;->o()Ljava/util/List;
    ...
    invoke-static {v3, v5}, Landroidx/core/util/Preconditions;->k(ZLjava/lang/String;)V
    ...
    sget-object v5, Landroidx/camera/camera2/internal/StreamUseCaseUtil;->a:Landroidx/camera/core/impl/Config$Option;

    invoke-interface {v3, v5}, Landroidx/camera/core/impl/Config;->e(Landroidx/camera/core/impl/Config$Option;)Z
    ...
    invoke-interface {v2, v5}, Landroidx/camera/core/impl/Config;->a(Landroidx/camera/core/impl/Config$Option;)Ljava/lang/Object;
