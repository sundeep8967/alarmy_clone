...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/preference/Preference;->l0(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
    ...
    invoke-virtual {p1}, Landroidx/preference/PreferenceScreen;->I0()Z
    ...
    :goto_0
    invoke-virtual {p0}, Landroidx/preference/PreferenceGroupAdapter;->o()V

    return-void
.end method

.method private h(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Landroidx/preference/ExpandButton;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2}, Landroidx/preference/Preference;->m0(Landroidx/preference/Preference$OnPreferenceClickListener;)V

    return-object v0
.end method

.method private i(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/preference/PreferenceGroupAdapter;->l(Landroidx/preference/PreferenceGroup;)Z
    ...
    invoke-direct {p0, v5}, Landroidx/preference/PreferenceGroupAdapter;->l(Landroidx/preference/PreferenceGroup;)Z
    ...
    :cond_6
    :goto_3
    invoke-direct {p0, v5}, Landroidx/preference/PreferenceGroupAdapter;->i(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v1}, Landroidx/preference/PreferenceGroupAdapter;->h(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Landroidx/preference/ExpandButton;
...
.method private j(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2}, Landroidx/preference/PreferenceGroup;->H0()V
    ...
    invoke-direct {p0, p1, v3}, Landroidx/preference/PreferenceGroupAdapter;->j(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    :cond_1
    invoke-virtual {v2, p0}, Landroidx/preference/Preference;->l0(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
...
.method private l(Landroidx/preference/PreferenceGroup;)Z
    .locals 1
...
.method public getItemId(I)J
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/preference/PreferenceGroupAdapter;->k(I)Landroidx/preference/Preference;
...
.method public k(I)Landroidx/preference/Preference;
    .locals 1
...
.method public m(Landroidx/preference/PreferenceViewHolder;I)V
    .locals 0

    invoke-virtual {p0, p2}, Landroidx/preference/PreferenceGroupAdapter;->k(I)Landroidx/preference/Preference;

    move-result-object p2

    invoke-virtual {p1}, Landroidx/preference/PreferenceViewHolder;->g()V

    invoke-virtual {p2, p1}, Landroidx/preference/Preference;->N(Landroidx/preference/PreferenceViewHolder;)V

    return-void
.end method

.method public n(Landroid/view/ViewGroup;I)Landroidx/preference/PreferenceViewHolder;
    .locals 4
    ...
    invoke-static {p1, v2}, Landroidx/core/view/ViewCompat;->s0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method o()V
    ...
    invoke-virtual {v1, v2}, Landroidx/preference/Preference;->l0(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
    ...
    invoke-direct {p0, v1, v0}, Landroidx/preference/PreferenceGroupAdapter;->j(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    iget-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;->k:Ljava/util/List;

    iget-object v1, p0, Landroidx/preference/PreferenceGroupAdapter;->i:Landroidx/preference/PreferenceGroup;

    invoke-direct {p0, v1}, Landroidx/preference/PreferenceGroupAdapter;->i(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    invoke-virtual {v2}, Landroidx/preference/Preference;->y()Landroidx/preference/PreferenceManager;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Landroidx/preference/PreferenceManager;->h()Landroidx/preference/PreferenceManager$PreferenceComparisonCallback;
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/preference/PreferenceGroupAdapter;->m(Landroidx/preference/PreferenceViewHolder;I)V
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/preference/PreferenceGroupAdapter;->n(Landroid/view/ViewGroup;I)Landroidx/preference/PreferenceViewHolder;
