...
# instance fields
.field private final b:Landroidx/media3/exoplayer/offline/DownloadService$ForegroundNotificationUpdater;
...
.field private f:Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;
...
.method static synthetic a(Landroidx/media3/exoplayer/offline/DownloadService;)Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;
    ...
    iget-object p0, p0, Landroidx/media3/exoplayer/offline/DownloadService;->f:Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;
...
.method static synthetic b(Landroidx/media3/exoplayer/offline/DownloadService;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/offline/DownloadService;->k(Ljava/util/List;)V

    return-void
.end method

.method static synthetic c(Landroidx/media3/exoplayer/offline/DownloadService;)Z
    .locals 0

    invoke-direct {p0}, Landroidx/media3/exoplayer/offline/DownloadService;->i()Z
...
.method static synthetic d(Landroid/content/Context;Ljava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1, p2}, Landroidx/media3/exoplayer/offline/DownloadService;->g(Landroid/content/Context;Ljava/lang/Class;Ljava/lang/String;)Landroid/content/Intent;
...
.method private k(Ljava/util/List;)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/offline/DownloadService;->b:Landroidx/media3/exoplayer/offline/DownloadService$ForegroundNotificationUpdater;
    ...
    iget v1, v1, Landroidx/media3/exoplayer/offline/Download;->b:I

    invoke-static {v1}, Landroidx/media3/exoplayer/offline/DownloadService;->j(I)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object p1, p0, Landroidx/media3/exoplayer/offline/DownloadService;->b:Landroidx/media3/exoplayer/offline/DownloadService$ForegroundNotificationUpdater;
...
.method private l()V
    ...
    invoke-virtual {v0}, Landroidx/media3/exoplayer/offline/DownloadService$ForegroundNotificationUpdater;->d()V

    :cond_0
    iget-object v0, p0, Landroidx/media3/exoplayer/offline/DownloadService;->f:Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;
    ...
    invoke-virtual {v0}, Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;->m()Z
...
# virtual methods
.method protected abstract e()Landroidx/media3/exoplayer/offline/DownloadManager;
.end method
...
.method protected abstract h()Landroidx/media3/exoplayer/scheduler/Scheduler;
.end method
...
.method public onCreate()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/offline/DownloadService;->c:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget v1, p0, Landroidx/media3/exoplayer/offline/DownloadService;->d:I

    iget v2, p0, Landroidx/media3/exoplayer/offline/DownloadService;->e:I
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/offline/DownloadService;->b:Landroidx/media3/exoplayer/offline/DownloadService$ForegroundNotificationUpdater;
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/offline/DownloadService;->h()Landroidx/media3/exoplayer/scheduler/Scheduler;
    ...
    :goto_2
    invoke-virtual {p0}, Landroidx/media3/exoplayer/offline/DownloadService;->e()Landroidx/media3/exoplayer/offline/DownloadManager;

    move-result-object v6

    invoke-virtual {v6}, Landroidx/media3/exoplayer/offline/DownloadManager;->p()V
    ...
    :cond_4
    iput-object v2, p0, Landroidx/media3/exoplayer/offline/DownloadService;->f:Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;

    invoke-virtual {v2, p0}, Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;->f(Landroidx/media3/exoplayer/offline/DownloadService;)V
...
.method public onDestroy()V
    ...
    invoke-virtual {v0, p0}, Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;->h(Landroidx/media3/exoplayer/offline/DownloadService;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-boolean v4, p0, Landroidx/media3/exoplayer/offline/DownloadService;->h:Z
    ...
    iput-boolean v4, p0, Landroidx/media3/exoplayer/offline/DownloadService;->h:Z
    ...
    :cond_3
    iget-object v4, p0, Landroidx/media3/exoplayer/offline/DownloadService;->f:Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;
    ...
    invoke-static {v4}, Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;->e(Landroidx/media3/exoplayer/offline/DownloadService$DownloadManagerHelper;)Landroidx/media3/exoplayer/offline/DownloadManager;
    ...
    :pswitch_0
    invoke-virtual {v4}, Landroidx/media3/exoplayer/offline/DownloadManager;->m()V
    ...
    :cond_d
    invoke-virtual {v4, p1}, Landroidx/media3/exoplayer/offline/DownloadManager;->r(Landroidx/media3/exoplayer/scheduler/Requirements;)V
    ...
    invoke-virtual {v4, p2, p1}, Landroidx/media3/exoplayer/offline/DownloadManager;->a(Landroidx/media3/exoplayer/offline/DownloadRequest;I)V

    goto :goto_4

    :pswitch_3
    invoke-virtual {v4}, Landroidx/media3/exoplayer/offline/DownloadManager;->n()V

    goto :goto_4

    :pswitch_4
    invoke-virtual {v4}, Landroidx/media3/exoplayer/offline/DownloadManager;->p()V
    ...
    :cond_f
    invoke-virtual {v4, v3}, Landroidx/media3/exoplayer/offline/DownloadManager;->o(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v3, p1}, Landroidx/media3/exoplayer/offline/DownloadManager;->s(Ljava/lang/String;I)V
    ...
    :cond_11
    iput-boolean p3, p0, Landroidx/media3/exoplayer/offline/DownloadService;->j:Z

    invoke-virtual {v4}, Landroidx/media3/exoplayer/offline/DownloadManager;->g()Z

    move-result p1

    if-eqz p1, :cond_12

    invoke-direct {p0}, Landroidx/media3/exoplayer/offline/DownloadService;->l()V
