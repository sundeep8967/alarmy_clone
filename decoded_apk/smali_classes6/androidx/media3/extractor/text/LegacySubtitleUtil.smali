...
.method private static a(Landroidx/media3/extractor/text/Subtitle;J)I
    .locals 3
...
.method private static b(Landroidx/media3/extractor/text/Subtitle;ILandroidx/media3/common/util/Consumer;)V
    .locals 6
...
.method public static c(Landroidx/media3/extractor/text/Subtitle;Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;Landroidx/media3/common/util/Consumer;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-wide v0, p1, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J

    invoke-static {p0, v0, v1}, Landroidx/media3/extractor/text/LegacySubtitleUtil;->a(Landroidx/media3/extractor/text/Subtitle;J)I

    move-result v0

    iget-wide v1, p1, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J
    ...
    iget-wide v3, p1, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J
    ...
    iget-wide v7, p1, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J
    ...
    invoke-static {p0, v3, p2}, Landroidx/media3/extractor/text/LegacySubtitleUtil;->b(Landroidx/media3/extractor/text/Subtitle;ILandroidx/media3/common/util/Consumer;)V
    ...
    :cond_1
    iget-boolean v3, p1, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->b:Z
    ...
    invoke-static {p0, v2, p2}, Landroidx/media3/extractor/text/LegacySubtitleUtil;->b(Landroidx/media3/extractor/text/Subtitle;ILandroidx/media3/common/util/Consumer;)V
    ...
    iget-wide v2, p1, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J
