...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media3/extractor/mkv/Sniffer;->a:Landroidx/media3/common/util/ParsableByteArray;
...
.method private a(Landroidx/media3/extractor/ExtractorInput;)J
    ...
    iget-object v0, p0, Landroidx/media3/extractor/mkv/Sniffer;->a:Landroidx/media3/common/util/ParsableByteArray;
    ...
    iget-object v3, p0, Landroidx/media3/extractor/mkv/Sniffer;->a:Landroidx/media3/common/util/ParsableByteArray;
    ...
    :cond_2
    iget p1, p0, Landroidx/media3/extractor/mkv/Sniffer;->b:I

    add-int/2addr v4, v2

    add-int/2addr p1, v4

    iput p1, p0, Landroidx/media3/extractor/mkv/Sniffer;->b:I
...
# virtual methods
.method public b(Landroidx/media3/extractor/ExtractorInput;)Z
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v4}, Landroidx/media3/common/util/ParsableByteArray;->J()J

    move-result-wide v7

    iput v6, p0, Landroidx/media3/extractor/mkv/Sniffer;->b:I
    ...
    iget v4, p0, Landroidx/media3/extractor/mkv/Sniffer;->b:I

    add-int/2addr v4, v6

    iput v4, p0, Landroidx/media3/extractor/mkv/Sniffer;->b:I
    ...
    :cond_3
    invoke-direct {p0, p1}, Landroidx/media3/extractor/mkv/Sniffer;->a(Landroidx/media3/extractor/ExtractorInput;)J

    move-result-wide v3

    iget v7, p0, Landroidx/media3/extractor/mkv/Sniffer;->b:I
