...
.method public static synthetic b(Landroidx/camera/view/PreviewStreamStateObserver;Landroidx/camera/core/CameraInfo;Ljava/util/List;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/camera/view/PreviewStreamStateObserver;->i(Landroidx/camera/core/CameraInfo;Ljava/util/List;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
...
.method public static synthetic c(Landroidx/camera/view/PreviewStreamStateObserver;Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/view/PreviewStreamStateObserver;->g(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
...
.method public static synthetic d(Landroidx/camera/view/PreviewStreamStateObserver;Ljava/lang/Void;)Ljava/lang/Void;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/view/PreviewStreamStateObserver;->h(Ljava/lang/Void;)Ljava/lang/Void;
...
.method private e()V
    ...
    iget-object v0, p0, Landroidx/camera/view/PreviewStreamStateObserver;->e:Lcom/google/common/util/concurrent/m;
    ...
    iput-object v0, p0, Landroidx/camera/view/PreviewStreamStateObserver;->e:Lcom/google/common/util/concurrent/m;
...
.method private synthetic g(Ljava/lang/Void;)Lcom/google/common/util/concurrent/m;
    ...
    invoke-virtual {p1}, Landroidx/camera/view/PreviewViewImplementation;->j()Lcom/google/common/util/concurrent/m;
...
.method private synthetic h(Ljava/lang/Void;)Ljava/lang/Void;
    ...
    sget-object p1, Landroidx/camera/view/PreviewView$StreamState;->c:Landroidx/camera/view/PreviewView$StreamState;
...
.method private synthetic i(Landroidx/camera/core/CameraInfo;Ljava/util/List;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private k(Landroidx/camera/core/CameraInfo;)V
    .locals 4
    ...
    invoke-direct {p0, p1, v0}, Landroidx/camera/view/PreviewStreamStateObserver;->m(Landroidx/camera/core/CameraInfo;Ljava/util/List;)Lcom/google/common/util/concurrent/m;
    ...
    invoke-direct {v2, p0}, Landroidx/camera/view/k;-><init>(Landroidx/camera/view/PreviewStreamStateObserver;)V

    invoke-static {}, Landroidx/camera/core/impl/utils/executor/CameraXExecutors;->b()Ljava/util/concurrent/Executor;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Landroidx/camera/core/impl/utils/futures/FutureChain;->f(Landroidx/camera/core/impl/utils/futures/AsyncFunction;Ljava/util/concurrent/Executor;)Landroidx/camera/core/impl/utils/futures/FutureChain;
    ...
    invoke-virtual {v1, v2, v3}, Landroidx/camera/core/impl/utils/futures/FutureChain;->e(Landroidx/arch/core/util/Function;Ljava/util/concurrent/Executor;)Landroidx/camera/core/impl/utils/futures/FutureChain;

    move-result-object v1

    iput-object v1, p0, Landroidx/camera/view/PreviewStreamStateObserver;->e:Lcom/google/common/util/concurrent/m;
...
.method private m(Landroidx/camera/core/CameraInfo;Ljava/util/List;)Lcom/google/common/util/concurrent/m;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Landroidx/camera/view/m;-><init>(Landroidx/camera/view/PreviewStreamStateObserver;Landroidx/camera/core/CameraInfo;Ljava/util/List;)V
...
.method f()V
    ...
    invoke-direct {p0}, Landroidx/camera/view/PreviewStreamStateObserver;->e()V
...
.method public j(Landroidx/camera/core/impl/CameraInternal$State;)V
    ...
    :cond_0
    sget-object v0, Landroidx/camera/core/impl/CameraInternal$State;->h:Landroidx/camera/core/impl/CameraInternal$State;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/view/PreviewStreamStateObserver;->k(Landroidx/camera/core/CameraInfo;)V
