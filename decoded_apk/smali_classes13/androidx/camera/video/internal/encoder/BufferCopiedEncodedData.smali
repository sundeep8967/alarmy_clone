...
.method public constructor <init>(Landroidx/camera/video/internal/encoder/EncodedData;)V
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/BufferCopiedEncodedData;->e(Landroidx/camera/video/internal/encoder/EncodedData;)Landroid/media/MediaCodec$BufferInfo;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/BufferCopiedEncodedData;->d(Landroidx/camera/video/internal/encoder/EncodedData;)Ljava/nio/ByteBuffer;
    ...
    iput-object v0, p0, Landroidx/camera/video/internal/encoder/BufferCopiedEncodedData;->d:Lcom/google/common/util/concurrent/m;
...
.method public static synthetic b(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/internal/encoder/BufferCopiedEncodedData;->h(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
...
.method private d(Landroidx/camera/video/internal/encoder/EncodedData;)Ljava/nio/ByteBuffer;
    .locals 3

    invoke-interface {p1}, Landroidx/camera/video/internal/encoder/EncodedData;->F()Ljava/nio/ByteBuffer;

    move-result-object v0

    invoke-interface {p1}, Landroidx/camera/video/internal/encoder/EncodedData;->L()Landroid/media/MediaCodec$BufferInfo;
...
.method private e(Landroidx/camera/video/internal/encoder/EncodedData;)Landroid/media/MediaCodec$BufferInfo;
    .locals 7
...
.method private static synthetic h(Ljava/util/concurrent/atomic/AtomicReference;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
