...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/media3/extractor/mp4/SefReader;->d:Lcom/google/common/base/t;
    ...
    sput-object v0, Landroidx/media3/extractor/mp4/SefReader;->e:Lcom/google/common/base/t;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media3/extractor/mp4/SefReader;->a:Ljava/util/List;

    const/4 v0, 0x0

    iput v0, p0, Landroidx/media3/extractor/mp4/SefReader;->b:I
...
.method private a(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)V
    ...
    iput v2, p0, Landroidx/media3/extractor/mp4/SefReader;->c:I
    ...
    iget p1, p0, Landroidx/media3/extractor/mp4/SefReader;->c:I
    ...
    iput p1, p0, Landroidx/media3/extractor/mp4/SefReader;->b:I
...
.method private d(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)V
    ...
    iget v2, p0, Landroidx/media3/extractor/mp4/SefReader;->c:I
    ...
    invoke-virtual {v3, v4}, Landroidx/media3/common/util/ParsableByteArray;->V(I)V

    invoke-virtual {v3}, Landroidx/media3/common/util/ParsableByteArray;->w()S
    ...
    :cond_0
    iget v6, p0, Landroidx/media3/extractor/mp4/SefReader;->c:I

    int-to-long v6, v6

    sub-long v6, v0, v6

    invoke-virtual {v3}, Landroidx/media3/common/util/ParsableByteArray;->u()I
    ...
    iget-object v9, p0, Landroidx/media3/extractor/mp4/SefReader;->a:Ljava/util/List;
    ...
    :cond_1
    iget-object p1, p0, Landroidx/media3/extractor/mp4/SefReader;->a:Ljava/util/List;
    ...
    iget-wide v0, p1, Landroidx/media3/extractor/mp4/SefReader$DataReference;->b:J
...
.method private e(Landroidx/media3/extractor/ExtractorInput;Ljava/util/List;)V
    ...
    iget v4, p0, Landroidx/media3/extractor/mp4/SefReader;->c:I
    ...
    iget-wide v6, p1, Landroidx/media3/extractor/mp4/SefReader$DataReference;->b:J
    ...
    invoke-virtual {v3, v2}, Landroidx/media3/common/util/ParsableByteArray;->V(I)V

    invoke-virtual {v3}, Landroidx/media3/common/util/ParsableByteArray;->u()I

    move-result v2

    invoke-virtual {v3, v2}, Landroidx/media3/common/util/ParsableByteArray;->E(I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, Landroidx/media3/extractor/mp4/SefReader;->b(Ljava/lang/String;)I

    move-result v4

    iget p1, p1, Landroidx/media3/extractor/mp4/SefReader$DataReference;->c:I
    ...
    :cond_1
    invoke-static {v3, p1}, Landroidx/media3/extractor/mp4/SefReader;->f(Landroidx/media3/common/util/ParsableByteArray;I)Landroidx/media3/extractor/metadata/mp4/SlowMotionData;
...
.method private static f(Landroidx/media3/common/util/ParsableByteArray;I)Landroidx/media3/extractor/metadata/mp4/SlowMotionData;
    ...
    sget-object p1, Landroidx/media3/extractor/mp4/SefReader;->e:Lcom/google/common/base/t;
    ...
    sget-object v2, Landroidx/media3/extractor/mp4/SefReader;->d:Lcom/google/common/base/t;
    ...
    invoke-static {v5, p0}, Landroidx/media3/common/ParserException;->b(Ljava/lang/String;Ljava/lang/Throwable;)Landroidx/media3/common/ParserException;
    ...
    :cond_0
    invoke-static {v5, v5}, Landroidx/media3/common/ParserException;->b(Ljava/lang/String;Ljava/lang/Throwable;)Landroidx/media3/common/ParserException;
...
.method public c(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;Ljava/util/List;)I
    ...
    iget v0, p0, Landroidx/media3/extractor/mp4/SefReader;->b:I
    ...
    invoke-direct {p0, p1, p3}, Landroidx/media3/extractor/mp4/SefReader;->e(Landroidx/media3/extractor/ExtractorInput;Ljava/util/List;)V

    iput-wide v1, p2, Landroidx/media3/extractor/PositionHolder;->a:J
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/media3/extractor/mp4/SefReader;->d(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)V

    goto :goto_1

    :cond_2
    invoke-direct {p0, p1, p2}, Landroidx/media3/extractor/mp4/SefReader;->a(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)V
    ...
    iput v3, p0, Landroidx/media3/extractor/mp4/SefReader;->b:I
...
.method public g()V
    ...
    iget-object v0, p0, Landroidx/media3/extractor/mp4/SefReader;->a:Ljava/util/List;
