...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/media3/datasource/ContentDataSource;->r:Landroid/content/ContentResolver;
...
.method public close()V
    ...
    iput-object v0, p0, Landroidx/media3/datasource/ContentDataSource;->s:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/media3/datasource/ContentDataSource;->u:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Landroidx/media3/datasource/ContentDataSource;->u:Ljava/io/FileInputStream;

    :try_start_1
    iget-object v3, p0, Landroidx/media3/datasource/ContentDataSource;->t:Landroid/content/res/AssetFileDescriptor;
    ...
    :cond_1
    :goto_1
    iput-object v0, p0, Landroidx/media3/datasource/ContentDataSource;->t:Landroid/content/res/AssetFileDescriptor;

    iget-boolean v0, p0, Landroidx/media3/datasource/ContentDataSource;->w:Z

    if-eqz v0, :cond_2

    iput-boolean v2, p0, Landroidx/media3/datasource/ContentDataSource;->w:Z
    ...
    :try_start_4
    iget-object v4, p0, Landroidx/media3/datasource/ContentDataSource;->t:Landroid/content/res/AssetFileDescriptor;
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroidx/media3/datasource/ContentDataSource;->s:Landroid/net/Uri;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    iput-object v3, v1, Landroidx/media3/datasource/ContentDataSource;->s:Landroid/net/Uri;
    ...
    iget-object v6, v1, Landroidx/media3/datasource/ContentDataSource;->r:Landroid/content/ContentResolver;
    ...
    :cond_0
    iget-object v4, v1, Landroidx/media3/datasource/ContentDataSource;->r:Landroid/content/ContentResolver;
    ...
    :goto_0
    iput-object v4, v1, Landroidx/media3/datasource/ContentDataSource;->t:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v3, v1, Landroidx/media3/datasource/ContentDataSource;->u:Ljava/io/FileInputStream;
    ...
    iput-wide v8, v1, Landroidx/media3/datasource/ContentDataSource;->v:J
    ...
    iput-wide v5, v1, Landroidx/media3/datasource/ContentDataSource;->v:J
    ...
    iput-wide v6, v1, Landroidx/media3/datasource/ContentDataSource;->v:J
    :try_end_0
    ...
    :goto_2
    iget-wide v2, v0, Landroidx/media3/datasource/DataSpec;->h:J

    cmp-long v5, v2, v8

    if-eqz v5, :cond_7

    iget-wide v5, v1, Landroidx/media3/datasource/ContentDataSource;->v:J
    ...
    :goto_3
    iput-wide v2, v1, Landroidx/media3/datasource/ContentDataSource;->v:J

    :cond_7
    const/4 v2, 0x1

    iput-boolean v2, v1, Landroidx/media3/datasource/ContentDataSource;->w:Z
    ...
    :cond_8
    iget-wide v2, v1, Landroidx/media3/datasource/ContentDataSource;->v:J
...
.method public read([BII)I
    ...
    :cond_0
    iget-wide v0, p0, Landroidx/media3/datasource/ContentDataSource;->v:J
    ...
    :goto_0
    iget-object v0, p0, Landroidx/media3/datasource/ContentDataSource;->u:Ljava/io/FileInputStream;
    ...
    :cond_3
    iget-wide p2, p0, Landroidx/media3/datasource/ContentDataSource;->v:J
    ...
    iput-wide p2, p0, Landroidx/media3/datasource/ContentDataSource;->v:J
