...
.method private a()Landroidx/appcompat/view/menu/MenuPopup;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/MenuPopup;->t(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/MenuPopup;->o(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/MenuPopup;->q(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->g:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/MenuPopup;->r(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/MenuPopup;->u(Z)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/MenuPopup;->s(I)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/MenuPopup;->v(I)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/MenuPopup;->p(Landroid/graphics/Rect;)V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/MenuPopup;->q(Z)V
