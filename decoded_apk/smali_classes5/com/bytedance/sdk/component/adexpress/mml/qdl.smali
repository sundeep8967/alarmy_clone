...
.method public static ud(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 41
    invoke-static/range {v1 .. v6}, Lla/a;->a(IIIIJ)Landroid/media/ImageReader;
    ...
    invoke-static {v1}, Landroidx/compose/foundation/j;->a(Ljava/lang/String;)Landroid/graphics/RenderNode;
    ...
    invoke-static {v2, v3}, Lla/h;->a(Landroid/graphics/HardwareRenderer;Landroid/view/Surface;)V

    .line 45
    invoke-static {v2, v1}, Lla/i;->a(Landroid/graphics/HardwareRenderer;Landroid/graphics/RenderNode;)V
    ...
    invoke-static {v3, v3, v4}, Landroidx/compose/ui/graphics/q0;->a(FFLandroid/graphics/Shader$TileMode;)Landroid/graphics/RenderEffect;

    move-result-object v3

    .line 48
    invoke-static {v1, v3}, Landroidx/compose/ui/graphics/layer/z;->a(Landroid/graphics/RenderNode;Landroid/graphics/RenderEffect;)Z
    ...
    .line 50
    invoke-static {v3, p0, v5, v5, v4}, Lla/j;->a(Landroid/graphics/RecordingCanvas;Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V

    .line 51
    invoke-static {v1}, Landroidx/compose/foundation/h;->a(Landroid/graphics/RenderNode;)V

    .line 52
    invoke-static {v2}, Lla/k;->a(Landroid/graphics/HardwareRenderer;)Landroid/graphics/HardwareRenderer$FrameRenderRequest;

    move-result-object v3

    const/4 v5, 0x1

    invoke-static {v3, v5}, Lla/d;->a(Landroid/graphics/HardwareRenderer$FrameRenderRequest;Z)Landroid/graphics/HardwareRenderer$FrameRenderRequest;

    move-result-object v3

    invoke-static {v3}, Lla/e;->a(Landroid/graphics/HardwareRenderer$FrameRenderRequest;)I
    ...
    .line 55
    invoke-static {v5, v4}, Lla/f;->a(Landroid/hardware/HardwareBuffer;Landroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;
    ...
    .line 59
    invoke-static {v1}, Landroidx/compose/ui/graphics/layer/g;->a(Landroid/graphics/RenderNode;)V

    .line 60
    invoke-static {v2}, Lla/g;->a(Landroid/graphics/HardwareRenderer;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
