...
.method constructor <init>(Ljava/io/File;Lcom/google/android/exoplayer2/upstream/cache/b;Lcom/google/android/exoplayer2/upstream/cache/f;Lcom/google/android/exoplayer2/upstream/cache/d;)V
    ...
    .line 6
    invoke-static {p1}, Lcom/google/android/exoplayer2/upstream/cache/h;->t(Ljava/io/File;)Z
...
.method public constructor <init>(Ljava/io/File;Lcom/google/android/exoplayer2/upstream/cache/b;Lko/a;)V
    .locals 7
    ...
    .line 1
    invoke-direct/range {v0 .. v6}, Lcom/google/android/exoplayer2/upstream/cache/h;-><init>(Ljava/io/File;Lcom/google/android/exoplayer2/upstream/cache/b;Lko/a;[BZZ)V

    return-void
.end method

.method public constructor <init>(Ljava/io/File;Lcom/google/android/exoplayer2/upstream/cache/b;Lko/a;[BZZ)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/exoplayer2/upstream/cache/f;-><init>(Lko/a;Ljava/io/File;[BZZ)V
    ...
    invoke-direct {p4, p3}, Lcom/google/android/exoplayer2/upstream/cache/d;-><init>(Lko/a;)V
...
.method private A(Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/cache/i;)Lcom/google/android/exoplayer2/upstream/cache/i;
    .locals 9
    ...
    :cond_0
    iget-object v0, p2, Lfp/c;->f:Ljava/io/File;
    ...
    invoke-direct {p0, p2, p1}, Lcom/google/android/exoplayer2/upstream/cache/h;->w(Lcom/google/android/exoplayer2/upstream/cache/i;Lfp/c;)V
...
.method static synthetic i(Lcom/google/android/exoplayer2/upstream/cache/h;)V
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/cache/h;->q()V
...
.method private k(Lcom/google/android/exoplayer2/upstream/cache/i;)V
    ...
    iget-wide v2, p1, Lfp/c;->d:J

    add-long/2addr v0, v2

    iput-wide v0, p0, Lcom/google/android/exoplayer2/upstream/cache/h;->i:J

    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/h;->u(Lcom/google/android/exoplayer2/upstream/cache/i;)V
...
.method private p(Ljava/lang/String;JJ)Lcom/google/android/exoplayer2/upstream/cache/i;
    .locals 5
    ...
    iget-boolean v1, p1, Lfp/c;->e:Z

    if-eqz v1, :cond_1

    iget-object v1, p1, Lfp/c;->f:Ljava/io/File;

    invoke-virtual {v1}, Ljava/io/File;->length()J

    move-result-wide v1

    iget-wide v3, p1, Lfp/c;->d:J

    cmp-long v1, v1, v3

    if-eqz v1, :cond_1

    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/cache/h;->z()V
...
.method private q()V
    ...
    :cond_1
    invoke-static {v0}, Lcom/google/android/exoplayer2/upstream/cache/h;->s([Ljava/io/File;)J
    ...
    invoke-direct {p0, v4, v3, v0, v2}, Lcom/google/android/exoplayer2/upstream/cache/h;->r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    ...
    invoke-direct {p0, v2, v3, v0, v4}, Lcom/google/android/exoplayer2/upstream/cache/h;->r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    :try_end_2
...
.method private r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
    ...
    invoke-direct {p0, v8, v0, v2, p4}, Lcom/google/android/exoplayer2/upstream/cache/h;->r(Ljava/io/File;Z[Ljava/io/File;Ljava/util/Map;)V
...
.method private static s([Ljava/io/File;)J
    ...
    :try_start_0
    invoke-static {v3}, Lcom/google/android/exoplayer2/upstream/cache/h;->x(Ljava/lang/String;)J
    ...
    invoke-static {v4, v3}, Lcom/google/android/exoplayer2/util/t;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method private u(Lcom/google/android/exoplayer2/upstream/cache/i;)V
    .locals 3
    ...
    invoke-interface {v2, p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/Cache$a;->onSpanAdded(Lcom/google/android/exoplayer2/upstream/cache/Cache;Lfp/c;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/Cache$a;->onSpanAdded(Lcom/google/android/exoplayer2/upstream/cache/Cache;Lfp/c;)V

    return-void
.end method

.method private v(Lfp/c;)V
    .locals 3
    ...
    invoke-interface {v2, p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/Cache$a;->onSpanRemoved(Lcom/google/android/exoplayer2/upstream/cache/Cache;Lfp/c;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/Cache$a;->onSpanRemoved(Lcom/google/android/exoplayer2/upstream/cache/Cache;Lfp/c;)V

    return-void
.end method

.method private w(Lcom/google/android/exoplayer2/upstream/cache/i;Lfp/c;)V
    .locals 3
    ...
    invoke-interface {v2, p0, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/Cache$a;->onSpanTouched(Lcom/google/android/exoplayer2/upstream/cache/Cache;Lfp/c;Lfp/c;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/Cache$a;->onSpanTouched(Lcom/google/android/exoplayer2/upstream/cache/Cache;Lfp/c;Lfp/c;)V
...
.method private y(Lfp/c;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/upstream/cache/e;->k(Lfp/c;)Z
    ...
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/h;->v(Lfp/c;)V
...
.method private z()V
    ...
    iget-object v4, v3, Lfp/c;->f:Ljava/io/File;
    ...
    invoke-direct {p0, v2}, Lcom/google/android/exoplayer2/upstream/cache/h;->y(Lfp/c;)V
...
# virtual methods
.method public declared-synchronized a(Ljava/lang/String;JJ)Lfp/c;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    :goto_0
    invoke-virtual/range {p0 .. p5}, Lcom/google/android/exoplayer2/upstream/cache/h;->d(Ljava/lang/String;JJ)Lfp/c;
...
.method public declared-synchronized b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/h;->o(Ljava/lang/String;)Ljava/util/NavigableSet;
    ...
    invoke-direct {p0, v0}, Lcom/google/android/exoplayer2/upstream/cache/h;->y(Lfp/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized c(Ljava/lang/String;JJ)J
    ...
    :try_start_0
    invoke-virtual/range {v1 .. v6}, Lcom/google/android/exoplayer2/upstream/cache/h;->getCachedLength(Ljava/lang/String;JJ)J
...
.method public declared-synchronized d(Ljava/lang/String;JJ)Lfp/c;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/upstream/cache/Cache$CacheException;
    ...
    invoke-direct/range {p0 .. p5}, Lcom/google/android/exoplayer2/upstream/cache/h;->p(Ljava/lang/String;JJ)Lcom/google/android/exoplayer2/upstream/cache/i;

    move-result-object p4

    iget-boolean p5, p4, Lfp/c;->e:Z

    if-eqz p5, :cond_0

    invoke-direct {p0, p1, p4}, Lcom/google/android/exoplayer2/upstream/cache/h;->A(Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/cache/i;)Lcom/google/android/exoplayer2/upstream/cache/i;
...
.method public declared-synchronized e(Ljava/io/File;J)V
    ...
    iget-object v0, p2, Lfp/c;->b:Ljava/lang/String;
    ...
    iget-wide v3, p2, Lfp/c;->c:J

    iget-wide v5, p2, Lfp/c;->d:J
    ...
    invoke-virtual {p3}, Lcom/google/android/exoplayer2/upstream/cache/e;->d()Lfp/g;

    move-result-object p3

    invoke-static {p3}, Lfp/e;->a(Lfp/e;)J
    ...
    iget-wide v5, p2, Lfp/c;->c:J

    iget-wide v7, p2, Lfp/c;->d:J
...
.method public declared-synchronized f(Lfp/c;)V
    .locals 3
...
.method public declared-synchronized g(Lfp/c;)V
    .locals 1
    ...
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/h;->y(Lfp/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized getContentMetadata(Ljava/lang/String;)Lfp/e;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/upstream/cache/f;->j(Ljava/lang/String;)Lfp/e;
...
.method public declared-synchronized h(Ljava/lang/String;Lfp/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/upstream/cache/Cache$CacheException;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/exoplayer2/upstream/cache/f;->e(Ljava/lang/String;Lfp/f;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
