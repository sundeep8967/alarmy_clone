...
.method private d(Lcom/google/zxing/c;Ljava/util/Map;)Lcom/google/zxing/m;
    .locals 21
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/zxing/c;->c()I

    move-result v2

    new-instance v3, Lcs/a;

    invoke-direct {v3, v1}, Lcs/a;-><init>(I)V
    ...
    :try_start_0
    invoke-virtual {v9, v11, v3}, Lcom/google/zxing/c;->b(ILcs/a;)Lcs/a;
    ...
    invoke-virtual {v3}, Lcs/a;->q()V

    if-eqz v0, :cond_4

    sget-object v13, Lcom/google/zxing/d;->l:Lcom/google/zxing/d;
    ...
    :goto_6
    :try_start_1
    invoke-virtual {v13, v11, v3, v0}, Lcom/google/zxing/oned/r;->c(ILcs/a;Ljava/util/Map;)Lcom/google/zxing/m;

    move-result-object v14

    if-ne v12, v5, :cond_5

    sget-object v15, Lcom/google/zxing/n;->c:Lcom/google/zxing/n;
    :try_end_1
    ...
    invoke-virtual {v14, v15, v5}, Lcom/google/zxing/m;->h(Lcom/google/zxing/n;Ljava/lang/Object;)V

    invoke-virtual {v14}, Lcom/google/zxing/m;->e()[Lcom/google/zxing/o;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/google/zxing/o;->c()F
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/google/zxing/o;->d()F

    move-result v4

    invoke-direct {v15, v1, v4}, Lcom/google/zxing/o;-><init>(FF)V
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/google/zxing/o;->c()F
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/google/zxing/o;->d()F
...
.method protected static f(Lcs/a;I[I)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/NotFoundException;
...
.method protected static g(Lcs/a;I[I)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/NotFoundException;
    ...
    invoke-static {p0, p1, p2}, Lcom/google/zxing/oned/r;->f(Lcs/a;I[I)V
...
.method public a(Lcom/google/zxing/c;Ljava/util/Map;)Lcom/google/zxing/m;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/google/zxing/oned/r;->d(Lcom/google/zxing/c;Ljava/util/Map;)Lcom/google/zxing/m;
    ...
    invoke-virtual {p1}, Lcom/google/zxing/c;->e()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p1}, Lcom/google/zxing/c;->f()Lcom/google/zxing/c;
    ...
    invoke-virtual {p2}, Lcom/google/zxing/m;->d()Ljava/util/Map;
    ...
    sget-object v2, Lcom/google/zxing/n;->c:Lcom/google/zxing/n;
    ...
    invoke-virtual {p2}, Lcom/google/zxing/m;->e()[Lcom/google/zxing/o;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lcom/google/zxing/c;->c()I
...
.method public b(Lcom/google/zxing/c;)Lcom/google/zxing/m;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/zxing/oned/r;->a(Lcom/google/zxing/c;Ljava/util/Map;)Lcom/google/zxing/m;
...
.method public abstract c(ILcs/a;Ljava/util/Map;)Lcom/google/zxing/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
            "Lcs/a;",
