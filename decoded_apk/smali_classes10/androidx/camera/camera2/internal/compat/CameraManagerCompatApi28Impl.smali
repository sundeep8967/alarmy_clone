...
.method static h(Landroid/content/Context;)Landroidx/camera/camera2/internal/compat/CameraManagerCompatApi28Impl;
    .locals 1
...
.method private i(Ljava/lang/Throwable;)Z
    ...
    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/CameraManagerCompatApi28Impl;->j(Ljava/lang/Throwable;)Z
...
.method public b(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraDevice$StateCallback;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/compat/CameraManagerCompatApi28Impl;->i(Ljava/lang/Throwable;)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/compat/CameraManagerCompatApi28Impl;->k(Ljava/lang/Throwable;)V
...
.method public d(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
    ...
    :try_start_0
    invoke-super {p0, p1}, Landroidx/camera/camera2/internal/compat/CameraManagerCompatBaseImpl;->d(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
