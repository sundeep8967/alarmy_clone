...
.field volatile c:Landroidx/concurrent/futures/AbstractResolvableFuture$Listener;

.field volatile d:Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-object v3, Landroidx/concurrent/futures/AbstractResolvableFuture;->g:Landroidx/concurrent/futures/AbstractResolvableFuture$AtomicHelper;
...
.method private g(Landroidx/concurrent/futures/AbstractResolvableFuture$Listener;)Landroidx/concurrent/futures/AbstractResolvableFuture$Listener;
    .locals 4

    :cond_0
    iget-object v0, p0, Landroidx/concurrent/futures/AbstractResolvableFuture;->c:Landroidx/concurrent/futures/AbstractResolvableFuture$Listener;
...
.method static h(Landroidx/concurrent/futures/AbstractResolvableFuture;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    invoke-direct {p0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->o()V

    invoke-virtual {p0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->b()V

    invoke-direct {p0, v0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->g(Landroidx/concurrent/futures/AbstractResolvableFuture$Listener;)Landroidx/concurrent/futures/AbstractResolvableFuture$Listener;
    ...
    iget-object p0, v1, Landroidx/concurrent/futures/AbstractResolvableFuture$SetFuture;->b:Landroidx/concurrent/futures/AbstractResolvableFuture;

    iget-object v2, p0, Landroidx/concurrent/futures/AbstractResolvableFuture;->b:Ljava/lang/Object;

    if-ne v2, v1, :cond_1

    iget-object v2, v1, Landroidx/concurrent/futures/AbstractResolvableFuture$SetFuture;->c:Lcom/google/common/util/concurrent/m;

    invoke-static {v2}, Landroidx/concurrent/futures/AbstractResolvableFuture;->k(Lcom/google/common/util/concurrent/m;)Ljava/lang/Object;
    ...
    invoke-static {v1, p0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->i(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method static k(Lcom/google/common/util/concurrent/m;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private o()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/concurrent/futures/AbstractResolvableFuture;->d:Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;
...
.method private p(Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;)V
    .locals 4
    ...
    :goto_0
    iget-object p1, p0, Landroidx/concurrent/futures/AbstractResolvableFuture;->d:Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;
...
.method public final cancel(Z)Z
    ...
    invoke-virtual {v4}, Landroidx/concurrent/futures/AbstractResolvableFuture;->m()V

    :cond_4
    invoke-static {v4}, Landroidx/concurrent/futures/AbstractResolvableFuture;->h(Landroidx/concurrent/futures/AbstractResolvableFuture;)V
    ...
    iget-object v0, v0, Landroidx/concurrent/futures/AbstractResolvableFuture$SetFuture;->c:Lcom/google/common/util/concurrent/m;
...
.method public final get()Ljava/lang/Object;
    ...
    .line 48
    invoke-direct {p0, v0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 59
    :cond_5
    invoke-direct {p0, v3}, Landroidx/concurrent/futures/AbstractResolvableFuture;->p(Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;)V
...
.method public final get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    .line 5
    invoke-direct {v0, v6}, Landroidx/concurrent/futures/AbstractResolvableFuture;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 7
    iget-object v6, v0, Landroidx/concurrent/futures/AbstractResolvableFuture;->d:Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;
    ...
    .line 16
    invoke-direct {v0, v4}, Landroidx/concurrent/futures/AbstractResolvableFuture;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 18
    invoke-direct {v0, v15}, Landroidx/concurrent/futures/AbstractResolvableFuture;->p(Landroidx/concurrent/futures/AbstractResolvableFuture$Waiter;)V
    ...
    invoke-direct {v0, v1}, Landroidx/concurrent/futures/AbstractResolvableFuture;->j(Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected q(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroidx/concurrent/futures/AbstractResolvableFuture;->h(Landroidx/concurrent/futures/AbstractResolvableFuture;)V
