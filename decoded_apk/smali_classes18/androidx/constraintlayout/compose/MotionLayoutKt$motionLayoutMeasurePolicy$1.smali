...
.field final synthetic d:Landroidx/constraintlayout/compose/ConstraintSet;

.field final synthetic e:Landroidx/constraintlayout/compose/TransitionImpl;

.field final synthetic f:I

.field final synthetic g:Landroidx/compose/runtime/MutableFloatState;

.field final synthetic h:Landroidx/compose/ui/node/Ref;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final synthetic i:Landroidx/constraintlayout/compose/InvalidationStrategy;
...
.method constructor <init>(Landroidx/compose/runtime/State;Landroidx/constraintlayout/compose/MotionMeasurer;Landroidx/constraintlayout/compose/ConstraintSet;Landroidx/constraintlayout/compose/ConstraintSet;Landroidx/constraintlayout/compose/TransitionImpl;ILandroidx/compose/runtime/MutableFloatState;Landroidx/compose/ui/node/Ref;Landroidx/constraintlayout/compose/InvalidationStrategy;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->a:Landroidx/compose/runtime/State;
...
.method public final measure-3p2s80s(Landroidx/compose/ui/layout/MeasureScope;Ljava/util/List;J)Landroidx/compose/ui/layout/MeasureResult;
    ...
    iget-object v1, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->a:Landroidx/compose/runtime/State;

    invoke-interface {v1}, Landroidx/compose/runtime/State;->getValue()Ljava/lang/Object;

    iget-object v2, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->b:Landroidx/constraintlayout/compose/MotionMeasurer;

    invoke-interface {p1}, Landroidx/compose/ui/layout/IntrinsicMeasureScope;->getLayoutDirection()Landroidx/compose/ui/unit/LayoutDirection;

    move-result-object v5

    iget-object v6, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->c:Landroidx/constraintlayout/compose/ConstraintSet;

    iget-object v7, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->d:Landroidx/constraintlayout/compose/ConstraintSet;

    iget-object v8, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->e:Landroidx/constraintlayout/compose/TransitionImpl;

    iget v10, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->f:I

    iget-object v1, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->g:Landroidx/compose/runtime/MutableFloatState;

    invoke-interface {v1}, Landroidx/compose/runtime/MutableFloatState;->c()F

    move-result v11

    iget-object v1, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->h:Landroidx/compose/ui/node/Ref;
    ...
    iget-object v1, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->i:Landroidx/constraintlayout/compose/InvalidationStrategy;

    invoke-virtual {v1}, Landroidx/constraintlayout/compose/InvalidationStrategy;->e()Landroidx/constraintlayout/compose/ShouldInvalidateCallback;
    ...
    iget-object v3, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->h:Landroidx/compose/ui/node/Ref;
    ...
    new-instance v9, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1$1;

    iget-object v1, v0, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1;->b:Landroidx/constraintlayout/compose/MotionMeasurer;

    move-object/from16 v2, p2

    invoke-direct {v9, v1, v2}, Landroidx/constraintlayout/compose/MotionLayoutKt$motionLayoutMeasurePolicy$1$1;-><init>(Landroidx/constraintlayout/compose/MotionMeasurer;Ljava/util/List;)V
