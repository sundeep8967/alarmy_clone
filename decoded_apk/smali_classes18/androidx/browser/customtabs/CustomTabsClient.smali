...
.method constructor <init>(Lb/b;Landroid/content/ComponentName;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsClient;->a:Lb/b;
...
.method private b(Landroidx/browser/customtabs/CustomTabsCallback;)Lb/a$a;
    .locals 1
...
.method public static c(Landroid/content/Context;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Landroidx/browser/customtabs/CustomTabsClient;->d(Landroid/content/Context;Ljava/util/List;Z)Ljava/lang/String;
...
.method private f(Landroidx/browser/customtabs/CustomTabsCallback;Landroid/app/PendingIntent;)Landroidx/browser/customtabs/CustomTabsSession;
    .locals 3

    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsClient;->b(Landroidx/browser/customtabs/CustomTabsCallback;)Lb/a$a;
    ...
    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsClient;->a:Lb/b;

    invoke-interface {v2, p1, v1}, Lb/b;->K(Lb/a;Landroid/os/Bundle;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsClient;->a:Lb/b;

    invoke-interface {v1, p1}, Lb/b;->q(Lb/a;)Z
    ...
    invoke-direct {v0, v1, p1, v2, p2}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Lb/b;Lb/a;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
# virtual methods
.method public e(Landroidx/browser/customtabs/CustomTabsCallback;)Landroidx/browser/customtabs/CustomTabsSession;
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Landroidx/browser/customtabs/CustomTabsClient;->f(Landroidx/browser/customtabs/CustomTabsCallback;Landroid/app/PendingIntent;)Landroidx/browser/customtabs/CustomTabsSession;
...
.method public g(J)Z
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsClient;->a:Lb/b;

    invoke-interface {v0, p1, p2}, Lb/b;->p(J)Z
