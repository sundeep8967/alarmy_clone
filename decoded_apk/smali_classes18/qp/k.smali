...
.method private static c(Ljava/lang/String;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p0, v0}, Lqp/k;->e(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0, v0}, Lqp/k;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lqp/k;->a([Ljava/lang/String;I)F

    move-result v0

    const/4 v1, 0x1

    invoke-static {p0, v1}, Lqp/k;->a([Ljava/lang/String;I)F

    move-result v1

    const/4 v2, 0x2

    invoke-static {p0, v2}, Lqp/k;->a([Ljava/lang/String;I)F

    move-result v2

    const/4 v3, 0x3

    invoke-static {p0, v3}, Lqp/k;->a([Ljava/lang/String;I)F
...
.method public static f(Landroid/content/Context;II)I
    ...
    invoke-static {p0, p1, p2}, Lrp/b;->d(Landroid/content/Context;II)I
...
.method public static g(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p1}, Lqp/k;->d(Ljava/lang/String;)Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-static {p1}, Lqp/k;->c(Ljava/lang/String;)Landroid/animation/TimeInterpolator;
...
.method public static h(Landroid/content/Context;II)Landroidx/dynamicanimation/animation/SpringForce;
    .locals 2
    ...
    invoke-virtual {p1, p2}, Landroidx/dynamicanimation/animation/SpringForce;->h(F)Landroidx/dynamicanimation/animation/SpringForce;

    invoke-virtual {p1, v1}, Landroidx/dynamicanimation/animation/SpringForce;->f(F)Landroidx/dynamicanimation/animation/SpringForce;
    :try_end_0
