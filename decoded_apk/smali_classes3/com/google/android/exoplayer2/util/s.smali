...
.field private final c:Lcom/google/android/exoplayer2/util/s$b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/android/exoplayer2/util/s$b<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Landroid/os/Looper;Lcom/google/android/exoplayer2/util/e;Lcom/google/android/exoplayer2/util/s$b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/google/android/exoplayer2/util/s;-><init>(Ljava/util/concurrent/CopyOnWriteArraySet;Landroid/os/Looper;Lcom/google/android/exoplayer2/util/e;Lcom/google/android/exoplayer2/util/s$b;)V

    return-void
.end method

.method private constructor <init>(Ljava/util/concurrent/CopyOnWriteArraySet;Landroid/os/Looper;Lcom/google/android/exoplayer2/util/e;Lcom/google/android/exoplayer2/util/s$b;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p3, p0, Lcom/google/android/exoplayer2/util/s;->a:Lcom/google/android/exoplayer2/util/e;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/util/s;->g:Ljava/lang/Object;
    ...
    invoke-direct {p1, p0}, Lcom/google/android/exoplayer2/util/r;-><init>(Lcom/google/android/exoplayer2/util/s;)V

    invoke-interface {p3, p2, p1}, Lcom/google/android/exoplayer2/util/e;->createHandler(Landroid/os/Looper;Landroid/os/Handler$Callback;)Lcom/google/android/exoplayer2/util/p;
    ...
    .line 11
    iput-boolean p1, p0, Lcom/google/android/exoplayer2/util/s;->i:Z
...
.method private m()V
    ...
    iget-boolean v0, p0, Lcom/google/android/exoplayer2/util/s;->i:Z
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/util/s;->b:Lcom/google/android/exoplayer2/util/p;

    invoke-interface {v1}, Lcom/google/android/exoplayer2/util/p;->getLooper()Landroid/os/Looper;
...
.method public c(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/util/s;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lcom/google/android/exoplayer2/util/s;->h:Z
    ...
    new-instance v2, Lcom/google/android/exoplayer2/util/s$c;

    invoke-direct {v2, p1}, Lcom/google/android/exoplayer2/util/s$c;-><init>(Ljava/lang/Object;)V
...
.method public d(Landroid/os/Looper;Lcom/google/android/exoplayer2/util/e;Lcom/google/android/exoplayer2/util/s$b;)Lcom/google/android/exoplayer2/util/s;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p1, p2, p3}, Lcom/google/android/exoplayer2/util/s;-><init>(Ljava/util/concurrent/CopyOnWriteArraySet;Landroid/os/Looper;Lcom/google/android/exoplayer2/util/e;Lcom/google/android/exoplayer2/util/s$b;)V
...
.method public e(Landroid/os/Looper;Lcom/google/android/exoplayer2/util/s$b;)Lcom/google/android/exoplayer2/util/s;
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/util/s;->a:Lcom/google/android/exoplayer2/util/e;

    invoke-virtual {p0, p1, v0, p2}, Lcom/google/android/exoplayer2/util/s;->d(Landroid/os/Looper;Lcom/google/android/exoplayer2/util/e;Lcom/google/android/exoplayer2/util/s$b;)Lcom/google/android/exoplayer2/util/s;
...
.method public f()V
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/util/s;->m()V
...
.method public i(ILcom/google/android/exoplayer2/util/s$a;)V
    ...
    invoke-direct {v2, v0, p1, p2}, Lcom/google/android/exoplayer2/util/q;-><init>(Ljava/util/concurrent/CopyOnWriteArraySet;ILcom/google/android/exoplayer2/util/s$a;)V
...
.method public j()V
    ...
    :try_start_0
    iput-boolean v1, p0, Lcom/google/android/exoplayer2/util/s;->h:Z
