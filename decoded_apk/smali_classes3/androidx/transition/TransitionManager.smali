...
.method public static b(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    invoke-static {p0, p1}, Landroidx/transition/TransitionManager;->i(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    const/4 v0, 0x0

    invoke-static {p0, v0}, Landroidx/transition/Scene;->f(Landroid/view/ViewGroup;Landroidx/transition/Scene;)V

    invoke-static {p0, p1}, Landroidx/transition/TransitionManager;->h(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    :cond_1
    return-void
.end method

.method private static c(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
    .locals 3
    ...
    invoke-virtual {v1}, Landroidx/transition/Scene;->b()V
    ...
    invoke-virtual {v1}, Landroidx/transition/Scene;->e()Z
    ...
    :cond_2
    invoke-static {v0, p1}, Landroidx/transition/TransitionManager;->i(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    invoke-virtual {p0}, Landroidx/transition/Scene;->a()V

    invoke-static {v0, p1}, Landroidx/transition/TransitionManager;->h(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method public static d(Landroid/view/ViewGroup;Landroidx/transition/Transition;)Landroidx/transition/TransitionSeekController;
    .locals 3
    ...
    invoke-static {p0, v0}, Landroidx/transition/TransitionManager;->i(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    invoke-static {p0, v1}, Landroidx/transition/Scene;->f(Landroid/view/ViewGroup;Landroidx/transition/Scene;)V

    invoke-static {p0, v0}, Landroidx/transition/TransitionManager;->h(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method public static e(Landroid/view/ViewGroup;)V
    ...
    invoke-static {}, Landroidx/transition/TransitionManager;->f()Landroidx/collection/ArrayMap;
...
.method static f()Landroidx/collection/ArrayMap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static g(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/transition/TransitionManager;->c(Landroidx/transition/Scene;Landroidx/transition/Transition;)V

    return-void
.end method

.method private static h(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    .locals 1
...
.method private static i(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    .locals 2
