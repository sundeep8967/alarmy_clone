...
.field private final c:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;
...
.method public constructor <init>(Landroidx/media3/datasource/DataSource$Factory;I)V
    ...
    .line 2
    sget-object v0, Landroidx/media3/exoplayer/source/chunk/BundledChunkExtractor;->k:Landroidx/media3/exoplayer/source/chunk/BundledChunkExtractor$Factory;
...
.method public constructor <init>(Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;Landroidx/media3/datasource/DataSource$Factory;I)V
    ...
    .line 4
    iput-object p1, p0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->c:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;

    .line 5
    iput-object p2, p0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->a:Landroidx/media3/datasource/DataSource$Factory;

    .line 6
    iput p3, p0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->b:I
...
# virtual methods
.method public bridge synthetic a(Z)Landroidx/media3/exoplayer/dash/DashChunkSource$Factory;
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->e(Z)Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;
...
.method public bridge synthetic b(Landroidx/media3/extractor/text/SubtitleParser$Factory;)Landroidx/media3/exoplayer/dash/DashChunkSource$Factory;
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->f(Landroidx/media3/extractor/text/SubtitleParser$Factory;)Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;
...
.method public c(Landroidx/media3/common/Format;)Landroidx/media3/common/Format;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->c:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;

    invoke-interface {v0, p1}, Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;->c(Landroidx/media3/common/Format;)Landroidx/media3/common/Format;
...
.method public d(Landroidx/media3/exoplayer/upstream/LoaderErrorThrower;Landroidx/media3/exoplayer/dash/manifest/DashManifest;Landroidx/media3/exoplayer/dash/BaseUrlExclusionList;I[ILandroidx/media3/exoplayer/trackselection/ExoTrackSelection;IJZLjava/util/List;Landroidx/media3/exoplayer/dash/PlayerEmsgHandler$PlayerTrackEmsgHandler;Landroidx/media3/datasource/TransferListener;Landroidx/media3/exoplayer/analytics/PlayerId;Landroidx/media3/exoplayer/upstream/CmcdConfiguration;)Landroidx/media3/exoplayer/dash/DashChunkSource;
    ...
    iget-object v2, v0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->a:Landroidx/media3/datasource/DataSource$Factory;
    ...
    iget-object v4, v0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->c:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;

    iget v15, v0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->b:I
...
.method public e(Z)Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;
    .locals 1

    iget-object v0, p0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->c:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;

    invoke-interface {v0, p1}, Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;->a(Z)Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;

    return-object p0
.end method

.method public f(Landroidx/media3/extractor/text/SubtitleParser$Factory;)Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;
    .locals 1

    iget-object v0, p0, Landroidx/media3/exoplayer/dash/DefaultDashChunkSource$Factory;->c:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;

    invoke-interface {v0, p1}, Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;->b(Landroidx/media3/extractor/text/SubtitleParser$Factory;)Landroidx/media3/exoplayer/source/chunk/ChunkExtractor$Factory;
