...
.field private final e:Landroidx/camera/core/internal/SupportedOutputSizesSorterLegacy;
...
.method public constructor <init>(Landroidx/camera/core/impl/CameraInfoInternal;Landroid/util/Size;)V
    ...
    invoke-direct {p0, p2}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->h(Landroid/util/Size;)Landroid/util/Rational;
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->i(Landroidx/camera/core/impl/CameraInfoInternal;)Landroid/util/Rational;
    ...
    iput-object v0, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->e:Landroidx/camera/core/internal/SupportedOutputSizesSorterLegacy;

    return-void
.end method

.method private static a(Ljava/util/List;Landroidx/camera/core/resolutionselector/AspectRatioStrategy;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    .locals 0
    ...
    invoke-static {p0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->o(Ljava/util/List;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0, p1, p2}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->b(Ljava/util/Map;Landroidx/camera/core/resolutionselector/AspectRatioStrategy;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
...
.method private static b(Ljava/util/Map;Landroidx/camera/core/resolutionselector/AspectRatioStrategy;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1}, Landroidx/camera/core/resolutionselector/AspectRatioStrategy;->b()I

    move-result v1

    invoke-static {v1, v0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->n(IZ)Landroid/util/Rational;

    move-result-object v1

    invoke-virtual {p1}, Landroidx/camera/core/resolutionselector/AspectRatioStrategy;->a()I
    ...
    invoke-static {p1, v0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->n(IZ)Landroid/util/Rational;
...
.method private c(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionSelector;I)Ljava/util/List;
    ...
    invoke-interface {p1, p3}, Landroidx/camera/core/impl/CameraInfoInternal;->j(I)Ljava/util/List;
...
.method private static e(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionFilter;III)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-static {p2}, Landroidx/camera/core/impl/utils/CameraOrientationUtil;->b(I)I
    ...
    :goto_0
    invoke-static {p2, p3, v0}, Landroidx/camera/core/impl/utils/CameraOrientationUtil;->a(IIZ)I
    ...
    invoke-interface {p1, p3, p2}, Landroidx/camera/core/resolutionselector/ResolutionFilter;->a(Ljava/util/List;I)Ljava/util/List;
...
.method private i(Landroidx/camera/core/impl/CameraInfoInternal;)Landroid/util/Rational;
    .locals 2

    const/16 v0, 0x100

    invoke-interface {p1, v0}, Landroidx/camera/core/impl/CameraInfoInternal;->l(I)Ljava/util/List;
...
.method private j(Ljava/util/List;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->l(Ljava/util/List;I)Ljava/util/List;
    ...
    invoke-interface {p1, p2}, Landroidx/camera/core/impl/CameraInfoInternal;->l(I)Ljava/util/List;
...
.method static o(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-static {p0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->k(Ljava/util/List;)Ljava/util/List;
...
.method public static p(Landroidx/camera/core/resolutionselector/ResolutionSelector;Ljava/util/List;Landroid/util/Size;ILandroid/util/Rational;II)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Landroidx/camera/core/resolutionselector/ResolutionSelector;->b()Landroidx/camera/core/resolutionselector/AspectRatioStrategy;

    move-result-object v0

    invoke-static {p1, v0, p4}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->a(Ljava/util/List;Landroidx/camera/core/resolutionselector/AspectRatioStrategy;Landroid/util/Rational;)Ljava/util/LinkedHashMap;

    move-result-object p1

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->d(Ljava/util/LinkedHashMap;Landroid/util/Size;)V

    :cond_0
    invoke-virtual {p0}, Landroidx/camera/core/resolutionselector/ResolutionSelector;->d()Landroidx/camera/core/resolutionselector/ResolutionStrategy;

    move-result-object p2

    invoke-static {p1, p2}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->f(Ljava/util/LinkedHashMap;Landroidx/camera/core/resolutionselector/ResolutionStrategy;)V
    ...
    :cond_3
    invoke-virtual {p0}, Landroidx/camera/core/resolutionselector/ResolutionSelector;->c()Landroidx/camera/core/resolutionselector/ResolutionFilter;

    move-result-object p0

    invoke-static {p2, p0, p3, p5, p6}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->e(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionFilter;III)Ljava/util/List;
...
.method public m(Landroidx/camera/core/impl/UseCaseConfig;)Ljava/util/List;
    ...
    invoke-interface {v0, v1}, Landroidx/camera/core/impl/ImageOutputConfig;->x(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    invoke-interface {v0, v1}, Landroidx/camera/core/impl/ImageOutputConfig;->N(Landroidx/camera/core/resolutionselector/ResolutionSelector;)Landroidx/camera/core/resolutionselector/ResolutionSelector;

    move-result-object v2

    invoke-interface {v0, v1}, Landroidx/camera/core/impl/ImageOutputConfig;->k(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v4}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->j(Ljava/util/List;I)Ljava/util/List;

    move-result-object v3

    if-nez v2, :cond_1

    iget-object v0, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->e:Landroidx/camera/core/internal/SupportedOutputSizesSorterLegacy;

    invoke-virtual {v0, v3, p1}, Landroidx/camera/core/internal/SupportedOutputSizesSorterLegacy;->f(Ljava/util/List;Landroidx/camera/core/impl/UseCaseConfig;)Ljava/util/List;
    ...
    invoke-interface {v4, v1}, Landroidx/camera/core/impl/ImageOutputConfig;->i(Landroid/util/Size;)Landroid/util/Size;
    ...
    invoke-interface {p1, v1}, Landroidx/camera/core/impl/UseCaseConfig;->E(Z)Z
    ...
    invoke-direct {p0, v3, v2, p1}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->c(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionSelector;I)Ljava/util/List;
    ...
    invoke-interface {v0}, Landroidx/camera/core/impl/ImageOutputConfig;->I()Landroidx/camera/core/resolutionselector/ResolutionSelector;

    move-result-object v5

    iget-object v9, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->d:Landroid/util/Rational;

    iget v10, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->b:I

    iget v11, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->c:I

    invoke-static/range {v5 .. v11}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->p(Landroidx/camera/core/resolutionselector/ResolutionSelector;Ljava/util/List;Landroid/util/Size;ILandroid/util/Rational;II)Ljava/util/List;
