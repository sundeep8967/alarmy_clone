...
.field private final cache:Lio/bidmachine/y3;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lio/bidmachine/DeviceInfo;->cache:Lio/bidmachine/y3;

    new-instance v1, Lio/bidmachine/DeviceInfo$b;

    invoke-direct {v1, v0}, Lio/bidmachine/DeviceInfo$b;-><init>(Lio/bidmachine/y3;)V

    iput-object v1, p0, Lio/bidmachine/DeviceInfo;->cpu:Lio/bidmachine/DeviceInfo$b;

    new-instance v1, Lio/bidmachine/DeviceInfo$c;

    invoke-direct {v1, v0}, Lio/bidmachine/DeviceInfo$c;-><init>(Lio/bidmachine/y3;)V
    ...
    invoke-static {}, Lio/bidmachine/util/d;->b()Ljava/lang/String;
    ...
    invoke-static {p1}, Lio/bidmachine/utils/c;->l(Landroid/content/Context;)I

    move-result v0

    iput v0, p0, Lio/bidmachine/DeviceInfo;->screenDpi:I

    invoke-static {p1}, Lio/bidmachine/util/d;->g(Landroid/content/Context;)F

    move-result v0

    iput v0, p0, Lio/bidmachine/DeviceInfo;->screenDensity:F

    invoke-static {p1}, Lio/bidmachine/util/d;->h(Landroid/content/Context;)Z

    move-result v0

    iput-boolean v0, p0, Lio/bidmachine/DeviceInfo;->isTablet:Z

    invoke-static {p1}, Lio/bidmachine/util/d;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lio/bidmachine/DeviceInfo;->phoneMCCMNC:Ljava/lang/String;

    invoke-static {p1}, Lio/bidmachine/util/d;->f(Landroid/content/Context;)Ljava/lang/String;
...
.method getAvailableDiskSpaceInMB()Ljava/lang/Long;
    ...
    :try_start_0
    invoke-static {}, Lio/bidmachine/core/h;->H()Z
