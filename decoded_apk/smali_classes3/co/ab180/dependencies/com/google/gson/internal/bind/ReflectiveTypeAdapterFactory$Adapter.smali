.class public final Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory;
.end annotation
...
# direct methods
.method constructor <init>(Lco/ab180/dependencies/com/google/gson/internal/ObjectConstructor;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->constructor:Lco/ab180/dependencies/com/google/gson/internal/ObjectConstructor;

    iput-object p2, p0, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;
...
.method public read(Lco/ab180/dependencies/com/google/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->constructor:Lco/ab180/dependencies/com/google/gson/internal/ObjectConstructor;
    ...
    iget-object v2, p0, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;

    invoke-interface {v2, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;

    if-eqz v1, :cond_2

    iget-boolean v2, v1, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->deserialized:Z
    ...
    :cond_1
    invoke-virtual {v1, p1, v0}, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->read(Lco/ab180/dependencies/com/google/gson/stream/JsonReader;Ljava/lang/Object;)V
...
.method public write(Lco/ab180/dependencies/com/google/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;
    ...
    invoke-virtual {v1, p2}, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->writeField(Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object v2, v1, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->name:Ljava/lang/String;

    invoke-virtual {p1, v2}, Lco/ab180/dependencies/com/google/gson/stream/JsonWriter;->name(Ljava/lang/String;)Lco/ab180/dependencies/com/google/gson/stream/JsonWriter;

    invoke-virtual {v1, p1, p2}, Lco/ab180/dependencies/com/google/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->write(Lco/ab180/dependencies/com/google/gson/stream/JsonWriter;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
