...
.method private a(Landroidx/constraintlayout/core/parser/CLElement;ILandroidx/constraintlayout/core/parser/CLParser$TYPE;Z[C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    :pswitch_0
    invoke-static {p5}, Landroidx/constraintlayout/core/parser/CLToken;->w([C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    :pswitch_1
    invoke-static {p5}, Landroidx/constraintlayout/core/parser/CLKey;->V([C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    :pswitch_2
    invoke-static {p5}, Landroidx/constraintlayout/core/parser/CLString;->w([C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    :pswitch_3
    invoke-static {p5}, Landroidx/constraintlayout/core/parser/CLNumber;->w([C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    :pswitch_4
    invoke-static {p5}, Landroidx/constraintlayout/core/parser/CLArray;->U([C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    :pswitch_5
    invoke-static {p5}, Landroidx/constraintlayout/core/parser/CLObject;->U([C)Landroidx/constraintlayout/core/parser/CLObject;
    ...
    invoke-virtual {p3, p5}, Landroidx/constraintlayout/core/parser/CLElement;->t(I)V

    if-eqz p4, :cond_2

    int-to-long p4, p2

    invoke-virtual {p3, p4, p5}, Landroidx/constraintlayout/core/parser/CLElement;->u(J)V
    ...
    invoke-virtual {p3, p1}, Landroidx/constraintlayout/core/parser/CLElement;->r(Landroidx/constraintlayout/core/parser/CLContainer;)V
...
.method private b(ICLandroidx/constraintlayout/core/parser/CLElement;[C)Landroidx/constraintlayout/core/parser/CLElement;
    ...
    sget-object v4, Landroidx/constraintlayout/core/parser/CLParser$TYPE;->h:Landroidx/constraintlayout/core/parser/CLParser$TYPE;
    ...
    invoke-virtual {p4, p2, v0, v1}, Landroidx/constraintlayout/core/parser/CLToken;->y(CJ)Z
    ...
    :cond_1
    sget-object v3, Landroidx/constraintlayout/core/parser/CLParser$TYPE;->g:Landroidx/constraintlayout/core/parser/CLParser$TYPE;
    ...
    :pswitch_1
    sget-object v3, Landroidx/constraintlayout/core/parser/CLParser$TYPE;->e:Landroidx/constraintlayout/core/parser/CLParser$TYPE;
    ...
    :cond_2
    sget-object v3, Landroidx/constraintlayout/core/parser/CLParser$TYPE;->c:Landroidx/constraintlayout/core/parser/CLParser$TYPE;
    ...
    invoke-virtual {p3, v0, v1}, Landroidx/constraintlayout/core/parser/CLElement;->s(J)V

    invoke-virtual {p3}, Landroidx/constraintlayout/core/parser/CLElement;->g()Landroidx/constraintlayout/core/parser/CLElement;

    move-result-object p3

    int-to-long p1, p1

    invoke-virtual {p3, p1, p2}, Landroidx/constraintlayout/core/parser/CLElement;->s(J)V

    goto :goto_0

    :cond_4
    sget-object v3, Landroidx/constraintlayout/core/parser/CLParser$TYPE;->d:Landroidx/constraintlayout/core/parser/CLParser$TYPE;
    ...
    :cond_6
    sget-object v3, Landroidx/constraintlayout/core/parser/CLParser$TYPE;->f:Landroidx/constraintlayout/core/parser/CLParser$TYPE;
...
.method public static d(Ljava/lang/String;)Landroidx/constraintlayout/core/parser/CLObject;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/constraintlayout/core/parser/CLParsingException;
    ...
    invoke-virtual {v0}, Landroidx/constraintlayout/core/parser/CLParser;->c()Landroidx/constraintlayout/core/parser/CLObject;
...
# virtual methods
.method public c()Landroidx/constraintlayout/core/parser/CLObject;
    .locals 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/constraintlayout/core/parser/CLParsingException;
    ...
    invoke-static {v1}, Landroidx/constraintlayout/core/parser/CLObject;->U([C)Landroidx/constraintlayout/core/parser/CLObject;

    move-result-object v7

    iget v8, v0, Landroidx/constraintlayout/core/parser/CLParser;->c:I

    invoke-virtual {v7, v8}, Landroidx/constraintlayout/core/parser/CLElement;->t(I)V

    int-to-long v8, v5

    invoke-virtual {v7, v8, v9}, Landroidx/constraintlayout/core/parser/CLElement;->u(J)V
    ...
    :cond_5
    invoke-virtual {v8}, Landroidx/constraintlayout/core/parser/CLElement;->q()Z
    ...
    invoke-virtual {v8, v9, v10}, Landroidx/constraintlayout/core/parser/CLElement;->s(J)V
    ...
    iget-wide v10, v8, Landroidx/constraintlayout/core/parser/CLElement;->c:J
    ...
    invoke-virtual {v8, v10, v11}, Landroidx/constraintlayout/core/parser/CLElement;->u(J)V
    ...
    invoke-virtual {v15, v9, v3, v4}, Landroidx/constraintlayout/core/parser/CLToken;->y(CJ)Z
    ...
    :cond_e
    iget-wide v3, v8, Landroidx/constraintlayout/core/parser/CLElement;->c:J
    ...
    invoke-virtual {v8, v3, v4}, Landroidx/constraintlayout/core/parser/CLElement;->u(J)V

    add-int/lit8 v3, v5, -0x1

    int-to-long v3, v3

    invoke-virtual {v8, v3, v4}, Landroidx/constraintlayout/core/parser/CLElement;->s(J)V
    ...
    :cond_12
    invoke-virtual {v8}, Landroidx/constraintlayout/core/parser/CLElement;->g()Landroidx/constraintlayout/core/parser/CLElement;
    ...
    iget-object v3, v3, Landroidx/constraintlayout/core/parser/CLContainer;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v4, v5}, Landroidx/constraintlayout/core/parser/CLElement;->u(J)V
    ...
    invoke-virtual {v8, v4, v5}, Landroidx/constraintlayout/core/parser/CLElement;->s(J)V
    ...
    invoke-virtual {v7}, Landroidx/constraintlayout/core/parser/CLObject;->v()Ljava/lang/String;
