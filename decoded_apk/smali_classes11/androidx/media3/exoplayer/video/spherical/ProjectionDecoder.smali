...
.method public static a([BI)Landroidx/media3/exoplayer/video/spherical/Projection;
    ...
    :try_start_0
    invoke-static {v0}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->c(Landroidx/media3/common/util/ParsableByteArray;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {v0}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->f(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->e(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
...
.method private static d(Landroidx/media3/common/util/ParsableByteArray;)Landroidx/media3/exoplayer/video/spherical/Projection$Mesh;
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/media3/common/util/ParsableByteArray;->p()F
    ...
    invoke-virtual {v10, v11}, Landroidx/media3/common/util/ParsableBitArray;->p(I)V
    ...
    invoke-virtual {v10, v9}, Landroidx/media3/common/util/ParsableBitArray;->h(I)I

    move-result v18

    invoke-static/range {v18 .. v18}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->b(I)I
    ...
    :cond_6
    invoke-virtual {v10}, Landroidx/media3/common/util/ParsableBitArray;->e()I
    ...
    invoke-virtual {v10, v0}, Landroidx/media3/common/util/ParsableBitArray;->p(I)V

    const/16 v0, 0x20

    invoke-virtual {v10, v0}, Landroidx/media3/common/util/ParsableBitArray;->h(I)I
    ...
    invoke-virtual {v10, v12}, Landroidx/media3/common/util/ParsableBitArray;->h(I)I
    ...
    invoke-static/range {v19 .. v19}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->b(I)I
...
.method private static e(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-static {p0, v0, v2}, Landroidx/media3/common/util/Util;->B0(Landroidx/media3/common/util/ParsableByteArray;Landroidx/media3/common/util/ParsableByteArray;Ljava/util/zip/Inflater;)Z
    ...
    :cond_3
    :goto_0
    invoke-static {p0}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->g(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
...
.method private static f(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, v3}, Landroidx/media3/common/util/ParsableByteArray;->T(I)V

    invoke-static {p0}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->e(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
...
.method private static g(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/video/spherical/ProjectionDecoder;->d(Landroidx/media3/common/util/ParsableByteArray;)Landroidx/media3/exoplayer/video/spherical/Projection$Mesh;
