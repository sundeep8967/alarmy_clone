...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/bidmachine/u4;->a:[Ljava/lang/String;
...
.method public static synthetic a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/bidmachine/u4;->n(Ljava/lang/String;)Ljava/lang/String;
...
.method public static synthetic b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/bidmachine/u4;->j(Ljava/lang/String;)Ljava/lang/String;
...
.method public static synthetic c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/bidmachine/u4;->k(Ljava/lang/String;)Ljava/lang/String;
...
.method public static synthetic d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/bidmachine/u4;->m(Ljava/lang/String;)Ljava/lang/String;
...
.method public static synthetic e(Lio/bidmachine/NetworkConfig;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lio/bidmachine/u4;->l(Lio/bidmachine/NetworkConfig;)Ljava/lang/String;
...
.method static f(Landroid/content/Context;Lio/bidmachine/protobuf/AdNetwork;)Lio/bidmachine/NetworkConfig;
    ...
    invoke-static {p0, v1, v2}, Lio/bidmachine/u4;->g(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;)Lio/bidmachine/NetworkConfig;
    ...
    :cond_3
    new-instance v0, Lio/bidmachine/p4;

    invoke-direct {v0, v1}, Lio/bidmachine/p4;-><init>(Ljava/lang/String;)V
...
.method private static g(Landroid/content/Context;Ljava/lang/String;Ljava/util/Map;)Lio/bidmachine/NetworkConfig;
    ...
    invoke-static {p0, p1}, Lio/bidmachine/m4;->d(Landroid/content/Context;Ljava/lang/String;)Lio/bidmachine/n4;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0}, Lio/bidmachine/n4;->b()Ljava/lang/String;
    ...
    invoke-static {p2}, Lio/bidmachine/u4;->i(Ljava/util/Map;)Ljava/util/Map;
    ...
    new-instance p2, Lio/bidmachine/t4;

    invoke-direct {p2, p1}, Lio/bidmachine/t4;-><init>(Ljava/lang/String;)V

    invoke-static {p2}, Lio/bidmachine/core/a;->d(Lu80/b;)V
...
.method static h(Landroid/content/Context;Lorg/json/JSONObject;)Lio/bidmachine/NetworkConfig;
    ...
    :try_start_1
    invoke-static {p1}, Lio/bidmachine/core/h;->n0(Lorg/json/JSONObject;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lio/bidmachine/core/h;->n0(Lorg/json/JSONObject;)Ljava/util/Map;

    move-result-object v3

    invoke-static {v3}, Lio/bidmachine/u4;->i(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v3

    invoke-virtual {p0, v4, v3}, Lio/bidmachine/NetworkConfig;->withMediationConfig(Lio/bidmachine/AdFormat;Ljava/util/Map;)Lio/bidmachine/NetworkConfig;
    ...
    :cond_2
    new-instance v3, Lio/bidmachine/q4;

    invoke-direct {v3, v1}, Lio/bidmachine/q4;-><init>(Ljava/lang/String;)V

    invoke-static {v3}, Lio/bidmachine/core/a;->d(Lu80/b;)V
    ...
    :cond_3
    new-instance p1, Lio/bidmachine/r4;

    invoke-direct {p1, p0}, Lio/bidmachine/r4;-><init>(Lio/bidmachine/NetworkConfig;)V
    ...
    :goto_2
    new-instance p1, Lio/bidmachine/s4;

    invoke-direct {p1, v1}, Lio/bidmachine/s4;-><init>(Ljava/lang/String;)V
...
.method private static i(Ljava/util/Map;)Ljava/util/Map;
    ...
    :try_start_0
    sget-object v0, Lio/bidmachine/u4;->a:[Ljava/lang/String;
