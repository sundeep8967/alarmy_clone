...
.method private a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/TooltipPopup;->a:Landroid/content/Context;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/TooltipPopup;->b(Landroid/view/View;)Landroid/view/View;
    ...
    :cond_3
    iget-object v4, p0, Landroidx/appcompat/widget/TooltipPopup;->e:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/TooltipPopup;->a:Landroid/content/Context;
    ...
    sget-object v6, Lcom/datadog/android/rum/internal/metric/IBpP/UMvHXYd;->MBgSQKRBPCjj:Ljava/lang/String;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/TooltipPopup;->e:Landroid/graphics/Rect;
    ...
    :cond_5
    iget-object v4, p0, Landroidx/appcompat/widget/TooltipPopup;->g:[I

    invoke-virtual {v3, v4}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v4, p0, Landroidx/appcompat/widget/TooltipPopup;->f:[I

    invoke-virtual {p1, v4}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object p1, p0, Landroidx/appcompat/widget/TooltipPopup;->f:[I

    aget v4, p1, v2

    iget-object v5, p0, Landroidx/appcompat/widget/TooltipPopup;->g:[I
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;

    invoke-virtual {p2, p1, p1}, Landroid/view/View;->measure(II)V

    iget-object p1, p0, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;

    invoke-virtual {p1}, Landroid/view/View;->getMeasuredHeight()I

    move-result p1

    iget-object p2, p0, Landroidx/appcompat/widget/TooltipPopup;->f:[I
    ...
    iget-object p4, p0, Landroidx/appcompat/widget/TooltipPopup;->e:Landroid/graphics/Rect;
...
.method c()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/TooltipPopup;->d()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;
...
.method d()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/TooltipPopup;->b:Landroid/view/View;
...
.method e(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/TooltipPopup;->c()V

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/TooltipPopup;->c:Landroid/widget/TextView;

    invoke-virtual {v0, p5}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v6, p0, Landroidx/appcompat/widget/TooltipPopup;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/TooltipPopup;->a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V

    iget-object p1, p0, Landroidx/appcompat/widget/TooltipPopup;->a:Landroid/content/Context;
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/TooltipPopup;->d:Landroid/view/WindowManager$LayoutParams;
