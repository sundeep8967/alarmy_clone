.class public final Lcom/delightroom/alarmy/data/database/dao/p$b;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/delightroom/alarmy/data/database/dao/p$b",
        "Landroidx/room/EntityDeleteOrUpdateAdapter;",
        "Lxe/b;",
        "",
        "b",
...
.method constructor <init>(Lcom/delightroom/alarmy/data/database/dao/p;)V
    ...
    iput-object p1, p0, Lcom/delightroom/alarmy/data/database/dao/p$b;->a:Lcom/delightroom/alarmy/data/database/dao/p;
...
.method public bridge synthetic a(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/delightroom/alarmy/data/database/dao/p$b;->d(Landroidx/sqlite/SQLiteStatement;Lxe/b;)V
...
.method protected b()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `AlarmInfo` SET `id` = ?,`type` = ?,`emoji` = ?,`name` = ?,`hour` = ?,`minutes` = ?,`time` = ?,`enabled` = ?,`daysOfWeek` = ?,`alert` = ?,`alertType` = ?,`volume` = ?,`vibrate` = ?,`ringtoneMode` = ?,`label` = ?,`isSnoozeEnable` = ?,`snoozeDuration` = ?,`snoozeLimitCount` = ?,`wakeUpCheck` = ?,`isCrescendoEnable` = ?,`crescendoDuration` = ?,`backupSound` = ?,`timePressure` = ?,`labelReminder` = ?,`isSkipped` = ?,`wallpaperId` = ?,`isWeatherReading` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?"

    return-object v0
.end method

.method protected d(Landroidx/sqlite/SQLiteStatement;Lxe/b;)V
    .locals 4
    ...
    iget-object v0, p0, Lcom/delightroom/alarmy/data/database/dao/p$b;->a:Lcom/delightroom/alarmy/data/database/dao/p;
