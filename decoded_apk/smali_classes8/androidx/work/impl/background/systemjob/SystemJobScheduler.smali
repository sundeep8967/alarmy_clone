...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->e(Landroid/app/job/JobScheduler;I)V
...
.method private static f(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, p1}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    invoke-static {v0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->h(Landroid/app/job/JobInfo;)Landroidx/work/impl/model/WorkGenerationalId;
...
.method private static h(Landroid/app/job/JobInfo;)Landroidx/work/impl/model/WorkGenerationalId;
    .locals 3
...
.method public static i(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;)Z
    .locals 6
    ...
    invoke-interface {v1}, Landroidx/work/impl/model/SystemIdInfoDao;->e()Ljava/util/List;
    ...
    invoke-static {v3}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->h(Landroid/app/job/JobInfo;)Landroidx/work/impl/model/WorkGenerationalId;

    move-result-object v5

    if-eqz v5, :cond_1

    invoke-virtual {v5}, Landroidx/work/impl/model/WorkGenerationalId;->b()Ljava/lang/String;
    ...
    invoke-static {v0, v3}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->e(Landroid/app/job/JobScheduler;I)V
    ...
    invoke-virtual {p0, v0, v2}, Landroidx/work/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroidx/work/impl/model/WorkSpecDao;->t(Ljava/lang/String;J)I
...
.method public c(Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->f(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v2, v1}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->e(Landroid/app/job/JobScheduler;I)V
    ...
    invoke-interface {v0, p1}, Landroidx/work/impl/model/SystemIdInfoDao;->g(Ljava/lang/String;)V
...
.method public varargs d([Landroidx/work/impl/model/WorkSpec;)V
    ...
    iget-object v6, v4, Landroidx/work/impl/model/WorkSpec;->a:Ljava/lang/String;

    invoke-interface {v5, v6}, Landroidx/work/impl/model/WorkSpecDao;->r(Ljava/lang/String;)Landroidx/work/impl/model/WorkSpec;
    ...
    sget-object v7, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->f:Ljava/lang/String;
    ...
    invoke-virtual {v5, v7, v4}, Landroidx/work/Logger;->k(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    iget-object v5, v5, Landroidx/work/impl/model/WorkSpec;->b:Landroidx/work/WorkInfo$State;
    ...
    invoke-interface {v6, v5}, Landroidx/work/impl/model/SystemIdInfoDao;->d(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/model/SystemIdInfo;

    move-result-object v6

    if-eqz v6, :cond_2

    iget v7, v6, Landroidx/work/impl/model/SystemIdInfo;->c:I
    ...
    invoke-virtual {v7}, Landroidx/work/impl/WorkManagerImpl;->n()Landroidx/work/Configuration;

    move-result-object v7

    invoke-virtual {v7}, Landroidx/work/Configuration;->i()I

    move-result v7

    iget-object v8, p0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->d:Landroidx/work/impl/WorkManagerImpl;

    invoke-virtual {v8}, Landroidx/work/impl/WorkManagerImpl;->n()Landroidx/work/Configuration;

    move-result-object v8

    invoke-virtual {v8}, Landroidx/work/Configuration;->g()I

    move-result v8

    invoke-virtual {v1, v7, v8}, Landroidx/work/impl/utils/IdGenerator;->e(II)I
    ...
    invoke-static {v5, v7}, Landroidx/work/impl/model/SystemIdInfoKt;->a(Landroidx/work/impl/model/WorkGenerationalId;I)Landroidx/work/impl/model/SystemIdInfo;

    move-result-object v5

    iget-object v6, p0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->d:Landroidx/work/impl/WorkManagerImpl;

    invoke-virtual {v6}, Landroidx/work/impl/WorkManagerImpl;->u()Landroidx/work/impl/WorkDatabase;
    ...
    invoke-interface {v6, v5}, Landroidx/work/impl/model/SystemIdInfoDao;->c(Landroidx/work/impl/model/SystemIdInfo;)V

    :cond_3
    invoke-virtual {p0, v4, v7}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->j(Landroidx/work/impl/model/WorkSpec;I)V
...
.method public j(Landroidx/work/impl/model/WorkSpec;I)V
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->c:Landroid/app/job/JobScheduler;
    ...
    invoke-virtual {v0, v2, v3}, Landroidx/work/Logger;->k(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-boolean v1, p1, Landroidx/work/impl/model/WorkSpec;->q:Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->j(Landroidx/work/impl/model/WorkSpec;I)V
    :try_end_0
    ...
    invoke-virtual {v0, v1, p1, p2}, Landroidx/work/Logger;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, v0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->g(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->d:Landroidx/work/impl/WorkManagerImpl;
    ...
    invoke-interface {v1}, Landroidx/work/impl/model/WorkSpecDao;->p()Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->d:Landroidx/work/impl/WorkManagerImpl;

    invoke-virtual {v2}, Landroidx/work/impl/WorkManagerImpl;->n()Landroidx/work/Configuration;

    move-result-object v2

    invoke-virtual {v2}, Landroidx/work/Configuration;->h()I
    ...
    invoke-virtual {v0, v1, p2}, Landroidx/work/Logger;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Landroidx/work/Configuration;->l()Landroidx/core/util/Consumer;
