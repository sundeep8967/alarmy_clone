...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lda/e;->b:Lcom/bumptech/glide/load/g;
...
.method private d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lda/e;->a:Landroid/content/Context;
    ...
    iget-object p1, p0, Lda/e;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lda/e;->a:Landroid/content/Context;
...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lda/e;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lda/e;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;Lcom/bumptech/glide/load/h;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lda/e;->h(Landroid/net/Uri;Lcom/bumptech/glide/load/h;)Z
...
.method public bridge synthetic b(Ljava/lang/Object;IILcom/bumptech/glide/load/h;)Lcom/bumptech/glide/load/engine/u;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lda/e;->c(Landroid/net/Uri;IILcom/bumptech/glide/load/h;)Lcom/bumptech/glide/load/engine/u;
...
.method public c(Landroid/net/Uri;IILcom/bumptech/glide/load/h;)Lcom/bumptech/glide/load/engine/u;
    ...
    invoke-direct {p0, p1, p2}, Lda/e;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p3

    invoke-direct {p0, p3, p1}, Lda/e;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    sget-object v0, Lda/e;->b:Lcom/bumptech/glide/load/g;
    ...
    invoke-static {p2, v0}, Lcom/bumptech/glide/util/k;->a(ZLjava/lang/String;)V

    if-nez p4, :cond_2

    iget-object p2, p0, Lda/e;->a:Landroid/content/Context;

    invoke-static {p2, p3, p1}, Lda/b;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p2, p1, p4}, Lda/b;->a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    :goto_2
    invoke-static {p1}, Lda/d;->d(Landroid/graphics/drawable/Drawable;)Lcom/bumptech/glide/load/engine/u;
...
.method public h(Landroid/net/Uri;Lcom/bumptech/glide/load/h;)Z
    .locals 0
