...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1;->b(Landroidx/compose/runtime/Composer;I)V
.end annotation
...
.field final synthetic o:Landroidx/compose/foundation/text/selection/OffsetProvider;
...
.method constructor <init>(JZLandroidx/compose/ui/Modifier;Landroidx/compose/foundation/text/selection/OffsetProvider;)V
    ...
    iput-wide p1, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->l:J

    iput-boolean p3, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->m:Z

    iput-object p4, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->n:Landroidx/compose/ui/Modifier;

    iput-object p5, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->o:Landroidx/compose/foundation/text/selection/OffsetProvider;
...
.method public final b(Landroidx/compose/runtime/Composer;I)V
    ...
    :cond_1
    iget-wide v0, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->l:J
    ...
    iget-boolean p2, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->m:Z
    ...
    invoke-virtual {p2}, Landroidx/compose/foundation/layout/Arrangement$Absolute;->b()Landroidx/compose/foundation/layout/Arrangement$Horizontal;
    ...
    invoke-virtual {p2}, Landroidx/compose/foundation/layout/Arrangement$Absolute;->a()Landroidx/compose/foundation/layout/Arrangement$Horizontal;

    move-result-object p2

    :goto_1
    iget-object v4, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->n:Landroidx/compose/ui/Modifier;
    ...
    invoke-static {v0, v1}, Landroidx/compose/ui/unit/DpSize;->i(J)F
    ...
    invoke-static/range {v4 .. v10}, Landroidx/compose/foundation/layout/SizeKt;->r(Landroidx/compose/ui/Modifier;FFFFILjava/lang/Object;)Landroidx/compose/ui/Modifier;

    move-result-object v0

    iget-object v1, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->o:Landroidx/compose/foundation/text/selection/OffsetProvider;

    iget-boolean v2, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->m:Z
    ...
    invoke-static {p2, v4, p1, v3}, Landroidx/compose/foundation/layout/RowKt;->b(Landroidx/compose/foundation/layout/Arrangement$Horizontal;Landroidx/compose/ui/Alignment$Vertical;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-interface {v6, v3, p2}, Landroidx/compose/runtime/Composer;->q(Ljava/lang/Object;Lza0/p;)V
    ...
    invoke-static {p2, v3, v2, p1, v0}, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt;->c(Landroidx/compose/ui/Modifier;Lza0/a;ZLandroidx/compose/runtime/Composer;I)V
    ...
    iget-object p2, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->n:Landroidx/compose/ui/Modifier;

    iget-object v0, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->o:Landroidx/compose/foundation/text/selection/OffsetProvider;
    ...
    iget-boolean v0, p0, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->m:Z

    invoke-static {p2, v2, v0, p1, v3}, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt;->c(Landroidx/compose/ui/Modifier;Lza0/a;ZLandroidx/compose/runtime/Composer;I)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/text/selection/AndroidSelectionHandles_androidKt$SelectionHandle$1$1;->b(Landroidx/compose/runtime/Composer;I)V
