...
.field public final j:Lio/bidmachine/media3/common/p;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lio/bidmachine/media3/common/p;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p10}, Ly50/d;-><init>(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    iput-object p8, p0, Lio/bidmachine/media3/exoplayer/hls/playlist/d;->j:Lio/bidmachine/media3/common/p;
...
.method private static c(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    iget v6, v5, Lio/bidmachine/media3/common/StreamKey;->c:I

    if-ne v6, p1, :cond_0

    iget v5, v5, Lio/bidmachine/media3/common/StreamKey;->d:I
...
.method public b(Ljava/util/List;)Lio/bidmachine/media3/exoplayer/hls/playlist/d;
    ...
    iget-object v1, p0, Ly50/d;->a:Ljava/lang/String;

    iget-object v2, p0, Ly50/d;->b:Ljava/util/List;
    ...
    iget-object v8, p0, Lio/bidmachine/media3/exoplayer/hls/playlist/d;->j:Lio/bidmachine/media3/common/p;

    iget-object v9, p0, Lio/bidmachine/media3/exoplayer/hls/playlist/d;->k:Ljava/util/List;

    iget-boolean v10, p0, Ly50/d;->c:Z
