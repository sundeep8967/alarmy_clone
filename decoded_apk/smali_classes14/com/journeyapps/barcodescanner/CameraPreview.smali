...
# static fields
.field private static final B:Ljava/lang/String; = "CameraPreview"


# instance fields
.field private final A:Lcom/journeyapps/barcodescanner/CameraPreview$f;

.field private b:Lbt/g;
...
.field private l:Lbt/m;

.field private m:Lbt/i;

.field private n:Lat/p;

.field private o:Lat/p;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1}, Lbt/i;-><init>()V

    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->m:Lbt/i;
    ...
    .line 9
    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;
    ...
    .line 11
    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->v:Lbt/q;
    ...
    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->z:Lat/n;
...
.method private B(Lbt/j;)V
    ...
    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    invoke-virtual {v0, p1}, Lbt/g;->z(Lbt/j;)V

    iget-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    invoke-virtual {p1}, Lbt/g;->B()V
...
.method private C()V
    ...
    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->q:Lat/p;

    if-eqz v0, :cond_2

    iget-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->o:Lat/p;
    ...
    invoke-direct {v2, v1, v3}, Lat/p;-><init>(II)V
    ...
    invoke-direct {v0, v1}, Lbt/j;-><init>(Landroid/view/SurfaceHolder;)V

    invoke-direct {p0, v0}, Lcom/journeyapps/barcodescanner/CameraPreview;->B(Lbt/j;)V
    ...
    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->o:Lat/p;
    ...
    invoke-direct {v0, v1, v2}, Lat/p;-><init>(II)V

    iget-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->o:Lat/p;

    invoke-virtual {p0, v0, v1}, Lcom/journeyapps/barcodescanner/CameraPreview;->l(Lat/p;Lat/p;)Landroid/graphics/Matrix;
    ...
    invoke-direct {v0, v1}, Lbt/j;-><init>(Landroid/graphics/SurfaceTexture;)V
...
.method static synthetic a(Lcom/journeyapps/barcodescanner/CameraPreview;Lat/p;)Lat/p;
    .locals 0

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->q:Lat/p;
...
.method static synthetic d(Lcom/journeyapps/barcodescanner/CameraPreview;Lat/p;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/journeyapps/barcodescanner/CameraPreview;->w(Lat/p;)V
...
.method private j()V
    ...
    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->n:Lat/p;

    const/4 v1, 0x0

    if-eqz v0, :cond_4

    iget-object v2, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->o:Lat/p;

    if-eqz v2, :cond_4

    iget-object v3, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->l:Lbt/m;

    if-eqz v3, :cond_4

    iget v4, v2, Lat/p;->b:I

    iget v5, v2, Lat/p;->c:I

    iget v6, v0, Lat/p;->b:I

    iget v0, v0, Lat/p;->c:I

    invoke-virtual {v3, v2}, Lbt/m;->d(Lat/p;)Landroid/graphics/Rect;
...
.method private m(Lat/p;)V
    .locals 2

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->n:Lat/p;

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lbt/g;->n()Lbt/m;
    ...
    invoke-direct {v0, v1, p1}, Lbt/m;-><init>(ILat/p;)V

    iput-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->l:Lbt/m;

    invoke-virtual {p0}, Lcom/journeyapps/barcodescanner/CameraPreview;->getPreviewScalingStrategy()Lbt/q;

    move-result-object p1

    invoke-virtual {v0, p1}, Lbt/m;->e(Lbt/q;)V

    iget-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->l:Lbt/m;

    invoke-virtual {p1, v0}, Lbt/g;->x(Lbt/m;)V

    iget-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    invoke-virtual {p1}, Lbt/g;->m()V
    ...
    invoke-virtual {v0, p1}, Lbt/g;->A(Z)V
...
.method private o()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/journeyapps/barcodescanner/CameraPreview;->n()Lbt/g;

    move-result-object v0

    iput-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    iget-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->d:Landroid/os/Handler;

    invoke-virtual {v0, v1}, Lbt/g;->y(Landroid/os/Handler;)V

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;

    invoke-virtual {v0}, Lbt/g;->u()V
...
.method private p(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p1}, Lat/o;-><init>()V

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->i:Lat/o;

    return-void
.end method

.method private w(Lat/p;)V
    .locals 0

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->o:Lat/p;

    iget-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->n:Lat/p;
...
.method public getCameraInstance()Lbt/g;
    .locals 1
...
.method public getCameraSettings()Lbt/i;
    ...
    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->m:Lbt/i;
...
.method public getFramingRectSize()Lat/p;
    .locals 1

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;
...
.method public getPreviewScalingStrategy()Lbt/q;
    .locals 1

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->v:Lbt/q;
...
.method public getPreviewSize()Lat/p;
    .locals 1
...
.method protected k(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iget-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;
    ...
    iget-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;

    iget v1, v1, Lat/p;->b:I
    ...
    iget-object v2, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;

    iget v2, v2, Lat/p;->c:I
...
.method protected l(Lat/p;Lat/p;)Landroid/graphics/Matrix;
    .locals 4
...
.method protected n()Lbt/g;
    ...
    invoke-direct {v0, v1}, Lbt/g;-><init>(Landroid/content/Context;)V

    iget-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->m:Lbt/i;

    invoke-virtual {v0, v1}, Lbt/g;->w(Lbt/i;)V
...
.method protected onLayout(ZIIII)V
    ...
    new-instance p1, Lat/p;

    sub-int/2addr p4, p2

    sub-int/2addr p5, p3

    invoke-direct {p1, p4, p5}, Lat/p;-><init>(II)V

    invoke-direct {p0, p1}, Lcom/journeyapps/barcodescanner/CameraPreview;->m(Lat/p;)V
...
.method protected q(Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, v0, v1}, Lat/p;-><init>(II)V

    iput-object v2, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;
    ...
    iput-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->v:Lbt/q;
...
.method public setCameraSettings(Lbt/i;)V
    ...
    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->m:Lbt/i;

    return-void
.end method

.method public setFramingRectSize(Lat/p;)V
    .locals 0

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->t:Lat/p;
...
.method public setPreviewScalingStrategy(Lbt/q;)V
    .locals 0

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->v:Lbt/q;
...
.method public u()V
    ...
    invoke-virtual {v0}, Lbt/g;->l()V

    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->b:Lbt/g;
    ...
    :cond_2
    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->n:Lat/p;

    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->o:Lat/p;

    iput-object v1, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->s:Landroid/graphics/Rect;

    iget-object v0, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->i:Lat/o;

    invoke-virtual {v0}, Lat/o;->f()V
...
.method public y()V
    ...
    iget-object v2, p0, Lcom/journeyapps/barcodescanner/CameraPreview;->z:Lat/n;

    invoke-virtual {v0, v1, v2}, Lat/o;->e(Landroid/content/Context;Lat/n;)V
