...
.method private final F(Ljava/util/List;)V
    ...
    invoke-virtual {v4}, Landroidx/fragment/app/DefaultSpecialEffectsController$SpecialEffectsInfo;->a()Landroidx/fragment/app/SpecialEffectsController$Operation;
    ...
    invoke-virtual {v4, v6}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->c(Landroid/content/Context;)Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;
    ...
    invoke-virtual {v7}, Landroidx/fragment/app/SpecialEffectsController$Operation;->f()Ljava/util/List;
    ...
    sget-object v5, Landroidx/fragment/app/SpecialEffectsController$Operation$State;->e:Landroidx/fragment/app/SpecialEffectsController$Operation$State;

    if-ne v3, v5, :cond_5

    invoke-virtual {v7, v2}, Landroidx/fragment/app/SpecialEffectsController$Operation;->q(Z)V
    ...
    invoke-virtual {v7, v3}, Landroidx/fragment/app/SpecialEffectsController$Operation;->b(Landroidx/fragment/app/SpecialEffectsController$Effect;)V
    ...
    invoke-virtual {v2, v4}, Landroidx/fragment/app/SpecialEffectsController$Operation;->b(Landroidx/fragment/app/SpecialEffectsController$Effect;)V
...
.method private static final G(Landroidx/fragment/app/DefaultSpecialEffectsController;Landroidx/fragment/app/SpecialEffectsController$Operation;)V
    .locals 1
...
.method private final H(Ljava/util/List;ZLandroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/SpecialEffectsController$Operation;)V
    .locals 23
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v12, v5}, Landroidx/fragment/app/DefaultSpecialEffectsController;->I(Ljava/util/Map;Landroid/view/View;)V

    invoke-virtual {v12, v14}, Landroidx/collection/ArrayMap;->t(Ljava/util/Collection;)Z
    ...
    invoke-static {v2, v8}, Lkotlin/jvm/internal/x;->i(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v2}, Landroidx/collection/ArrayMap;->t(Ljava/util/Collection;)Z
    ...
    invoke-direct {v0, v13, v2}, Landroidx/fragment/app/DefaultSpecialEffectsController;->I(Ljava/util/Map;Landroid/view/View;)V

    invoke-virtual {v13, v11}, Landroidx/collection/ArrayMap;->t(Ljava/util/Collection;)Z

    invoke-virtual {v9}, Landroidx/collection/ArrayMap;->values()Ljava/util/Collection;

    move-result-object v2

    invoke-virtual {v13, v2}, Landroidx/collection/ArrayMap;->t(Ljava/util/Collection;)Z
    ...
    :cond_16
    invoke-static {v5}, Landroidx/core/view/ViewCompat;->J(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-direct {v0, v12, v1}, Landroidx/fragment/app/DefaultSpecialEffectsController;->J(Landroidx/collection/ArrayMap;Ljava/util/Collection;)V
    ...
    invoke-direct {v0, v13, v1}, Landroidx/fragment/app/DefaultSpecialEffectsController;->J(Landroidx/collection/ArrayMap;Ljava/util/Collection;)V
...
.method private final I(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1, v2}, Landroidx/fragment/app/DefaultSpecialEffectsController;->I(Ljava/util/Map;Landroid/view/View;)V
...
.method private final J(Landroidx/collection/ArrayMap;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Lkotlin/collections/w;->T(Ljava/lang/Iterable;Lza0/l;)Z
...
.method public d(Ljava/util/List;Z)V
    ...
    sget-object v5, Landroidx/fragment/app/SpecialEffectsController$Operation$State;->b:Landroidx/fragment/app/SpecialEffectsController$Operation$State$Companion;
    ...
    sget-object v6, Landroidx/fragment/app/SpecialEffectsController$Operation$State;->b:Landroidx/fragment/app/SpecialEffectsController$Operation$State$Companion;
    ...
    invoke-direct {p0, p1}, Landroidx/fragment/app/DefaultSpecialEffectsController;->K(Ljava/util/List;)V
    ...
    :cond_7
    invoke-direct {p0, v3, p2, v1, v2}, Landroidx/fragment/app/DefaultSpecialEffectsController;->H(Ljava/util/List;ZLandroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/SpecialEffectsController$Operation;)V

    invoke-direct {p0, v0}, Landroidx/fragment/app/DefaultSpecialEffectsController;->F(Ljava/util/List;)V
