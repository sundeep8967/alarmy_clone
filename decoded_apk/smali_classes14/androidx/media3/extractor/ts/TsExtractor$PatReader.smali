...
.method public b(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    iget-object v4, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->a:Landroidx/media3/common/util/ParsableBitArray;

    invoke-virtual {p1, v4, v1}, Landroidx/media3/common/util/ParsableByteArray;->k(Landroidx/media3/common/util/ParsableBitArray;I)V

    iget-object v4, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->a:Landroidx/media3/common/util/ParsableBitArray;

    const/16 v5, 0x10

    invoke-virtual {v4, v5}, Landroidx/media3/common/util/ParsableBitArray;->h(I)I

    move-result v4

    iget-object v5, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->a:Landroidx/media3/common/util/ParsableBitArray;
    ...
    invoke-virtual {v4, v5}, Landroidx/media3/common/util/ParsableBitArray;->r(I)V
    ...
    iget-object v5, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->b:Landroidx/media3/extractor/ts/TsExtractor;

    invoke-static {v5}, Landroidx/media3/extractor/ts/TsExtractor;->e(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseArray;
    ...
    iget-object v8, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->b:Landroidx/media3/extractor/ts/TsExtractor;
    ...
    iget-object v4, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->b:Landroidx/media3/extractor/ts/TsExtractor;

    invoke-static {v4}, Landroidx/media3/extractor/ts/TsExtractor;->l(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    :cond_4
    iget-object p1, p0, Landroidx/media3/extractor/ts/TsExtractor$PatReader;->b:Landroidx/media3/extractor/ts/TsExtractor;

    invoke-static {p1}, Landroidx/media3/extractor/ts/TsExtractor;->m(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    invoke-static {p1}, Landroidx/media3/extractor/ts/TsExtractor;->e(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseArray;
