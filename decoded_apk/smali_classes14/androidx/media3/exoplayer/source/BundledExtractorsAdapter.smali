...
.field private b:Landroidx/media3/extractor/Extractor;

.field private c:Landroidx/media3/extractor/ExtractorInput;
...
.method public constructor <init>(Landroidx/media3/extractor/ExtractorsFactory;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->a:Landroidx/media3/extractor/ExtractorsFactory;

    return-void
.end method

.method public static synthetic e(Landroidx/media3/extractor/Extractor;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->f(Landroidx/media3/extractor/Extractor;)Ljava/lang/String;
...
.method private static synthetic f(Landroidx/media3/extractor/Extractor;)Ljava/lang/String;
    .locals 0

    invoke-interface {p0}, Landroidx/media3/extractor/Extractor;->b()Landroidx/media3/extractor/Extractor;
...
.method public a()J
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->c:Landroidx/media3/extractor/ExtractorInput;
...
.method public b()V
    ...
    :cond_0
    invoke-interface {v0}, Landroidx/media3/extractor/Extractor;->b()Landroidx/media3/extractor/Extractor;
    ...
    invoke-virtual {v0}, Landroidx/media3/extractor/mp3/Mp3Extractor;->k()V
...
.method public c(Landroidx/media3/common/DataReader;Landroid/net/Uri;Ljava/util/Map;JJLandroidx/media3/extractor/ExtractorOutput;)V
    ...
    iput-object v6, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->c:Landroidx/media3/extractor/ExtractorInput;

    iget-object p1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->a:Landroidx/media3/extractor/ExtractorsFactory;
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;
    ...
    :try_start_0
    invoke-interface {v2, v6}, Landroidx/media3/extractor/Extractor;->g(Landroidx/media3/extractor/ExtractorInput;)Z

    move-result v3

    if-eqz v3, :cond_2

    iput-object v2, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;
    :try_end_0
    ...
    :cond_2
    :try_start_1
    invoke-interface {v2}, Landroidx/media3/extractor/Extractor;->c()Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;
    ...
    :goto_3
    iget-object p2, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;
    ...
    :cond_6
    invoke-static {p7}, Landroidx/media3/common/util/Assertions;->g(Z)V
    ...
    :cond_7
    :goto_5
    iget-object p4, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;
    ...
    invoke-interface {p1, p8}, Landroidx/media3/extractor/Extractor;->d(Landroidx/media3/extractor/ExtractorOutput;)V
...
.method public d(Landroidx/media3/extractor/PositionHolder;)I
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->c:Landroidx/media3/extractor/ExtractorInput;
    ...
    invoke-interface {v0, v1, p1}, Landroidx/media3/extractor/Extractor;->f(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)I
...
.method public release()V
    ...
    iput-object v1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->b:Landroidx/media3/extractor/Extractor;

    :cond_0
    iput-object v1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->c:Landroidx/media3/extractor/ExtractorInput;
