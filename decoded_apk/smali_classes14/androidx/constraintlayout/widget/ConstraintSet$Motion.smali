...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->o:Landroid/util/SparseIntArray;
    ...
    sget-object v0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->o:Landroid/util/SparseIntArray;
...
.method public constructor <init>()V
    ...
    iput v1, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->h:I

    iput v0, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->i:F

    iput v0, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->j:F

    iput v1, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->k:I

    iput-object v2, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->l:Ljava/lang/String;

    const/4 v0, -0x3

    iput v0, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->m:I

    iput v1, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->n:I
...
.method public a(Landroidx/constraintlayout/widget/ConstraintSet$Motion;)V
    ...
    iget v0, p1, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->i:F
    ...
    iget p1, p1, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->h:I

    iput p1, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->h:I
...
.method b(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v4, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->o:Landroid/util/SparseIntArray;
    ...
    iput v3, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->n:I

    if-eq v3, v7, :cond_4

    iput v6, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->m:I
    ...
    iput-object v4, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->l:Ljava/lang/String;
    ...
    :cond_1
    iput v7, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->m:I

    goto/16 :goto_1

    :cond_2
    iget v4, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->n:I
    ...
    :pswitch_1
    iget v4, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->j:F

    invoke-virtual {p1, v3, v4}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->j:F

    goto :goto_1

    :pswitch_2
    iget v4, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->k:I

    invoke-virtual {p1, v3, v4}, Landroid/content/res/TypedArray;->getInteger(II)I

    move-result v3

    iput v3, p0, Landroidx/constraintlayout/widget/ConstraintSet$Motion;->k:I
