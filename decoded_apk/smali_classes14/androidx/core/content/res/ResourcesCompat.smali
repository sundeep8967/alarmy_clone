...
.method public static c(Landroid/content/Context;I)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v0 .. v7}, Landroidx/core/content/res/ResourcesCompat;->o(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method public static e(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Landroidx/core/content/res/ResourcesCompat;->m(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static h(Landroid/content/res/Resources;I)F
    ...
    invoke-static {p0, p1}, Landroidx/core/content/res/ResourcesCompat$Api29Impl;->a(Landroid/content/res/Resources;I)F
    ...
    :cond_0
    invoke-static {}, Landroidx/core/content/res/ResourcesCompat;->l()Landroid/util/TypedValue;
...
.method public static j(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/ResourcesCompat$FontCallback;)Landroid/graphics/Typeface;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/content/res/Resources$NotFoundException;
...
.method public static k(Landroid/content/Context;ILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/content/res/Resources$NotFoundException;
...
.method private static m(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, p1}, Landroidx/core/content/res/ResourcesCompat;->n(Landroid/content/res/Resources;I)Z
...
.method private static o(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-static/range {v0 .. v8}, Landroidx/core/content/res/ResourcesCompat;->p(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static p(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 16
