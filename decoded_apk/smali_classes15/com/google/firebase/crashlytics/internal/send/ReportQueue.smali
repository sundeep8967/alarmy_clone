...
.field private final transport:Lao/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lao/i<",
...
# direct methods
.method constructor <init>(DDJLao/i;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(DDJ",
    ...
    .line 6
    iput-object p7, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:Lao/i;
...
.method constructor <init>(Lao/i;Lcom/google/firebase/crashlytics/internal/settings/Settings;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;-><init>(DDJLao/i;Lcom/google/firebase/crashlytics/internal/common/OnDemandCounter;)V
...
.method private synthetic lambda$flushScheduledReportsIfAble$0(Ljava/util/concurrent/CountDownLatch;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:Lao/i;

    sget-object v1, Lao/f;->d:Lao/f;

    invoke-static {v0, v1}, Lcom/google/android/datatransport/runtime/l;->a(Lao/i;Lao/f;)V
    :try_end_0
...
.method private sendReport(Lcom/google/firebase/crashlytics/internal/common/CrashlyticsReportWithSessionId;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/firebase/crashlytics/internal/send/ReportQueue;->transport:Lao/i;
    ...
    invoke-static {v2}, Lao/d;->i(Ljava/lang/Object;)Lao/d;
    ...
    invoke-interface {v1, v2, v3}, Lao/i;->a(Lao/d;Lao/k;)V
