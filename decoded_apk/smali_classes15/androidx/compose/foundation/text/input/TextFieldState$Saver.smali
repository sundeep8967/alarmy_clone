...
# static fields
.field public static final a:Landroidx/compose/foundation/text/input/TextFieldState$Saver;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/compose/foundation/text/input/TextFieldState$Saver;->a:Landroidx/compose/foundation/text/input/TextFieldState$Saver;
...
.method public bridge synthetic a(Landroidx/compose/runtime/saveable/SaverScope;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/text/input/TextFieldState$Saver;->d(Landroidx/compose/runtime/saveable/SaverScope;Landroidx/compose/foundation/text/input/TextFieldState;)Ljava/lang/Object;
...
.method public bridge synthetic b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/foundation/text/input/TextFieldState$Saver;->c(Ljava/lang/Object;)Landroidx/compose/foundation/text/input/TextFieldState;
...
.method public c(Ljava/lang/Object;)Landroidx/compose/foundation/text/input/TextFieldState;
    .locals 10
    ...
    sget-object v0, Landroidx/compose/foundation/text/input/TextUndoManager$Companion$Saver;->a:Landroidx/compose/foundation/text/input/TextUndoManager$Companion$Saver;

    invoke-static {p1}, Lkotlin/jvm/internal/x;->g(Ljava/lang/Object;)V

    invoke-virtual {v0, p1}, Landroidx/compose/foundation/text/input/TextUndoManager$Companion$Saver;->c(Ljava/lang/Object;)Landroidx/compose/foundation/text/input/TextUndoManager;
...
.method public d(Landroidx/compose/runtime/saveable/SaverScope;Landroidx/compose/foundation/text/input/TextFieldState;)Ljava/lang/Object;
    .locals 4

    invoke-virtual {p2}, Landroidx/compose/foundation/text/input/TextFieldState;->i()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2}, Landroidx/compose/foundation/text/input/TextFieldState;->h()J
    ...
    invoke-virtual {p2}, Landroidx/compose/foundation/text/input/TextFieldState;->j()Landroidx/compose/foundation/text/input/TextUndoManager;

    move-result-object p2

    invoke-virtual {v3, p1, p2}, Landroidx/compose/foundation/text/input/TextUndoManager$Companion$Saver;->d(Landroidx/compose/runtime/saveable/SaverScope;Landroidx/compose/foundation/text/input/TextUndoManager;)Ljava/lang/Object;
