...
.method static d(Landroid/content/Context;Landroidx/work/impl/model/WorkGenerationalId;)Landroid/content/Intent;
    .locals 2
...
.method private i(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->g()V
    ...
    invoke-virtual {p2, v2, p1}, Landroidx/work/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private j(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v2, v3, p1}, Landroidx/work/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/background/systemalarm/CommandHandler;->e(Landroidx/work/impl/model/WorkGenerationalId;Z)V
...
.method private k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkManagerImpl;->y()V
...
.method private l(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-interface {v2, v3}, Landroidx/work/impl/model/WorkSpecDao;->r(Ljava/lang/String;)Landroidx/work/impl/model/WorkSpec;
    ...
    invoke-virtual {p2, v1, p1}, Landroidx/work/Logger;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v4, v2, Landroidx/work/impl/model/WorkSpec;->b:Landroidx/work/WorkInfo$State;

    invoke-virtual {v4}, Landroidx/work/WorkInfo$State;->h()Z
    ...
    invoke-virtual {v2}, Landroidx/work/impl/model/WorkSpec;->f()Z
    ...
    invoke-virtual {p2, v1, p3}, Landroidx/work/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1, v5}, Landroidx/work/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private m(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {v2, v3}, Landroidx/work/impl/StartStopTokens;->b(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
    ...
    invoke-virtual {p1, v0}, Landroidx/work/impl/StartStopTokens;->c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v1}, Landroidx/work/impl/WorkManagerImpl;->D(Landroidx/work/impl/StartStopToken;)V
    ...
    invoke-virtual {v3}, Landroidx/work/impl/WorkManagerImpl;->u()Landroidx/work/impl/WorkDatabase;
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->e(Landroidx/work/impl/model/WorkGenerationalId;Z)V
...
.method public e(Landroidx/work/impl/model/WorkGenerationalId;Z)V
    ...
    invoke-virtual {v1, p2}, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->h(Z)V
...
.method p(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/work/Logger;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p3, p1}, Landroidx/work/Logger;->k(Ljava/lang/String;Ljava/lang/String;)V
