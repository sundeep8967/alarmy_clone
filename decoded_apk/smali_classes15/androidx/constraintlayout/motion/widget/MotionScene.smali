...
.method private K(Landroid/content/Context;I)V
    ...
    iget-object v5, p0, Landroidx/constraintlayout/motion/widget/MotionScene;->r:Landroidx/constraintlayout/motion/widget/ViewTransitionController;

    invoke-virtual {v5, v3}, Landroidx/constraintlayout/motion/widget/ViewTransitionController;->a(Landroidx/constraintlayout/motion/widget/ViewTransition;)V
    ...
    invoke-static {v4}, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;->f(Landroidx/constraintlayout/motion/widget/MotionScene$Transition;)Ljava/util/ArrayList;
    ...
    :pswitch_2
    invoke-direct {p0, p1, v2}, Landroidx/constraintlayout/motion/widget/MotionScene;->N(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    goto/16 :goto_4

    :pswitch_3
    invoke-direct {p0, p1, v2}, Landroidx/constraintlayout/motion/widget/MotionScene;->L(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)I
    ...
    invoke-virtual {v4, p1, v2}, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;->u(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {v4, v3}, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;->n(Landroidx/constraintlayout/motion/widget/MotionScene$Transition;Landroidx/constraintlayout/motion/widget/TouchResponse;)Landroidx/constraintlayout/motion/widget/TouchResponse;
    ...
    invoke-static {v4}, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;->e(Landroidx/constraintlayout/motion/widget/MotionScene$Transition;)Z
    ...
    invoke-static {v3}, Landroidx/constraintlayout/motion/widget/MotionScene$Transition;->l(Landroidx/constraintlayout/motion/widget/MotionScene$Transition;)Landroidx/constraintlayout/motion/widget/TouchResponse;

    move-result-object v3

    iget-boolean v5, p0, Landroidx/constraintlayout/motion/widget/MotionScene;->q:Z

    invoke-virtual {v3, v5}, Landroidx/constraintlayout/motion/widget/TouchResponse;->x(Z)V
    ...
    iput-object v4, p0, Landroidx/constraintlayout/motion/widget/MotionScene;->f:Landroidx/constraintlayout/motion/widget/MotionScene$Transition;
    ...
    :pswitch_8
    invoke-direct {p0, p1, v2}, Landroidx/constraintlayout/motion/widget/MotionScene;->O(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private L(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)I
    ...
    invoke-virtual {v7, v8}, Landroidx/constraintlayout/widget/ConstraintSet;->V(Z)V
    ...
    :pswitch_0
    invoke-virtual {v7, v15}, Landroidx/constraintlayout/widget/ConstraintSet;->X(Ljava/lang/String;)V

    goto/16 :goto_5

    :pswitch_1
    invoke-direct {v0, v1, v15}, Landroidx/constraintlayout/motion/widget/MotionScene;->r(Landroid/content/Context;Ljava/lang/String;)I

    move-result v12

    iget-object v10, v0, Landroidx/constraintlayout/motion/widget/MotionScene;->i:Ljava/util/HashMap;

    invoke-static {v15}, Landroidx/constraintlayout/motion/widget/MotionScene;->a0(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v12}, Landroidx/constraintlayout/motion/widget/Debug;->c(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v10

    iput-object v10, v7, Landroidx/constraintlayout/widget/ConstraintSet;->b:Ljava/lang/String;
    ...
    iput v10, v7, Landroidx/constraintlayout/widget/ConstraintSet;->e:I
    :try_end_0
    ...
    :pswitch_3
    iput v4, v7, Landroidx/constraintlayout/widget/ConstraintSet;->e:I

    goto :goto_5

    :pswitch_4
    iput v6, v7, Landroidx/constraintlayout/widget/ConstraintSet;->e:I

    goto :goto_5

    :pswitch_5
    iput v8, v7, Landroidx/constraintlayout/widget/ConstraintSet;->e:I

    goto :goto_5

    :pswitch_6
    iput v5, v7, Landroidx/constraintlayout/widget/ConstraintSet;->e:I

    goto :goto_5

    :pswitch_7
    iput v3, v7, Landroidx/constraintlayout/widget/ConstraintSet;->e:I
    ...
    iget v3, v3, Landroidx/constraintlayout/motion/widget/MotionLayout;->O:I

    if-eqz v3, :cond_a

    invoke-virtual {v7, v6}, Landroidx/constraintlayout/widget/ConstraintSet;->Y(Z)V

    :cond_a
    invoke-virtual {v7, v1, v2}, Landroidx/constraintlayout/widget/ConstraintSet;->I(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    if-eq v13, v10, :cond_b

    iget-object v1, v0, Landroidx/constraintlayout/motion/widget/MotionScene;->j:Landroid/util/SparseIntArray;

    invoke-virtual {v1, v12, v13}, Landroid/util/SparseIntArray;->put(II)V

    :cond_b
    iget-object v1, v0, Landroidx/constraintlayout/motion/widget/MotionScene;->h:Landroid/util/SparseArray;
...
.method private S(ILandroidx/constraintlayout/motion/widget/MotionLayout;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/constraintlayout/widget/ConstraintSet;->Q(Landroidx/constraintlayout/widget/ConstraintSet;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/constraintlayout/widget/ConstraintSet;->P(Landroidx/constraintlayout/widget/ConstraintLayout;)V
