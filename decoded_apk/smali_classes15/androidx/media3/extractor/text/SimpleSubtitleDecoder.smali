...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->o:Ljava/lang/String;
...
.method static synthetic t(Landroidx/media3/extractor/text/SimpleSubtitleDecoder;Landroidx/media3/decoder/DecoderOutputBuffer;)V
    .locals 0
...
.method protected bridge synthetic e()Landroidx/media3/decoder/DecoderInputBuffer;
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->u()Landroidx/media3/extractor/text/SubtitleInputBuffer;
...
.method protected bridge synthetic f()Landroidx/media3/decoder/DecoderOutputBuffer;
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->v()Landroidx/media3/extractor/text/SubtitleOutputBuffer;
...
.method protected bridge synthetic g(Ljava/lang/Throwable;)Landroidx/media3/decoder/DecoderException;
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->w(Ljava/lang/Throwable;)Landroidx/media3/extractor/text/SubtitleDecoderException;
...
.method public final getName()Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->o:Ljava/lang/String;
...
.method protected bridge synthetic h(Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/decoder/DecoderOutputBuffer;Z)Landroidx/media3/decoder/DecoderException;
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->y(Landroidx/media3/extractor/text/SubtitleInputBuffer;Landroidx/media3/extractor/text/SubtitleOutputBuffer;Z)Landroidx/media3/extractor/text/SubtitleDecoderException;
...
.method protected final u()Landroidx/media3/extractor/text/SubtitleInputBuffer;
    .locals 1
...
.method protected final v()Landroidx/media3/extractor/text/SubtitleOutputBuffer;
    .locals 1
...
.method protected abstract x([BIZ)Landroidx/media3/extractor/text/Subtitle;
...
.method protected final y(Landroidx/media3/extractor/text/SubtitleInputBuffer;Landroidx/media3/extractor/text/SubtitleOutputBuffer;Z)Landroidx/media3/extractor/text/SubtitleDecoderException;
    .locals 8
    ...
    invoke-virtual {p0, v1, v0, p3}, Landroidx/media3/extractor/text/SimpleSubtitleDecoder;->x([BIZ)Landroidx/media3/extractor/text/Subtitle;

    move-result-object v5

    iget-wide v3, p1, Landroidx/media3/decoder/DecoderInputBuffer;->g:J

    iget-wide v6, p1, Landroidx/media3/extractor/text/SubtitleInputBuffer;->k:J

    move-object v2, p2

    invoke-virtual/range {v2 .. v7}, Landroidx/media3/extractor/text/SubtitleOutputBuffer;->m(JLandroidx/media3/extractor/text/Subtitle;J)V

    const/4 p1, 0x0

    iput-boolean p1, p2, Landroidx/media3/decoder/DecoderOutputBuffer;->e:Z
    :try_end_0
