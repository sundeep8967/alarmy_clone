...
.method private static b(Landroid/net/Uri;)Ljava/io/RandomAccessFile;
    .locals 4
    ...
    invoke-static {v2}, Landroidx/media3/datasource/FileDataSource$Api21;->a(Ljava/lang/Throwable;)Z
...
.method public close()V
    ...
    iput-object v0, p0, Landroidx/media3/datasource/FileDataSource;->s:Landroid/net/Uri;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Landroidx/media3/datasource/FileDataSource;->r:Ljava/io/RandomAccessFile;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Landroidx/media3/datasource/FileDataSource;->r:Ljava/io/RandomAccessFile;

    iget-boolean v0, p0, Landroidx/media3/datasource/FileDataSource;->u:Z

    if-eqz v0, :cond_1

    iput-boolean v1, p0, Landroidx/media3/datasource/FileDataSource;->u:Z
...
.method public getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroidx/media3/datasource/FileDataSource;->s:Landroid/net/Uri;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    invoke-static {v0}, Landroidx/media3/datasource/FileDataSource;->b(Landroid/net/Uri;)Ljava/io/RandomAccessFile;
    ...
    iget-object v0, p0, Landroidx/media3/datasource/FileDataSource;->r:Ljava/io/RandomAccessFile;
    ...
    :cond_0
    :goto_0
    iput-wide v0, p0, Landroidx/media3/datasource/FileDataSource;->t:J
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-boolean v0, p0, Landroidx/media3/datasource/FileDataSource;->u:Z

    invoke-virtual {p0, p1}, Landroidx/media3/datasource/BaseDataSource;->transferStarted(Landroidx/media3/datasource/DataSpec;)V

    iget-wide v0, p0, Landroidx/media3/datasource/FileDataSource;->t:J
...
.method public read([BII)I
    ...
    iget-wide v1, p0, Landroidx/media3/datasource/FileDataSource;->t:J
    ...
    iget-wide p2, p0, Landroidx/media3/datasource/FileDataSource;->t:J

    int-to-long v0, p1

    sub-long/2addr p2, v0

    iput-wide p2, p0, Landroidx/media3/datasource/FileDataSource;->t:J
