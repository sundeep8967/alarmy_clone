...
.field public static volatile q:[Lio/appmetrica/analytics/impl/Ni;
...
.field public e:Lio/appmetrica/analytics/impl/Ii;
...
.field public j:Lio/appmetrica/analytics/impl/Mi;

.field public k:Lio/appmetrica/analytics/impl/Li;
...
.method public constructor <init>()V
    ...
    invoke-virtual {p0}, Lio/appmetrica/analytics/impl/Ni;->a()Lio/appmetrica/analytics/impl/Ni;

    return-void
.end method

.method public static a([B)Lio/appmetrica/analytics/impl/Ni;
    .locals 1
    ...
    invoke-direct {v0}, Lio/appmetrica/analytics/impl/Ni;-><init>()V

    invoke-static {v0, p0}, Lio/appmetrica/analytics/protobuf/nano/MessageNano;->mergeFrom(Lio/appmetrica/analytics/protobuf/nano/MessageNano;[B)Lio/appmetrica/analytics/protobuf/nano/MessageNano;

    move-result-object p0

    check-cast p0, Lio/appmetrica/analytics/impl/Ni;

    return-object p0
.end method

.method public static b(Lio/appmetrica/analytics/protobuf/nano/CodedInputByteBufferNano;)Lio/appmetrica/analytics/impl/Ni;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {v0, p0}, Lio/appmetrica/analytics/impl/Ni;->a(Lio/appmetrica/analytics/protobuf/nano/CodedInputByteBufferNano;)Lio/appmetrica/analytics/impl/Ni;
...
.method public static b()[Lio/appmetrica/analytics/impl/Ni;
    .locals 2

    .line 1
    sget-object v0, Lio/appmetrica/analytics/impl/Ni;->q:[Lio/appmetrica/analytics/impl/Ni;
    ...
    .line 3
    :try_start_0
    sget-object v1, Lio/appmetrica/analytics/impl/Ni;->q:[Lio/appmetrica/analytics/impl/Ni;
    ...
    .line 4
    new-array v1, v1, [Lio/appmetrica/analytics/impl/Ni;

    sput-object v1, Lio/appmetrica/analytics/impl/Ni;->q:[Lio/appmetrica/analytics/impl/Ni;
...
# virtual methods
.method public final a()Lio/appmetrica/analytics/impl/Ni;
    .locals 4

    const/4 v0, 0x1

    .line 1
    iput v0, p0, Lio/appmetrica/analytics/impl/Ni;->a:I
    ...
    .line 6
    iput-wide v2, p0, Lio/appmetrica/analytics/impl/Ni;->f:J

    const/4 v2, 0x0

    .line 7
    iput-boolean v2, p0, Lio/appmetrica/analytics/impl/Ni;->g:Z

    .line 8
    iput v2, p0, Lio/appmetrica/analytics/impl/Ni;->h:I

    .line 9
    iput v0, p0, Lio/appmetrica/analytics/impl/Ni;->i:I

    .line 10
    iput-object v1, p0, Lio/appmetrica/analytics/impl/Ni;->j:Lio/appmetrica/analytics/impl/Mi;

    .line 11
    iput-object v1, p0, Lio/appmetrica/analytics/impl/Ni;->k:Lio/appmetrica/analytics/impl/Li;
...
.method public final a(Lio/appmetrica/analytics/protobuf/nano/CodedInputByteBufferNano;)Lio/appmetrica/analytics/impl/Ni;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 15
    :sswitch_0
    iget-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->k:Lio/appmetrica/analytics/impl/Li;
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->k:Lio/appmetrica/analytics/impl/Li;
    ...
    .line 18
    :sswitch_1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->j:Lio/appmetrica/analytics/impl/Mi;
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->j:Lio/appmetrica/analytics/impl/Mi;
    ...
    .line 24
    :cond_4
    iput v0, p0, Lio/appmetrica/analytics/impl/Ni;->h:I
    ...
    iput-boolean v0, p0, Lio/appmetrica/analytics/impl/Ni;->g:Z
    ...
    iput-wide v0, p0, Lio/appmetrica/analytics/impl/Ni;->f:J

    goto :goto_0

    .line 27
    :sswitch_6
    iget-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->e:Lio/appmetrica/analytics/impl/Ii;
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->e:Lio/appmetrica/analytics/impl/Ii;
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->d:[B
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->c:[B
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->b:[B
...
.method public final computeSerializedSize()I
    ...
    iget v1, p0, Lio/appmetrica/analytics/impl/Ni;->a:I
    ...
    :cond_0
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Ni;->b:[B
    ...
    iget-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->c:[B
    ...
    :cond_1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->d:[B
    ...
    :cond_3
    iget-wide v3, p0, Lio/appmetrica/analytics/impl/Ni;->f:J
    ...
    :cond_4
    iget-boolean v0, p0, Lio/appmetrica/analytics/impl/Ni;->g:Z
    ...
    :cond_5
    iget v0, p0, Lio/appmetrica/analytics/impl/Ni;->h:I
    ...
    :cond_6
    iget v0, p0, Lio/appmetrica/analytics/impl/Ni;->i:I
...
.method public final bridge synthetic mergeFrom(Lio/appmetrica/analytics/protobuf/nano/CodedInputByteBufferNano;)Lio/appmetrica/analytics/protobuf/nano/MessageNano;
    ...
    invoke-virtual {p0, p1}, Lio/appmetrica/analytics/impl/Ni;->a(Lio/appmetrica/analytics/protobuf/nano/CodedInputByteBufferNano;)Lio/appmetrica/analytics/impl/Ni;
...
.method public final writeTo(Lio/appmetrica/analytics/protobuf/nano/CodedOutputByteBufferNano;)V
    ...
    iget v0, p0, Lio/appmetrica/analytics/impl/Ni;->a:I
    ...
    :cond_0
    iget-object v0, p0, Lio/appmetrica/analytics/impl/Ni;->b:[B
    ...
    :cond_3
    iget-wide v2, p0, Lio/appmetrica/analytics/impl/Ni;->f:J
