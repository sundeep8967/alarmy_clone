...
.method constructor <init>(Landroidx/camera/video/internal/encoder/EncoderImpl;)V
    ...
    sget-object p1, Landroidx/camera/video/internal/BufferProvider$State;->c:Landroidx/camera/video/internal/BufferProvider$State;
...
.method public static synthetic f(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->w(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method public static synthetic h(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->x(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
...
.method public static synthetic i(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/camera/core/impl/Observable$Observer;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->v(Landroidx/camera/core/impl/Observable$Observer;Ljava/util/concurrent/Executor;)V
...
.method public static synthetic k(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/camera/core/impl/Observable$Observer;)V
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->y(Landroidx/camera/core/impl/Observable$Observer;)V

    return-void
.end method

.method public static synthetic l(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Lcom/google/common/util/concurrent/m;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->r(Lcom/google/common/util/concurrent/m;)V
...
.method public static synthetic m(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->t(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
...
.method public static synthetic n(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->s(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V

    return-void
.end method

.method public static synthetic o(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Lcom/google/common/util/concurrent/m;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->q(Lcom/google/common/util/concurrent/m;)V

    return-void
.end method

.method private p(Lcom/google/common/util/concurrent/m;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private synthetic q(Lcom/google/common/util/concurrent/m;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;->p(Lcom/google/common/util/concurrent/m;)V

    return-void
.end method

.method private synthetic r(Lcom/google/common/util/concurrent/m;)V
    .locals 1
...
.method private synthetic s(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 3
    ...
    invoke-virtual {v0}, Landroidx/camera/video/internal/encoder/EncoderImpl;->A()Lcom/google/common/util/concurrent/m;
    ...
    :cond_0
    sget-object v1, Landroidx/camera/video/internal/BufferProvider$State;->c:Landroidx/camera/video/internal/BufferProvider$State;
...
.method private synthetic t(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
...
.method private static synthetic u(Landroidx/camera/core/impl/Observable$Observer;Landroidx/camera/video/internal/BufferProvider$State;)V
    .locals 0
...
.method private synthetic v(Landroidx/camera/core/impl/Observable$Observer;Ljava/util/concurrent/Executor;)V
    .locals 3
    ...
    invoke-direct {v1, p1, v0}, Landroidx/camera/video/internal/encoder/d0;-><init>(Landroidx/camera/core/impl/Observable$Observer;Landroidx/camera/video/internal/BufferProvider$State;)V
...
.method private synthetic w(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 1
...
.method private synthetic x(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {v1, p0, p1}, Landroidx/camera/video/internal/encoder/y;-><init>(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic y(Landroidx/camera/core/impl/Observable$Observer;)V
    .locals 1
...
.method private static synthetic z(Ljava/util/Map$Entry;Landroidx/camera/video/internal/BufferProvider$State;)V
    .locals 0
...
.method A(Z)V
    ...
    new-instance v3, Landroidx/camera/video/internal/encoder/z;

    invoke-direct {v3, v1, p1}, Landroidx/camera/video/internal/encoder/z;-><init>(Ljava/util/Map$Entry;Landroidx/camera/video/internal/BufferProvider$State;)V
...
.method public b()Lcom/google/common/util/concurrent/m;
    ...
    invoke-direct {v0, p0}, Landroidx/camera/video/internal/encoder/u;-><init>(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;)V
...
.method public d(Landroidx/camera/core/impl/Observable$Observer;)V
    ...
    invoke-direct {v1, p0, p1}, Landroidx/camera/video/internal/encoder/a0;-><init>(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;Landroidx/camera/core/impl/Observable$Observer;)V
...
.method public e()Lcom/google/common/util/concurrent/m;
    ...
    invoke-direct {v0, p0}, Landroidx/camera/video/internal/encoder/v;-><init>(Landroidx/camera/video/internal/encoder/EncoderImpl$ByteBufferInput;)V
