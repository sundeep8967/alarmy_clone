...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroidx/collection/LongSparseArray;->o(JLjava/lang/Object;)V
    :try_end_0
...
.method private c(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-static {p1}, Landroidx/appcompat/widget/ResourceManagerInternal;->p(Landroid/graphics/drawable/Drawable;)Z
...
.method private e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->d(Landroid/util/TypedValue;)J

    move-result-wide v1

    invoke-direct {p0, p1, v1, v2}, Landroidx/appcompat/widget/ResourceManagerInternal;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v1, v2, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private static f(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/widget/ResourceManagerInternal;->k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public static declared-synchronized g()Landroidx/appcompat/widget/ResourceManagerInternal;
    .locals 2
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/ResourceManagerInternal;->o(Landroidx/appcompat/widget/ResourceManagerInternal;)V
...
.method private declared-synchronized h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Landroidx/collection/LongSparseArray;->i(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Landroidx/collection/LongSparseArray;->x(J)V
    :try_end_2
...
.method public static declared-synchronized k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/ResourceManagerInternal$ColorFilterLruCache;->c(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static o(Landroidx/appcompat/widget/ResourceManagerInternal;)V
    .locals 0
...
.method private q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v4, v5}, Landroidx/appcompat/widget/ResourceManagerInternal;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/ResourceManagerInternal;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->n(I)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;->d(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/widget/ResourceManagerInternal;->w(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method static v(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;[I)V
    .locals 2
    ...
    :goto_2
    invoke-static {v0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->f(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
...
.method public declared-synchronized i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->j(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized j(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/ResourceManagerInternal;->c(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method n(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;->c(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized s(Landroid/content/Context;Landroidx/appcompat/widget/VectorEnabledTintResources;I)Landroid/graphics/drawable/Drawable;
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-direct {p0, p1, p3}, Landroidx/appcompat/widget/ResourceManagerInternal;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/ResourcesWrapper;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized t(Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;)V
    .locals 0
...
.method w(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;->e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
