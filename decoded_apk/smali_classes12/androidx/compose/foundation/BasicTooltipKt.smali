...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "c",
        "(ZLandroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;Lza0/p;Landroidx/compose/runtime/Composer;II)V",
        "Lkotlinx/coroutines/p0;",
        "scope",
        "b",
        "(Landroidx/compose/ui/window/PopupPositionProvider;Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;ZLza0/p;Landroidx/compose/runtime/Composer;I)V",
        "enabled",
        "g",
        ...
        "label",
        "f",
        "(Landroidx/compose/ui/Modifier;Ljava/lang/String;ZLandroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;)Landroidx/compose/ui/Modifier;",
        "foundation_release"
    }
    k = 0x2
    mv = {
...
# direct methods
.method public static final a(Landroidx/compose/ui/window/PopupPositionProvider;Lza0/p;Landroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;ZZLza0/p;Landroidx/compose/runtime/Composer;II)V
    .locals 20
    ...
    invoke-interface {v9, v4, v10}, Landroidx/compose/runtime/Composer;->d(ZI)Z
    ...
    invoke-static {v6, v1, v13}, Landroidx/compose/runtime/Updater;->e(Landroidx/compose/runtime/Composer;Ljava/lang/Object;Lza0/p;)V
    ...
    invoke-static/range {v0 .. v6}, Landroidx/compose/foundation/BasicTooltipKt;->b(Landroidx/compose/ui/window/PopupPositionProvider;Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;ZLza0/p;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-static/range {v0 .. v6}, Landroidx/compose/foundation/BasicTooltipKt;->c(ZLandroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;Lza0/p;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-static {v7, v0, v9, v1}, Landroidx/compose/runtime/EffectsKt;->c(Ljava/lang/Object;Lza0/l;Landroidx/compose/runtime/Composer;I)V
    ...
    invoke-direct/range {v0 .. v9}, Landroidx/compose/foundation/BasicTooltipKt$BasicTooltipBox$3;-><init>(Landroidx/compose/ui/window/PopupPositionProvider;Lza0/p;Landroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;ZZLza0/p;II)V
...
.method private static final b(Landroidx/compose/ui/window/PopupPositionProvider;Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;ZLza0/p;Landroidx/compose/runtime/Composer;I)V
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v7, v10, v11}, Landroidx/compose/runtime/ComposerKt;->U(IIILjava/lang/String;)V

    :cond_b
    sget-object v0, Landroidx/compose/foundation/BasicTooltipStrings;->a:Landroidx/compose/foundation/BasicTooltipStrings;

    const/4 v10, 0x6

    invoke-virtual {v0, v1, v10}, Landroidx/compose/foundation/BasicTooltipStrings;->a(Landroidx/compose/runtime/Composer;I)Ljava/lang/String;
    ...
    invoke-direct {v10, v2, v3}, Landroidx/compose/foundation/BasicTooltipKt$TooltipPopup$1$1;-><init>(Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;)V
    ...
    invoke-direct {v10, v0, v5}, Landroidx/compose/foundation/BasicTooltipKt$TooltipPopup$2;-><init>(Ljava/lang/String;Lza0/p;)V
    ...
    invoke-static {v11, v12, v10, v1, v0}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->e(IZLjava/lang/Object;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/compose/foundation/BasicTooltipKt$TooltipPopup$3;-><init>(Landroidx/compose/ui/window/PopupPositionProvider;Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;ZLza0/p;I)V
...
.method private static final c(ZLandroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;Lza0/p;Landroidx/compose/runtime/Composer;II)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-interface {p4, v3}, Landroidx/compose/runtime/Composer;->D(I)Landroidx/compose/runtime/Composer;
    ...
    invoke-interface {p4, v1, v4}, Landroidx/compose/runtime/Composer;->d(ZI)Z
    ...
    invoke-static {v3, v5, v0, v1}, Landroidx/compose/runtime/ComposerKt;->U(IIILjava/lang/String;)V
    ...
    invoke-static {v0, p4}, Landroidx/compose/runtime/EffectsKt;->l(Lpa0/i;Landroidx/compose/runtime/Composer;)Lkotlinx/coroutines/p0;
    ...
    sget-object v1, Landroidx/compose/foundation/BasicTooltipStrings;->a:Landroidx/compose/foundation/BasicTooltipStrings;

    invoke-virtual {v1, p4, v2}, Landroidx/compose/foundation/BasicTooltipStrings;->b(Landroidx/compose/runtime/Composer;I)Ljava/lang/String;

    move-result-object v1

    invoke-static {p2, p0, p1}, Landroidx/compose/foundation/BasicTooltipKt;->g(Landroidx/compose/ui/Modifier;ZLandroidx/compose/foundation/BasicTooltipState;)Landroidx/compose/ui/Modifier;

    move-result-object v2

    invoke-static {v2, v1, p0, p1, v0}, Landroidx/compose/foundation/BasicTooltipKt;->f(Landroidx/compose/ui/Modifier;Ljava/lang/String;ZLandroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;)Landroidx/compose/ui/Modifier;
    ...
    invoke-static {p4, v7}, Landroidx/compose/runtime/ComposablesKt;->a(Landroidx/compose/runtime/Composer;I)I
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/compose/foundation/BasicTooltipKt$WrappedAnchor$2;-><init>(ZLandroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;Lza0/p;II)V
...
.method public static final synthetic d(Landroidx/compose/ui/window/PopupPositionProvider;Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;ZLza0/p;Landroidx/compose/runtime/Composer;I)V
    .locals 0

    invoke-static/range {p0 .. p6}, Landroidx/compose/foundation/BasicTooltipKt;->b(Landroidx/compose/ui/window/PopupPositionProvider;Landroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;ZLza0/p;Landroidx/compose/runtime/Composer;I)V

    return-void
.end method

.method public static final synthetic e(ZLandroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;Lza0/p;Landroidx/compose/runtime/Composer;II)V
    .locals 0

    invoke-static/range {p0 .. p6}, Landroidx/compose/foundation/BasicTooltipKt;->c(ZLandroidx/compose/foundation/BasicTooltipState;Landroidx/compose/ui/Modifier;Lza0/p;Landroidx/compose/runtime/Composer;II)V

    return-void
.end method

.method private static final f(Landroidx/compose/ui/Modifier;Ljava/lang/String;ZLandroidx/compose/foundation/BasicTooltipState;Lkotlinx/coroutines/p0;)Landroidx/compose/ui/Modifier;
    .locals 0
    ...
    invoke-direct {p2, p1, p4, p3}, Landroidx/compose/foundation/BasicTooltipKt$anchorSemantics$1;-><init>(Ljava/lang/String;Lkotlinx/coroutines/p0;Landroidx/compose/foundation/BasicTooltipState;)V
...
.method private static final g(Landroidx/compose/ui/Modifier;ZLandroidx/compose/foundation/BasicTooltipState;)Landroidx/compose/ui/Modifier;
    .locals 0
    ...
    invoke-static {p0, p2, p1}, Landroidx/compose/ui/input/pointer/SuspendingPointerInputFilterKt;->d(Landroidx/compose/ui/Modifier;Ljava/lang/Object;Landroidx/compose/ui/input/pointer/PointerInputEventHandler;)Landroidx/compose/ui/Modifier;
