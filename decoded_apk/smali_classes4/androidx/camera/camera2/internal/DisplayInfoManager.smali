...
.field private static volatile i:Landroidx/camera/camera2/internal/DisplayInfoManager;
...
.field private final d:Landroidx/camera/camera2/internal/compat/workaround/DisplaySizeCorrector;
...
.method private a()Landroid/util/Size;
    ...
    invoke-direct {p0}, Landroidx/camera/camera2/internal/DisplayInfoManager;->b()Landroid/util/Size;
    ...
    sget-object v2, Landroidx/camera/camera2/internal/DisplayInfoManager;->e:Landroid/util/Size;
    ...
    :cond_0
    iget-object v1, p0, Landroidx/camera/camera2/internal/DisplayInfoManager;->c:Landroidx/camera/camera2/internal/compat/workaround/MaxPreviewSize;

    invoke-virtual {v1, v0}, Landroidx/camera/camera2/internal/compat/workaround/MaxPreviewSize;->a(Landroid/util/Size;)Landroid/util/Size;
...
.method private b()Landroid/util/Size;
    ...
    invoke-virtual {p0, v1}, Landroidx/camera/camera2/internal/DisplayInfoManager;->d(Z)Landroid/view/Display;
    ...
    invoke-static {v1, v0}, Landroidx/camera/core/internal/utils/SizeUtil;->d(Landroid/util/Size;Landroid/util/Size;)Z
    ...
    invoke-virtual {v0}, Landroidx/camera/camera2/internal/compat/workaround/DisplaySizeCorrector;->a()Landroid/util/Size;
...
.method public static c(Landroid/content/Context;)Landroidx/camera/camera2/internal/DisplayInfoManager;
    .locals 2
...
.method public d(Z)Landroid/view/Display;
    ...
    :cond_0
    invoke-direct {p0, v0, p1}, Landroidx/camera/camera2/internal/DisplayInfoManager;->e([Landroid/view/Display;Z)Landroid/view/Display;
    ...
    invoke-direct {p0, v0, v3}, Landroidx/camera/camera2/internal/DisplayInfoManager;->e([Landroid/view/Display;Z)Landroid/view/Display;
