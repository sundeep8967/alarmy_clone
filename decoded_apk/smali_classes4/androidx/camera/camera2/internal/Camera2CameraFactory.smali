...
.field private final b:Landroidx/camera/core/concurrent/CameraCoordinator;

.field private final c:Landroidx/camera/core/impl/CameraThreadConfig;

.field private final d:Landroidx/camera/core/impl/CameraStateRegistry;

.field private final e:Landroidx/camera/camera2/internal/compat/CameraManagerCompat;
...
.field private final g:Landroidx/camera/camera2/internal/DisplayInfoManager;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/core/impl/CameraThreadConfig;Landroidx/camera/core/CameraSelector;J)V
    ...
    iput-object v0, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->i:Ljava/util/Map;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CameraFactory;->e(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->f:Ljava/util/List;
    ...
    iput-object p1, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->b:Landroidx/camera/core/concurrent/CameraCoordinator;
...
.method private e(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    iget-object v2, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->e:Landroidx/camera/camera2/internal/compat/CameraManagerCompat;

    invoke-static {v2, v1}, Landroidx/camera/camera2/internal/CameraIdUtil;->a(Landroidx/camera/camera2/internal/compat/CameraManagerCompat;Ljava/lang/String;)Z
...
.method public a(Ljava/lang/String;)Landroidx/camera/core/impl/CameraInternal;
    ...
    iget-object v0, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->f:Ljava/util/List;
    ...
    iget-object v6, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->b:Landroidx/camera/core/concurrent/CameraCoordinator;
    ...
    iget-object v1, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->c:Landroidx/camera/core/impl/CameraThreadConfig;
...
.method public b()Ljava/util/Set;
    ...
    iget-object v1, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->f:Ljava/util/List;
...
.method public c()Landroidx/camera/core/concurrent/CameraCoordinator;
    ...
    iget-object v0, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->b:Landroidx/camera/core/concurrent/CameraCoordinator;
...
.method f(Ljava/lang/String;)Landroidx/camera/camera2/internal/Camera2CameraInfoImpl;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/camera/core/CameraUnavailableException;
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->i:Ljava/util/Map;
    ...
    iget-object v1, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->e:Landroidx/camera/camera2/internal/compat/CameraManagerCompat;
    ...
    iget-object v1, p0, Landroidx/camera/camera2/internal/Camera2CameraFactory;->i:Ljava/util/Map;
