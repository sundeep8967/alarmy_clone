...
.method private d(Landroid/text/Spanned;Ljava/lang/String;)Landroidx/media3/common/text/Cue;
    .locals 16
    ...
    invoke-static {v0}, Landroidx/media3/extractor/text/subrip/SubripParser;->f(I)F
    ...
    invoke-static {v1}, Landroidx/media3/extractor/text/subrip/SubripParser;->f(I)F
...
.method private e(Landroidx/media3/common/util/ParsableByteArray;)Ljava/nio/charset/Charset;
    .locals 0
...
.method private h(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    sget-object v1, Landroidx/media3/extractor/text/subrip/SubripParser;->e:Ljava/util/regex/Pattern;
...
.method public c([BIILandroidx/media3/extractor/text/SubtitleParser$OutputOptions;Landroidx/media3/common/util/Consumer;)V
    ...
    iget-object v5, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->c:Landroidx/media3/common/util/ParsableByteArray;

    add-int v6, v1, p3

    move-object/from16 v7, p1

    invoke-virtual {v5, v7, v6}, Landroidx/media3/common/util/ParsableByteArray;->S([BI)V

    iget-object v5, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->c:Landroidx/media3/common/util/ParsableByteArray;

    invoke-virtual {v5, v1}, Landroidx/media3/common/util/ParsableByteArray;->U(I)V

    iget-object v1, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->c:Landroidx/media3/common/util/ParsableByteArray;

    invoke-direct {v0, v1}, Landroidx/media3/extractor/text/subrip/SubripParser;->e(Landroidx/media3/common/util/ParsableByteArray;)Ljava/nio/charset/Charset;

    move-result-object v1

    iget-wide v5, v2, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J
    ...
    iget-boolean v5, v2, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->b:Z
    ...
    :goto_0
    iget-object v9, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->c:Landroidx/media3/common/util/ParsableByteArray;

    invoke-virtual {v9, v1}, Landroidx/media3/common/util/ParsableByteArray;->t(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    :cond_3
    sget-object v10, Landroidx/media3/extractor/text/subrip/SubripParser;->d:Ljava/util/regex/Pattern;
    ...
    invoke-static {v10, v9}, Landroidx/media3/extractor/text/subrip/SubripParser;->g(Ljava/util/regex/Matcher;I)J
    ...
    iget-object v11, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->a:Ljava/lang/StringBuilder;
    ...
    iget-object v11, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->c:Landroidx/media3/common/util/ParsableByteArray;

    invoke-virtual {v11, v1}, Landroidx/media3/common/util/ParsableByteArray;->t(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    iget-object v15, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->a:Ljava/lang/StringBuilder;
    ...
    :cond_4
    iget-object v6, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->a:Ljava/lang/StringBuilder;

    iget-object v15, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->b:Ljava/util/ArrayList;

    invoke-direct {v0, v11, v15}, Landroidx/media3/extractor/text/subrip/SubripParser;->h(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v6, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v6, v0, Landroidx/media3/extractor/text/subrip/SubripParser;->c:Landroidx/media3/common/util/ParsableByteArray;

    invoke-virtual {v6, v1}, Landroidx/media3/common/util/ParsableByteArray;->t(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    :goto_3
    iget-wide v3, v2, Landroidx/media3/extractor/text/SubtitleParser$OutputOptions;->a:J
    ...
    invoke-direct {v0, v6, v11}, Landroidx/media3/extractor/text/subrip/SubripParser;->d(Landroid/text/Spanned;Ljava/lang/String;)Landroidx/media3/common/text/Cue;
    ...
    invoke-static {v6, v3}, Landroidx/media3/common/util/Log;->h(Ljava/lang/String;Ljava/lang/String;)V
