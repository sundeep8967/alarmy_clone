...
# static fields
.field private static volatile c:Leq/a;
...
.method private constructor <init>(Lcom/google/android/gms/measurement/api/AppMeasurementSdk;)V
    ...
    iput-object p1, p0, Leq/b;->a:Lcom/google/android/gms/measurement/api/AppMeasurementSdk;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Leq/b;->b:Ljava/util/Map;

    return-void
.end method

.method public static h(Lcom/google/firebase/f;Landroid/content/Context;Lnq/d;)Leq/a;
    .locals 5
    ...
    sget-object v3, Leq/c;->b:Leq/c;

    sget-object v4, Leq/d;->a:Leq/d;

    invoke-interface {p2, v2, v3, v4}, Lnq/d;->a(Ljava/lang/Class;Ljava/util/concurrent/Executor;Lnq/b;)V
    ...
    invoke-direct {p0, p1}, Leq/b;-><init>(Lcom/google/android/gms/measurement/api/AppMeasurementSdk;)V

    sput-object p0, Leq/b;->c:Leq/a;
    ...
    :cond_2
    :goto_2
    sget-object p0, Leq/b;->c:Leq/a;

    return-object p0
.end method

.method static synthetic i(Lnq/a;)V
    .locals 2

    invoke-virtual {p0}, Lnq/a;->a()Ljava/lang/Object;
    ...
    iget-object v1, v1, Leq/b;->a:Lcom/google/android/gms/measurement/api/AppMeasurementSdk;
...
.method private final j(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Leq/b;->b:Ljava/util/Map;
...
.method public a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Leq/b;->a:Lcom/google/android/gms/measurement/api/AppMeasurementSdk;
...
.method public d(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, p0, Leq/b;->a:Lcom/google/android/gms/measurement/api/AppMeasurementSdk;
    ...
    invoke-static {p2}, Lcom/google/firebase/analytics/connector/internal/a;->b(Landroid/os/Bundle;)Leq/a$c;
...
.method public e(Leq/a$c;)V
    .locals 1

    invoke-static {p1}, Lcom/google/firebase/analytics/connector/internal/a;->g(Leq/a$c;)Z
    ...
    invoke-static {p1}, Lcom/google/firebase/analytics/connector/internal/a;->a(Leq/a$c;)Landroid/os/Bundle;
...
.method public g(Ljava/lang/String;Leq/a$b;)Leq/a$a;
    .locals 3
    ...
    :cond_0
    invoke-direct {p0, p1}, Leq/b;->j(Ljava/lang/String;)Z
    ...
    invoke-direct {v2, v0, p2}, Lcom/google/firebase/analytics/connector/internal/d;-><init>(Lcom/google/android/gms/measurement/api/AppMeasurementSdk;Leq/a$b;)V
    ...
    invoke-direct {v2, v0, p2}, Lcom/google/firebase/analytics/connector/internal/f;-><init>(Lcom/google/android/gms/measurement/api/AppMeasurementSdk;Leq/a$b;)V
    ...
    iget-object p2, p0, Leq/b;->b:Ljava/util/Map;

    invoke-interface {p2, p1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    new-instance p2, Leq/b$a;

    invoke-direct {p2, p0, p1}, Leq/b$a;-><init>(Leq/b;Ljava/lang/String;)V
