...
.method public static synthetic a(Landroidx/profileinstaller/DeviceProfileWriter;ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/profileinstaller/DeviceProfileWriter;->g(ILjava/lang/Object;)V
...
.method private b([Landroidx/profileinstaller/DexProfileData;[B)Landroidx/profileinstaller/DeviceProfileWriter;
    ...
    invoke-direct {p0, v1, v2}, Landroidx/profileinstaller/DeviceProfileWriter;->h(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-static {v1, v2}, Landroidx/profileinstaller/ProfileTranscoder;->p(Ljava/io/InputStream;[B)[B

    move-result-object v2

    invoke-static {v1, v2, p2, p1}, Landroidx/profileinstaller/ProfileTranscoder;->r(Ljava/io/InputStream;[B[B[Landroidx/profileinstaller/DexProfileData;)[Landroidx/profileinstaller/DexProfileData;
    ...
    invoke-interface {p2, v1, p1}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->a(ILjava/lang/Object;)V
...
.method private f(Landroid/content/res/AssetManager;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->h(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-interface {v0, v1, p1}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->a(ILjava/lang/Object;)V
...
.method private h(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-interface {p1, v0, p2}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->b(ILjava/lang/Object;)V
...
.method private j(Ljava/io/InputStream;)[Landroidx/profileinstaller/DexProfileData;
    .locals 4
    ...
    invoke-static {p1, v1}, Landroidx/profileinstaller/ProfileTranscoder;->p(Ljava/io/InputStream;[B)[B

    move-result-object v1

    iget-object v2, p0, Landroidx/profileinstaller/DeviceProfileWriter;->f:Ljava/lang/String;

    invoke-static {p1, v1, v2}, Landroidx/profileinstaller/ProfileTranscoder;->x(Ljava/io/InputStream;[BLjava/lang/String;)[Landroidx/profileinstaller/DexProfileData;
    ...
    invoke-interface {v2, v0, p1}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->a(ILjava/lang/Object;)V
    ...
    invoke-interface {v2, v3, v1}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->a(ILjava/lang/Object;)V
    :try_end_2
    ...
    invoke-interface {v1, v0, p1}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->a(ILjava/lang/Object;)V
...
.method public e()Z
    ...
    invoke-direct {p0, v2, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->l(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, v3, v2}, Landroidx/profileinstaller/DeviceProfileWriter;->l(ILjava/lang/Object;)V
...
.method public i()Landroidx/profileinstaller/DeviceProfileWriter;
    ...
    invoke-direct {p0, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->f(Landroid/content/res/AssetManager;)Ljava/io/InputStream;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-direct {p0, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->j(Ljava/io/InputStream;)[Landroidx/profileinstaller/DexProfileData;
    ...
    invoke-static {}, Landroidx/profileinstaller/DeviceProfileWriter;->k()Z
...
.method public m()Landroidx/profileinstaller/DeviceProfileWriter;
    .locals 4
    ...
    :try_start_1
    invoke-static {v3, v1}, Landroidx/profileinstaller/ProfileTranscoder;->F(Ljava/io/OutputStream;[B)V

    invoke-static {v3, v1, v0}, Landroidx/profileinstaller/ProfileTranscoder;->C(Ljava/io/OutputStream;[B[Landroidx/profileinstaller/DexProfileData;)Z
...
.method public n()Z
    ...
    :try_start_4
    invoke-static {v3, v0, v5}, Landroidx/profileinstaller/Encoding;->l(Ljava/io/InputStream;Ljava/io/OutputStream;Ljava/nio/channels/FileLock;)V

    const/4 v6, 0x1

    invoke-direct {p0, v6, v2}, Landroidx/profileinstaller/DeviceProfileWriter;->l(ILjava/lang/Object;)V
    :try_end_4
    ...
    :try_start_11
    invoke-direct {p0, v3, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->l(ILjava/lang/Object;)V
    :try_end_11
