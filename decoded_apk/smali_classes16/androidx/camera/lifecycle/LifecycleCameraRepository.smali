...
.method private f(Landroidx/lifecycle/LifecycleOwner;)Z
    ...
    invoke-virtual {v2}, Landroidx/camera/lifecycle/LifecycleCamera;->r()Ljava/util/List;
...
.method private g(Landroidx/camera/lifecycle/LifecycleCamera;)V
    ...
    :try_start_0
    invoke-virtual {p1}, Landroidx/camera/lifecycle/LifecycleCamera;->o()Landroidx/lifecycle/LifecycleOwner;

    move-result-object v1

    invoke-virtual {p1}, Landroidx/camera/lifecycle/LifecycleCamera;->b()Landroidx/camera/core/CameraInfo;

    move-result-object v2

    check-cast v2, Landroidx/camera/core/impl/RestrictedCameraInfo;

    invoke-virtual {p1}, Landroidx/camera/lifecycle/LifecycleCamera;->q()Landroidx/camera/core/CameraInfo;

    move-result-object v3

    check-cast v3, Landroidx/camera/core/impl/RestrictedCameraInfo;

    invoke-static {v2, v3}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->B(Landroidx/camera/core/impl/RestrictedCameraInfo;Landroidx/camera/core/impl/RestrictedCameraInfo;)Landroidx/camera/core/internal/CameraUseCaseAdapter$CameraId;
...
.method private n(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    invoke-virtual {v1}, Landroidx/camera/lifecycle/LifecycleCamera;->w()V
...
# virtual methods
.method a(Landroidx/camera/lifecycle/LifecycleCamera;Landroidx/camera/core/ViewPort;Ljava/util/List;Ljava/util/Collection;Landroidx/camera/core/concurrent/CameraCoordinator;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p5}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->d(Landroidx/lifecycle/LifecycleOwner;)Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;
    ...
    :cond_4
    :try_start_1
    invoke-virtual {p1}, Landroidx/camera/lifecycle/LifecycleCamera;->i()Landroidx/camera/core/internal/CameraUseCaseAdapter;

    move-result-object v1

    invoke-virtual {v1, p2}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->d0(Landroidx/camera/core/ViewPort;)V
    ...
    invoke-virtual {p1, p2}, Landroidx/lifecycle/Lifecycle$State;->e(Landroidx/lifecycle/Lifecycle$State;)Z

    move-result p1

    if-eqz p1, :cond_5

    invoke-virtual {p0, p5}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->h(Landroidx/lifecycle/LifecycleOwner;)V
...
.method b(Landroidx/lifecycle/LifecycleOwner;Landroidx/camera/core/internal/CameraUseCaseAdapter;)Landroidx/camera/lifecycle/LifecycleCamera;
    .locals 3
    ...
    :try_start_0
    invoke-virtual {p2}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->D()Landroidx/camera/core/internal/CameraUseCaseAdapter$CameraId;
...
.method c(Landroidx/lifecycle/LifecycleOwner;Landroidx/camera/core/internal/CameraUseCaseAdapter$CameraId;)Landroidx/camera/lifecycle/LifecycleCamera;
    .locals 2
...
.method h(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    :cond_3
    :goto_0
    invoke-direct {p0, p1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->n(Landroidx/lifecycle/LifecycleOwner;)V
...
.method k(Ljava/util/Collection;)V
    ...
    invoke-virtual {v2, p1}, Landroidx/camera/lifecycle/LifecycleCamera;->u(Ljava/util/Collection;)V
    ...
    invoke-virtual {v2}, Landroidx/camera/lifecycle/LifecycleCamera;->o()Landroidx/lifecycle/LifecycleOwner;
...
.method l()V
    ...
    invoke-virtual {v2}, Landroidx/camera/lifecycle/LifecycleCamera;->v()V
