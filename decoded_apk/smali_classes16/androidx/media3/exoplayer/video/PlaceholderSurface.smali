...
.field private final c:Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;
...
.method private constructor <init>(Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;Landroid/graphics/SurfaceTexture;Z)V
    ...
    .line 3
    iput-object p1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->c:Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;
...
.method public static declared-synchronized b(Landroid/content/Context;)Z
    ...
    sput p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->e:I
    ...
    :cond_0
    :goto_0
    sget p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->e:I
    :try_end_0
...
.method public static c(Landroid/content/Context;Z)Landroidx/media3/exoplayer/video/PlaceholderSurface;
    ...
    :goto_1
    invoke-static {p0}, Landroidx/media3/common/util/Assertions;->g(Z)V
    ...
    :cond_2
    invoke-virtual {p0, v0}, Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;->a(I)Landroidx/media3/exoplayer/video/PlaceholderSurface;
...
.method public release()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->c:Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->d:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->c:Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;

    invoke-virtual {v1}, Landroidx/media3/exoplayer/video/PlaceholderSurface$PlaceholderSurfaceThread;->c()V

    const/4 v1, 0x1

    iput-boolean v1, p0, Landroidx/media3/exoplayer/video/PlaceholderSurface;->d:Z
