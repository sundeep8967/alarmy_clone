...
.method public static a(Landroid/text/Spannable;IILandroidx/media3/extractor/text/ttml/TtmlStyle;Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;I)V
    .locals 8
    ...
    invoke-static {p0, v0, p1, p2, v1}, Landroidx/media3/common/text/SpanUtil;->b(Landroid/text/Spannable;Ljava/lang/Object;III)V
    ...
    invoke-static {p0, v7, p1, p2, v1}, Landroidx/media3/common/text/SpanUtil;->b(Landroid/text/Spannable;Ljava/lang/Object;III)V
    ...
    :cond_c
    invoke-static {p4, p5}, Landroidx/media3/extractor/text/ttml/TtmlRenderUtil;->d(Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    :cond_d
    invoke-static {p4, p5}, Landroidx/media3/extractor/text/ttml/TtmlRenderUtil;->e(Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    :cond_e
    invoke-virtual {p6}, Landroidx/media3/extractor/text/ttml/TtmlNode;->g()I
    ...
    invoke-virtual {p6, v0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->f(I)Landroidx/media3/extractor/text/ttml/TtmlNode;

    move-result-object v6

    iget-object v6, v6, Landroidx/media3/extractor/text/ttml/TtmlNode;->b:Ljava/lang/String;
    ...
    iget-object v0, v0, Landroidx/media3/extractor/text/ttml/TtmlNode;->b:Ljava/lang/String;
    ...
    iget-object v6, p6, Landroidx/media3/extractor/text/ttml/TtmlNode;->f:Landroidx/media3/extractor/text/ttml/TtmlStyle;

    invoke-virtual {p6}, Landroidx/media3/extractor/text/ttml/TtmlNode;->l()[Ljava/lang/String;

    move-result-object p6

    invoke-static {v6, p6, p5}, Landroidx/media3/extractor/text/ttml/TtmlRenderUtil;->f(Landroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    iget-object v2, p4, Landroidx/media3/extractor/text/ttml/TtmlNode;->f:Landroidx/media3/extractor/text/ttml/TtmlStyle;

    invoke-virtual {p4}, Landroidx/media3/extractor/text/ttml/TtmlNode;->l()[Ljava/lang/String;

    move-result-object p4

    invoke-static {v2, p4, p5}, Landroidx/media3/extractor/text/ttml/TtmlRenderUtil;->f(Landroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-static {p4, p5}, Landroidx/media3/common/util/Log;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p4, p1, p2, v1}, Landroidx/media3/common/text/SpanUtil;->b(Landroid/text/Spannable;Ljava/lang/Object;III)V
    ...
    invoke-static {p0, p3, p1, p2, v1}, Landroidx/media3/common/text/SpanUtil;->a(Landroid/text/Spannable;FIII)V
...
.method private static d(Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->l()[Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->j:Landroidx/media3/extractor/text/ttml/TtmlNode;
...
.method private static e(Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->f:Landroidx/media3/extractor/text/ttml/TtmlStyle;

    invoke-virtual {p0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->l()[Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2, p1}, Landroidx/media3/extractor/text/ttml/TtmlRenderUtil;->f(Landroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p0, v1}, Landroidx/media3/extractor/text/ttml/TtmlNode;->f(I)Landroidx/media3/extractor/text/ttml/TtmlNode;
