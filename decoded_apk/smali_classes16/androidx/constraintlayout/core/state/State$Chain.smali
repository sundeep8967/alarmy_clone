...
.field private static final synthetic g:[Landroidx/constraintlayout/core/state/State$Chain;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/constraintlayout/core/state/State$Chain;->b:Landroidx/constraintlayout/core/state/State$Chain;
    ...
    sput-object v1, Landroidx/constraintlayout/core/state/State$Chain;->c:Landroidx/constraintlayout/core/state/State$Chain;
    ...
    invoke-static {}, Landroidx/constraintlayout/core/state/State$Chain;->d()[Landroidx/constraintlayout/core/state/State$Chain;

    move-result-object v5

    sput-object v5, Landroidx/constraintlayout/core/state/State$Chain;->g:[Landroidx/constraintlayout/core/state/State$Chain;

    new-instance v5, Ljava/util/HashMap;

    invoke-direct {v5}, Ljava/util/HashMap;-><init>()V

    sput-object v5, Landroidx/constraintlayout/core/state/State$Chain;->e:Ljava/util/Map;

    new-instance v5, Ljava/util/HashMap;

    invoke-direct {v5}, Ljava/util/HashMap;-><init>()V

    sput-object v5, Landroidx/constraintlayout/core/state/State$Chain;->f:Ljava/util/Map;

    sget-object v5, Landroidx/constraintlayout/core/state/State$Chain;->e:Ljava/util/Map;

    const-string v7, "packed"

    invoke-interface {v5, v7, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v3, Landroidx/constraintlayout/core/state/State$Chain;->e:Ljava/util/Map;

    const-string v5, "spread_inside"

    invoke-interface {v3, v5, v1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Landroidx/constraintlayout/core/state/State$Chain;->e:Ljava/util/Map;

    const-string v3, "spread"

    invoke-interface {v1, v3, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v0, Landroidx/constraintlayout/core/state/State$Chain;->f:Ljava/util/Map;
...
.method private static synthetic d()[Landroidx/constraintlayout/core/state/State$Chain;
    .locals 3
    ...
    sget-object v2, Landroidx/constraintlayout/core/state/State$Chain;->d:Landroidx/constraintlayout/core/state/State$Chain;
...
.method public static values()[Landroidx/constraintlayout/core/state/State$Chain;
    ...
    sget-object v0, Landroidx/constraintlayout/core/state/State$Chain;->g:[Landroidx/constraintlayout/core/state/State$Chain;
