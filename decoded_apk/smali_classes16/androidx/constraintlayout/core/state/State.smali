...
# instance fields
.field private a:Landroidx/constraintlayout/core/state/CorePixelDp;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroidx/constraintlayout/core/state/State;->f:Landroidx/constraintlayout/core/state/ConstraintReference;
...
.method public A(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/constraintlayout/core/state/ConstraintReference;->b0(Ljava/lang/String;)V
...
.method public B(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/State;
    ...
    invoke-virtual {v0, p1}, Landroidx/constraintlayout/core/state/ConstraintReference;->f0(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/ConstraintReference;

    return-object p0
.end method

.method public C()Landroidx/constraintlayout/core/state/helpers/VerticalChainReference;
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/constraintlayout/core/state/State;->n(Ljava/lang/Object;Landroidx/constraintlayout/core/state/State$Helper;)Landroidx/constraintlayout/core/state/HelperReference;
...
.method public D(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/helpers/GuidelineReference;
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, v0}, Landroidx/constraintlayout/core/state/State;->l(Ljava/lang/Object;I)Landroidx/constraintlayout/core/state/helpers/GuidelineReference;
...
.method public E(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/State;
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/constraintlayout/core/state/State;->B(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/State;
...
.method public a(Landroidx/constraintlayout/core/widgets/ConstraintWidgetContainer;)V
    .locals 7
    ...
    invoke-virtual {v0}, Landroidx/constraintlayout/core/state/ConstraintReference;->C()Landroidx/constraintlayout/core/state/Dimension;
    ...
    invoke-virtual {v2}, Landroidx/constraintlayout/core/state/HelperReference;->u0()Landroidx/constraintlayout/core/widgets/HelperWidget;
    ...
    invoke-virtual {p0, v1}, Landroidx/constraintlayout/core/state/State;->d(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/ConstraintReference;

    move-result-object v3

    :cond_1
    invoke-interface {v3, v2}, Landroidx/constraintlayout/core/state/Reference;->b(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)V
    ...
    iget-object v3, p0, Landroidx/constraintlayout/core/state/State;->f:Landroidx/constraintlayout/core/state/ConstraintReference;

    if-eq v2, v3, :cond_3

    invoke-interface {v2}, Landroidx/constraintlayout/core/state/Reference;->d()Landroidx/constraintlayout/core/state/helpers/Facade;
    ...
    invoke-virtual {v2, v3}, Landroidx/constraintlayout/core/widgets/ConstraintWidget;->J0(Ljava/lang/String;)V

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Landroidx/constraintlayout/core/widgets/ConstraintWidget;->j1(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)V

    invoke-interface {v1}, Landroidx/constraintlayout/core/state/Reference;->d()Landroidx/constraintlayout/core/state/helpers/Facade;
    ...
    :cond_6
    invoke-virtual {p1, v2}, Landroidx/constraintlayout/core/widgets/WidgetContainer;->a(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)V

    goto :goto_2

    :cond_7
    invoke-interface {v1, p1}, Landroidx/constraintlayout/core/state/Reference;->b(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)V
    ...
    invoke-virtual {v0}, Landroidx/constraintlayout/core/state/HelperReference;->u0()Landroidx/constraintlayout/core/widgets/HelperWidget;

    move-result-object v1

    if-eqz v1, :cond_a

    iget-object v1, v0, Landroidx/constraintlayout/core/state/HelperReference;->o0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v2}, Landroidx/constraintlayout/core/widgets/HelperWidget;->a(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)V
    ...
    iget-object v1, p0, Landroidx/constraintlayout/core/state/State;->f:Landroidx/constraintlayout/core/state/ConstraintReference;

    if-eq v0, v1, :cond_c

    invoke-interface {v0}, Landroidx/constraintlayout/core/state/Reference;->d()Landroidx/constraintlayout/core/state/helpers/Facade;
    ...
    invoke-virtual {v1}, Landroidx/constraintlayout/core/state/HelperReference;->u0()Landroidx/constraintlayout/core/widgets/HelperWidget;

    move-result-object v2

    if-eqz v2, :cond_c

    iget-object v1, v1, Landroidx/constraintlayout/core/state/HelperReference;->o0:Ljava/util/ArrayList;
    ...
    invoke-interface {v4}, Landroidx/constraintlayout/core/state/Reference;->a()Landroidx/constraintlayout/core/widgets/ConstraintWidget;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroidx/constraintlayout/core/widgets/HelperWidget;->a(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)V
    ...
    invoke-interface {v3}, Landroidx/constraintlayout/core/state/Reference;->a()Landroidx/constraintlayout/core/widgets/ConstraintWidget;
...
.method public b(Ljava/lang/Object;Landroidx/constraintlayout/core/state/State$Direction;)Landroidx/constraintlayout/core/state/helpers/BarrierReference;
    .locals 1
    ...
    invoke-virtual {p1}, Landroidx/constraintlayout/core/state/ConstraintReference;->d()Landroidx/constraintlayout/core/state/helpers/Facade;
    ...
    invoke-virtual {v0, p2}, Landroidx/constraintlayout/core/state/helpers/BarrierReference;->w0(Landroidx/constraintlayout/core/state/State$Direction;)V

    invoke-virtual {p1, v0}, Landroidx/constraintlayout/core/state/ConstraintReference;->X(Landroidx/constraintlayout/core/state/helpers/Facade;)V
...
.method public d(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/ConstraintReference;
    .locals 2
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/core/state/State;->f(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/ConstraintReference;
    ...
    invoke-interface {v0, p1}, Landroidx/constraintlayout/core/state/Reference;->c(Ljava/lang/Object;)V
...
.method h()Landroidx/constraintlayout/core/state/CorePixelDp;
    .locals 1

    iget-object v0, p0, Landroidx/constraintlayout/core/state/State;->a:Landroidx/constraintlayout/core/state/CorePixelDp;

    return-object v0
.end method

.method public i(Ljava/lang/Object;Z)Landroidx/constraintlayout/core/state/helpers/FlowReference;
    .locals 1
    ...
    sget-object v0, Landroidx/constraintlayout/core/state/State$Helper;->i:Landroidx/constraintlayout/core/state/State$Helper;
    ...
    :goto_0
    invoke-virtual {p1, p2}, Landroidx/constraintlayout/core/state/ConstraintReference;->X(Landroidx/constraintlayout/core/state/helpers/Facade;)V
...
.method public j(Ljava/lang/Object;Ljava/lang/String;)Landroidx/constraintlayout/core/state/helpers/GridReference;
    .locals 4
    ...
    :cond_0
    sget-object v0, Landroidx/constraintlayout/core/state/State$Helper;->j:Landroidx/constraintlayout/core/state/State$Helper;
    ...
    sget-object v0, Landroidx/constraintlayout/core/state/State$Helper;->k:Landroidx/constraintlayout/core/state/State$Helper;
    ...
    sget-object v0, Landroidx/constraintlayout/core/state/State$Helper;->l:Landroidx/constraintlayout/core/state/State$Helper;
...
.method public l(Ljava/lang/Object;I)Landroidx/constraintlayout/core/state/helpers/GuidelineReference;
    .locals 2
    ...
    invoke-virtual {v0}, Landroidx/constraintlayout/core/state/ConstraintReference;->d()Landroidx/constraintlayout/core/state/helpers/Facade;
    ...
    invoke-virtual {v1, p2}, Landroidx/constraintlayout/core/state/helpers/GuidelineReference;->g(I)V

    invoke-virtual {v1, p1}, Landroidx/constraintlayout/core/state/helpers/GuidelineReference;->c(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, Landroidx/constraintlayout/core/state/ConstraintReference;->X(Landroidx/constraintlayout/core/state/helpers/Facade;)V
...
.method public m(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/State;
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/core/state/State;->y(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/State;
...
.method public n(Ljava/lang/Object;Landroidx/constraintlayout/core/state/State$Helper;)Landroidx/constraintlayout/core/state/HelperReference;
    .locals 1

    if-nez p1, :cond_0

    invoke-direct {p0}, Landroidx/constraintlayout/core/state/State;->g()Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {v0, p1}, Landroidx/constraintlayout/core/state/ConstraintReference;->c(Ljava/lang/Object;)V
...
.method public o()Landroidx/constraintlayout/core/state/helpers/HorizontalChainReference;
    .locals 2

    const/4 v0, 0x0

    sget-object v1, Landroidx/constraintlayout/core/state/State$Helper;->b:Landroidx/constraintlayout/core/state/State$Helper;
...
.method public p(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/helpers/GuidelineReference;
    .locals 1
...
.method public q(Landroidx/constraintlayout/core/widgets/ConstraintWidget;)Z
    ...
    iget-object v2, p0, Landroidx/constraintlayout/core/state/State;->i:Ljava/util/ArrayList;
...
.method public s(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p2}, Landroidx/constraintlayout/core/state/ConstraintReference;->e0(Ljava/lang/Object;)V

    :cond_0
    return-void
.end method

.method t(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/Reference;
    .locals 1
...
.method public v(I)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/constraintlayout/core/state/Dimension;->i(I)Z
...
.method public x(Landroidx/constraintlayout/core/state/CorePixelDp;)V
    .locals 0

    iput-object p1, p0, Landroidx/constraintlayout/core/state/State;->a:Landroidx/constraintlayout/core/state/CorePixelDp;

    return-void
.end method

.method public y(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/State;
    .locals 1

    iget-object v0, p0, Landroidx/constraintlayout/core/state/State;->f:Landroidx/constraintlayout/core/state/ConstraintReference;

    invoke-virtual {v0, p1}, Landroidx/constraintlayout/core/state/ConstraintReference;->Y(Landroidx/constraintlayout/core/state/Dimension;)Landroidx/constraintlayout/core/state/ConstraintReference;
