...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p2, p3, v0}, Lcom/google/android/material/textview/MaterialTextView;->h(Landroid/util/AttributeSet;II)V

    return-void
.end method

.method private e(Landroid/content/res/Resources$Theme;I)V
    .locals 2
...
.method private static f(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0, v1}, Lrp/b;->b(Landroid/content/Context;IZ)Z
...
.method private h(Landroid/util/AttributeSet;II)V
    ...
    invoke-static {v0}, Lcom/google/android/material/textview/MaterialTextView;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v0, v1, p1, p2, p3}, Lcom/google/android/material/textview/MaterialTextView;->j(Landroid/content/Context;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;II)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {v1, p1, p2, p3}, Lcom/google/android/material/textview/MaterialTextView;->g(Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;II)I
    ...
    invoke-direct {p0, v1, p1}, Lcom/google/android/material/textview/MaterialTextView;->e(Landroid/content/res/Resources$Theme;I)V
...
.method private static varargs i(Landroid/content/Context;Landroid/content/res/TypedArray;[I)I
    ...
    invoke-static {p0, p1, v2, v0}, Lrp/c;->d(Landroid/content/Context;Landroid/content/res/TypedArray;II)I
...
.method public setTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/material/textview/MaterialTextView;->e(Landroid/content/res/Resources$Theme;I)V
