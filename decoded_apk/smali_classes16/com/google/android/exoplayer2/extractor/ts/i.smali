...
.field private t:Lcom/google/android/exoplayer2/extractor/b0;
...
.method public constructor <init>(ZLjava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->c:Lcom/google/android/exoplayer2/util/d0;

    .line 5
    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->q()V
...
.method private e(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    iget-object p1, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->o()V
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->r()V
...
.method private f(Lcom/google/android/exoplayer2/util/d0;I)Z
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/google/android/exoplayer2/extractor/ts/i;->u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->b:Lcom/google/android/exoplayer2/util/c0;

    iget-object v4, v4, Lcom/google/android/exoplayer2/util/c0;->a:[B

    invoke-direct {p0, p1, v4, v1}, Lcom/google/android/exoplayer2/extractor/ts/i;->u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    invoke-direct {p0, p1, v4, v3}, Lcom/google/android/exoplayer2/extractor/ts/i;->u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    :cond_5
    iget-object v3, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->b:Lcom/google/android/exoplayer2/util/c0;
    ...
    invoke-direct {p0, v5, p1}, Lcom/google/android/exoplayer2/extractor/ts/i;->j(BB)Z
...
.method private h(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    iget v6, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->j:I
    ...
    invoke-direct {p0, v8, v6}, Lcom/google/android/exoplayer2/extractor/ts/i;->j(BB)Z

    move-result v6

    if-eqz v6, :cond_3

    iget-boolean v6, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->l:Z

    if-nez v6, :cond_0

    add-int/lit8 v6, v1, -0x1

    invoke-direct {p0, p1, v6}, Lcom/google/android/exoplayer2/extractor/ts/i;->f(Lcom/google/android/exoplayer2/util/d0;I)Z
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->p()V
    ...
    :goto_2
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/util/d0;->U(I)V
    ...
    :cond_4
    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->s()V
    ...
    :cond_6
    iput v7, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->j:I
...
.method private j(BB)Z
    ...
    invoke-static {p1}, Lcom/google/android/exoplayer2/extractor/ts/i;->k(I)Z
...
.method private l()V
    ...
    iget v3, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->n:I

    invoke-static {v1, v3, v0}, Lcom/google/android/exoplayer2/audio/a;->a(III)[B
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->e:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/exoplayer2/n1$b;->K(Ljava/lang/String;)Lcom/google/android/exoplayer2/n1$b;

    move-result-object v3

    iget v4, v1, Lcom/google/android/exoplayer2/audio/a$b;->b:I

    invoke-virtual {v3, v4}, Lcom/google/android/exoplayer2/n1$b;->J(I)Lcom/google/android/exoplayer2/n1$b;

    move-result-object v3

    iget v1, v1, Lcom/google/android/exoplayer2/audio/a$b;->a:I

    invoke-virtual {v3, v1}, Lcom/google/android/exoplayer2/n1$b;->h0(I)Lcom/google/android/exoplayer2/n1$b;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/exoplayer2/n1$b;->V(Ljava/util/List;)Lcom/google/android/exoplayer2/n1$b;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->d:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/google/android/exoplayer2/n1$b;->X(Ljava/lang/String;)Lcom/google/android/exoplayer2/n1$b;
    ...
    iput-wide v5, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->q:J

    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->f:Lcom/google/android/exoplayer2/extractor/b0;

    invoke-interface {v1, v0}, Lcom/google/android/exoplayer2/extractor/b0;->b(Lcom/google/android/exoplayer2/n1;)V

    iput-boolean v2, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->p:Z
    ...
    iget-boolean v2, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->k:Z
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->f:Lcom/google/android/exoplayer2/extractor/b0;

    iget-wide v4, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->q:J

    const/4 v6, 0x0

    move-object v2, p0

    invoke-direct/range {v2 .. v7}, Lcom/google/android/exoplayer2/extractor/ts/i;->t(Lcom/google/android/exoplayer2/extractor/b0;JII)V
...
.method private m()V
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->c:Lcom/google/android/exoplayer2/util/d0;

    const/16 v2, 0xa

    invoke-interface {v0, v1, v2}, Lcom/google/android/exoplayer2/extractor/b0;->a(Lcom/google/android/exoplayer2/util/d0;I)V

    iget-object v0, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->c:Lcom/google/android/exoplayer2/util/d0;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/google/android/exoplayer2/extractor/ts/i;->t(Lcom/google/android/exoplayer2/extractor/b0;JII)V
...
.method private s()V
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/exoplayer2/util/d0;->U(I)V

    return-void
.end method

.method private t(Lcom/google/android/exoplayer2/extractor/b0;JII)V
    .locals 1
...
.method private u(Lcom/google/android/exoplayer2/util/d0;[BI)Z
    ...
    :cond_0
    invoke-virtual {p1, p2, v1, p3}, Lcom/google/android/exoplayer2/util/d0;->l([BII)V
...
.method public b(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->d()V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/i;->n(Lcom/google/android/exoplayer2/util/d0;)V
    ...
    :goto_1
    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/ts/i;->b:Lcom/google/android/exoplayer2/util/c0;

    iget-object v1, v1, Lcom/google/android/exoplayer2/util/c0;->a:[B

    invoke-direct {p0, p1, v1, v0}, Lcom/google/android/exoplayer2/extractor/ts/i;->g(Lcom/google/android/exoplayer2/util/d0;[BI)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->l()V
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/google/android/exoplayer2/extractor/ts/i;->g(Lcom/google/android/exoplayer2/util/d0;[BI)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/google/android/exoplayer2/extractor/ts/i;->m()V

    goto :goto_0

    :cond_5
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/i;->e(Lcom/google/android/exoplayer2/util/d0;)V

    goto :goto_0

    :cond_6
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/extractor/ts/i;->h(Lcom/google/android/exoplayer2/util/d0;)V
