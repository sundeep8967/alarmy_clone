...
.method static synthetic access$400(Lcom/google/android/exoplayer2/offline/DownloadService;Lcom/google/android/exoplayer2/offline/c;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/offline/DownloadService;->notifyDownloadChanged(Lcom/google/android/exoplayer2/offline/c;)V
...
.method public static startForeground(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/util/p0;->M0(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
# virtual methods
.method protected abstract getDownloadManager()Lcom/google/android/exoplayer2/offline/h;
.end method
...
.method protected abstract getScheduler()Lcom/google/android/exoplayer2/scheduler/d;
.end method
...
.method public onCreate()V
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/offline/DownloadService;->getScheduler()Lcom/google/android/exoplayer2/scheduler/d;
    ...
    :goto_2
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/offline/DownloadService;->getDownloadManager()Lcom/google/android/exoplayer2/offline/h;

    move-result-object v6

    invoke-virtual {v6}, Lcom/google/android/exoplayer2/offline/h;->w()V
    ...
    invoke-direct/range {v4 .. v10}, Lcom/google/android/exoplayer2/offline/DownloadService$b;-><init>(Landroid/content/Context;Lcom/google/android/exoplayer2/offline/h;ZLcom/google/android/exoplayer2/scheduler/d;Ljava/lang/Class;Lcom/google/android/exoplayer2/offline/DownloadService$a;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-static {v4}, Lcom/google/android/exoplayer2/offline/DownloadService$b;->b(Lcom/google/android/exoplayer2/offline/DownloadService$b;)Lcom/google/android/exoplayer2/offline/h;
    ...
    invoke-static {v6, p1}, Lcom/google/android/exoplayer2/util/t;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_d
    invoke-virtual {v4, v3}, Lcom/google/android/exoplayer2/offline/h;->v(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v3, p1}, Lcom/google/android/exoplayer2/offline/h;->A(Ljava/lang/String;I)V

    goto :goto_4

    :pswitch_2
    invoke-virtual {v4}, Lcom/google/android/exoplayer2/offline/h;->t()V
    ...
    :cond_f
    invoke-virtual {v4, p1}, Lcom/google/android/exoplayer2/offline/h;->z(Lcom/google/android/exoplayer2/scheduler/Requirements;)V

    goto :goto_4

    :pswitch_4
    invoke-virtual {v4}, Lcom/google/android/exoplayer2/offline/h;->u()V

    goto :goto_4

    :pswitch_5
    invoke-virtual {v4}, Lcom/google/android/exoplayer2/offline/h;->w()V
    ...
    invoke-virtual {v4, p2, p1}, Lcom/google/android/exoplayer2/offline/h;->c(Lcom/google/android/exoplayer2/offline/DownloadRequest;I)V
    ...
    invoke-virtual {v4}, Lcom/google/android/exoplayer2/offline/h;->k()Z
